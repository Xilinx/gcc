 ...
 * increment the cilk_for rank at the beginning of each iteration around the
 ...
 * themselves.  Users should only call this function at the beginning of a
 * cilk_for loop body.
 *
