...
#@#@# 
#@#@# It has been AutoGen-ed  April  4, 2012 at 11:05:17 AM by AutoGen 5.12
...
melt-tiny-tests: melt-sayhello.melt melt-modules melt-sources \
		...
		$(MELT_RUNTIME_C)
# test that a helloworld can be translated from melt-build.tpl line 677
	@echo doing $@  from melt-build.tpl line 678
	@echo	$(MELTCCAPPLICATION1ARGS) \
	     $(meltarg_arg)=$<  -frandom-seed=$(shell $(MD5SUM) $< | cut -b-24) \
	     $(meltarg_module_path)=$(realpath melt-modules) \
	     $(meltarg_source_path)=$(realpath melt-sources) \
	...
	@echo; echo; echo; echo -n $(basename $<).args: ; cat $(basename $<).args ; echo "***** doing " $(basename $<)  from melt-build.tpl line 686
	$(melt_make_cc1) @$(basename $<).args
# test that a helloworld can be run from melt-build.tpl line 688
	...
	@echo; echo; echo; echo -n $(basename $<)-run.args: ; cat $(basename $<)-run.args ; echo "***** doing " $(basename $<)-run  from melt-build.tpl line 696
...
# test melt-runtime from melt-build.tpl line 700
	...
	@echo; echo; echo; echo -n meltframe.args: ; cat meltframe.args ; echo "***** doing " meltframe  from melt-build.tpl line 716
	$(melt_make_cc1) @meltframe.args


#@ from melt-build.tpl line 720
...
#@ from melt-build.tpl line 812

#@ from melt-build.tpl line 814
	@echo upgrading MELT translator warmelt-first
## dont indent the warmelt-first+meltdesc.c or warmelt-first+melttime.h ::: from melt-build.tpl line 816
...
#@ from melt-build.tpl line 835
#

#@ from melt-build.tpl line 814
	@echo upgrading MELT translator warmelt-base
## dont indent the warmelt-base+meltdesc.c or warmelt-base+melttime.h ::: from melt-build.tpl line 816
...
## dont indent the warmelt-debug+meltdesc.c or warmelt-debug+melttime.h ::: from melt-build.tpl line 816
...
## dont indent the warmelt-macro+meltdesc.c or warmelt-macro+melttime.h ::: from melt-build.tpl line 816
...
## dont indent the warmelt-normal+meltdesc.c or warmelt-normal+melttime.h ::: from melt-build.tpl line 816
...
## dont indent the warmelt-normatch+meltdesc.c or warmelt-normatch+melttime.h ::: from melt-build.tpl line 816
...
## dont indent the warmelt-genobj+meltdesc.c or warmelt-genobj+melttime.h ::: from melt-build.tpl line 816
...
## dont indent the warmelt-outobj+meltdesc.c or warmelt-outobj+melttime.h ::: from melt-build.tpl line 816
...
## dont indent the warmelt-modes+meltdesc.c or warmelt-modes+melttime.h ::: from melt-build.tpl line 816
...
### MELT cleanup  from melt-build.tpl line 871
.PHONY: melt-clean
melt-clean:
