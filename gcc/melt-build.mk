...
#@#@# 
#@#@# It has been AutoGen-ed  April 23, 2012 at 12:54:04 PM by AutoGen 5.12
  ...
  \
   ...
   $(melt_make_cc1_dependency)
	...
	@echo 	$(MELTCCAPPLICATION1ARGS) \
	     ...
	     $(meltarg_source_path)=$(realpath melt-sources) \
             $(meltarg_workdir)=melt-workdir $(meltarg_inhibitautobuild) \
	     $(meltarg_init)=@warmelt-quicklybuilt:xtramelt-ana-base:xtramelt-ana-simple \
	     $(meltarg_output)=$(basename $@) empty-file-for-melt.c > $(notdir $(basename $@))-quickb.args-tmp
	@$(melt_move_if_change) $(notdir $(basename $@))-quickb.args-tmp $(notdir $(basename $@))-quickb.args
	@echo; echo; echo; echo -n $(notdir $(basename $@))-quickb.args: ; cat $(notdir $(basename $@))-quickb.args ; echo "***** doing " $@ from melt-build.tpl line 626
	$(melt_make_cc1) @$(notdir $(basename $@))-quickb.args
  ...
  \
   ...
   $(melt_make_cc1_dependency)
	...
	@echo 	$(MELTCCAPPLICATION1ARGS) \
	     ...
	     $(meltarg_source_path)=$(realpath melt-sources) \
             $(meltarg_workdir)=melt-workdir $(meltarg_inhibitautobuild) \
	     $(meltarg_init)=@warmelt-quicklybuilt:xtramelt-ana-base:xtramelt-ana-simple:xtramelt-c-generator \
	     $(meltarg_output)=$(basename $@) empty-file-for-melt.c > $(notdir $(basename $@))-quickb.args-tmp
	@$(melt_move_if_change) $(notdir $(basename $@))-quickb.args-tmp $(notdir $(basename $@))-quickb.args
	@echo; echo; echo; echo -n $(notdir $(basename $@))-quickb.args: ; cat $(notdir $(basename $@))-quickb.args ; echo "***** doing " $@ from melt-build.tpl line 626
	$(melt_make_cc1) @$(notdir $(basename $@))-quickb.args
