...
#@#@# 
#@#@# It has been AutoGen-ed  July  5, 2012 at 07:37:31 PM by AutoGen 5.12
...
## the following Makefile variables are expected to be set from melt-build.tpl line 36 


#@ from melt-build.tpl line 65 name= melt_source_dir comment=   directory containing *.melt & *.c files
...
#@ from melt-build.tpl line 65 name= melt_module_dir comment=   directory containing *.so MELT module files
...
#@ from melt-build.tpl line 65 name= melt_make_module_makefile comment=   our melt-module.mk Makefile  when making MELT
...
#@ from melt-build.tpl line 65 name= melt_make_source_dir comment=   directory containing the *.melt files when making MELT
...
#@ from melt-build.tpl line 65 name= melt_make_module_dir comment=   directory containing the *.so files when making MELT
...
#@ from melt-build.tpl line 65 name= melt_default_modules_list comment=   basename of the default module list
...
#@ from melt-build.tpl line 65 name= melt_make_cc1 comment=   gcc -fplugin=melt or cc1-melt program within MELT branch
...
#@ from melt-build.tpl line 65 name= melt_make_cc1_dependency comment=   the make dependency for above
...
#@ from melt-build.tpl line 65 name= melt_make_gencdeps comment=   extra make dependency of generated C files -often empty-
...
#@ from melt-build.tpl line 65 name= melt_move_if_change comment=   a move if change command for MELT
...
#@ from melt-build.tpl line 65 name= melt_cflags comment=   the CFLAGS for compiling MELT generated C code
ifndef melt_cflags
...
#@ from melt-build.tpl line 65 name= melt_xtra_cflags comment=   th CFLAGS for compiling extra applicative C code - often empty
...
#@ from melt-build.tpl line 65 name= melt_default_variant comment=   quicklybuilt | optimized | debugnoline
...
## LN_S might not be defined, e.g. in MELT-Plugin-Makefile from melt-build.tpl line 74
LN_S ?= ln -sv

## GAWK is needed, the GNU awk from melt-build.tpl line 77
GAWK ?= gawk

## the md5sum utility is needed  from melt-build.tpl line 80
MD5SUM ?= md5sum

## the various arguments to MELT - avoid spaces in them! from melt-build.tpl line 83
...
## the invocation to translate the very first initial MELT file from melt-build.tpl line 102
...
#@ from melt-build.tpl line 109
## the invocation to translate the other files from melt-build.tpl line 110
...
## our vpath  from melt-build.tpl line 135
...
## using make to compile the generated C into MELT modules from melt-build.tpl line 146
...
## The base name of the MELT translator files from melt-build.tpl line 152
...
## the MELT translator MELT source files from melt-build.tpl line 156
MELT_TRANSLATOR_SOURCE= $(patsubst %,$(melt_make_source_dir)/%.melt,$(MELT_TRANSLATOR_BASE))

## The base name of the MELT application files from melt-build.tpl line 159
...
## The MELT application source files from melt-build.tpl line 163
MELT_APPLICATION_SOURCE= $(patsubst %,$(melt_make_source_dir)/%.melt,$(MELT_APPLICATION_BASE))

## The cold stage 0 of the translator from melt-build.tpl line 166

#@ The C files of the stage 0 are deposited from melt-build.tpl line 168
...
# The base names of stage 0 files from melt-build.tpl line 172
MELT_ZERO_GENERATED_FIRST_BASE= \
                  $(basename $(notdir $(MELT_GENERATED_FIRST_C_FILES)))
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 175
## avoid spaces in MELT_GENERATED_FIRST_CUMULMD5 below from melt-build.tpl line 176
...
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 175
## avoid spaces in MELT_GENERATED_BASE_CUMULMD5 below from melt-build.tpl line 176
...
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 175
## avoid spaces in MELT_GENERATED_DEBUG_CUMULMD5 below from melt-build.tpl line 176
...
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 175
## avoid spaces in MELT_GENERATED_MACRO_CUMULMD5 below from melt-build.tpl line 176
...
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 175
## avoid spaces in MELT_GENERATED_NORMAL_CUMULMD5 below from melt-build.tpl line 176
...
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 175
## avoid spaces in MELT_GENERATED_NORMATCH_CUMULMD5 below from melt-build.tpl line 176
...
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 175
## avoid spaces in MELT_GENERATED_GENOBJ_CUMULMD5 below from melt-build.tpl line 176
...
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 175
## avoid spaces in MELT_GENERATED_OUTOBJ_CUMULMD5 below from melt-build.tpl line 176
...
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 175
## avoid spaces in MELT_GENERATED_MODES_CUMULMD5 below from melt-build.tpl line 176
...
#@ the required work directory from melt-build.tpl line 180
melt-workdir:
	mkdir -p melt-workdir
	ls -ld $$PWD/melt-workdir > melt-workdir-directory.stamp

#@ the work directory timestamp  from melt-build.tpl line 185
melt-workdir-directory.stamp: melt-workdir ; @true

####----------------------------------------------------------------


## An empty file is needed for every MELT translation from melt-build.tpl line 191
empty-file-for-melt.c:
	date +"/* empty-file-for-melt.c %c */" > $@-tmp
	mv $@-tmp $@

## can be overridden manually to either melt-stage0-dynamic or
## melt-stage0-quicklybuilt  from melt-build.tpl line 197
.PHONY: warmelt0
## the default stage0 is from melt-build.tpl line 199
...
## is with static or dynamic field object offsets  from melt-build.tpl line 208


## stage 0 flavor dynamic  from melt-build.tpl line 211

## stage 0 for  from melt-build.tpl line 213
melt-stage0-dynamic:
...
#@ stage 0 flavor dynamic from melt-build.tpl line 219



#@ stage 0 for warmelt-first flavor dynamic  from melt-build.tpl line 223
melt-stage0-dynamic/warmelt-first.$(MELT_ZERO_GENERATED_FIRST_CUMULMD5).dynamic.so:  $(MELT_ZERO_GENERATED_FIRST_C_FILES) \
	...
	@echo  from melt-build.tpl line 235 $@  "real!melt-workdir=$(realpath melt-workdir)"
	-ls -l melt-stage0-dynamic/warmelt-first*  melt-workdir/warmelt-first*
	$(LN_S) -v -f $(realpath melt-workdir)/$(notdir $@) $@
	touch -c $@
	@echo  '@@touched' $@ from melt-build.tpl line 239
	-ls -l melt-stage0-dynamic/warmelt-first* melt-workdir/$(notdir $@) $@

#@ stage 0 for warmelt-first flavor dynamic  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-first flavor dynamic  shortmodule from melt-build.tpl line 249 
melt-stage0-dynamic/warmelt-first.dynamic.so: \
  melt-stage0-dynamic/warmelt-first.$(MELT_ZERO_GENERATED_FIRST_CUMULMD5).dynamic.so
	@echo  from melt-build.tpl line 252 $@
	-ls -l $< $@
	@echo  from melt-build.tpl line 254 $@
	cd melt-stage0-dynamic/ ; $(LN_S) -v -f $(notdir $<) $(notdir $@)
	-ls -l $< $@
	touch -c $@
	@echo  '@@touched' $@ from melt-build.tpl line 258 
...
#@ stage 0 for warmelt-first flavor dynamic  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-first.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-first.dynamic.so ; @true

#@ stage 0 for warmelt-first flavor dynamic done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-first flavored dynamic  from melt-build.tpl line 269


#@ stage 0 for warmelt-base flavor dynamic  from melt-build.tpl line 223
...
#@ stage 0 for warmelt-base flavor dynamic  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-base flavor dynamic  shortmodule from melt-build.tpl line 249 
...
#@ stage 0 for warmelt-base flavor dynamic  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-base.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-base.dynamic.so ; @true

#@ stage 0 for warmelt-base flavor dynamic done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-base flavored dynamic  from melt-build.tpl line 269


#@ stage 0 for warmelt-debug flavor dynamic  from melt-build.tpl line 223
...
#@ stage 0 for warmelt-debug flavor dynamic  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-debug flavor dynamic  shortmodule from melt-build.tpl line 249 
...
#@ stage 0 for warmelt-debug flavor dynamic  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-debug.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-debug.dynamic.so ; @true

#@ stage 0 for warmelt-debug flavor dynamic done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-debug flavored dynamic  from melt-build.tpl line 269


#@ stage 0 for warmelt-macro flavor dynamic  from melt-build.tpl line 223
...
#@ stage 0 for warmelt-macro flavor dynamic  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-macro flavor dynamic  shortmodule from melt-build.tpl line 249 
...
#@ stage 0 for warmelt-macro flavor dynamic  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-macro.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-macro.dynamic.so ; @true

#@ stage 0 for warmelt-macro flavor dynamic done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-macro flavored dynamic  from melt-build.tpl line 269


#@ stage 0 for warmelt-normal flavor dynamic  from melt-build.tpl line 223
...
#@ stage 0 for warmelt-normal flavor dynamic  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-normal flavor dynamic  shortmodule from melt-build.tpl line 249 
...
#@ stage 0 for warmelt-normal flavor dynamic  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-normal.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-normal.dynamic.so ; @true

#@ stage 0 for warmelt-normal flavor dynamic done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-normal flavored dynamic  from melt-build.tpl line 269


#@ stage 0 for warmelt-normatch flavor dynamic  from melt-build.tpl line 223
...
#@ stage 0 for warmelt-normatch flavor dynamic  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-normatch flavor dynamic  shortmodule from melt-build.tpl line 249 
...
#@ stage 0 for warmelt-normatch flavor dynamic  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-normatch.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-normatch.dynamic.so ; @true

#@ stage 0 for warmelt-normatch flavor dynamic done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-normatch flavored dynamic  from melt-build.tpl line 269


#@ stage 0 for warmelt-genobj flavor dynamic  from melt-build.tpl line 223
...
#@ stage 0 for warmelt-genobj flavor dynamic  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-genobj flavor dynamic  shortmodule from melt-build.tpl line 249 
...
#@ stage 0 for warmelt-genobj flavor dynamic  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-genobj.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-genobj.dynamic.so ; @true

#@ stage 0 for warmelt-genobj flavor dynamic done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-genobj flavored dynamic  from melt-build.tpl line 269


#@ stage 0 for warmelt-outobj flavor dynamic  from melt-build.tpl line 223
...
#@ stage 0 for warmelt-outobj flavor dynamic  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-outobj flavor dynamic  shortmodule from melt-build.tpl line 249 
...
#@ stage 0 for warmelt-outobj flavor dynamic  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-outobj.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-outobj.dynamic.so ; @true

#@ stage 0 for warmelt-outobj flavor dynamic done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-outobj flavored dynamic  from melt-build.tpl line 269


#@ stage 0 for warmelt-modes flavor dynamic  from melt-build.tpl line 223
...
#@ stage 0 for warmelt-modes flavor dynamic  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-modes flavor dynamic  shortmodule from melt-build.tpl line 249 
...
#@ stage 0 for warmelt-modes flavor dynamic  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-modes.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-modes.dynamic.so ; @true

#@ stage 0 for warmelt-modes flavor dynamic done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-modes flavored dynamic  from melt-build.tpl line 269



#@ stage 0 flavor dynamic modulelist  from melt-build.tpl line 273 
...
#@ stage 0 flavor dynamic fullstage stamp  from melt-build.tpl line 287 
...
##@ end STAGE0  flavor dynamic  from melt-build.tpl line 295
####-------------------------------------------------------------


## stage 0 flavor quicklybuilt  from melt-build.tpl line 211
...
#@ stage 0 flavor quicklybuilt from melt-build.tpl line 219



#@ stage 0 for warmelt-first flavor quicklybuilt  from melt-build.tpl line 223
...
#@ stage 0 for warmelt-first flavor quicklybuilt  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-first flavor quicklybuilt  shortmodule from melt-build.tpl line 249 
...
#@ stage 0 for warmelt-first flavor quicklybuilt  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-first.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-first.quicklybuilt.so ; @true

#@ stage 0 for warmelt-first flavor quicklybuilt done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-first flavored quicklybuilt  from melt-build.tpl line 269


#@ stage 0 for warmelt-base flavor quicklybuilt  from melt-build.tpl line 223
...
#@ stage 0 for warmelt-base flavor quicklybuilt  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-base flavor quicklybuilt  shortmodule from melt-build.tpl line 249 
...
#@ stage 0 for warmelt-base flavor quicklybuilt  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-base.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-base.quicklybuilt.so ; @true

#@ stage 0 for warmelt-base flavor quicklybuilt done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-base flavored quicklybuilt  from melt-build.tpl line 269


#@ stage 0 for warmelt-debug flavor quicklybuilt  from melt-build.tpl line 223
...
#@ stage 0 for warmelt-debug flavor quicklybuilt  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-debug flavor quicklybuilt  shortmodule from melt-build.tpl line 249 
...
#@ stage 0 for warmelt-debug flavor quicklybuilt  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-debug.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-debug.quicklybuilt.so ; @true

#@ stage 0 for warmelt-debug flavor quicklybuilt done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-debug flavored quicklybuilt  from melt-build.tpl line 269


#@ stage 0 for warmelt-macro flavor quicklybuilt  from melt-build.tpl line 223
...
#@ stage 0 for warmelt-macro flavor quicklybuilt  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-macro flavor quicklybuilt  shortmodule from melt-build.tpl line 249 
...
#@ stage 0 for warmelt-macro flavor quicklybuilt  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-macro.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-macro.quicklybuilt.so ; @true

#@ stage 0 for warmelt-macro flavor quicklybuilt done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-macro flavored quicklybuilt  from melt-build.tpl line 269


#@ stage 0 for warmelt-normal flavor quicklybuilt  from melt-build.tpl line 223
...
#@ stage 0 for warmelt-normal flavor quicklybuilt  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-normal flavor quicklybuilt  shortmodule from melt-build.tpl line 249 
...
#@ stage 0 for warmelt-normal flavor quicklybuilt  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-normal.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-normal.quicklybuilt.so ; @true

#@ stage 0 for warmelt-normal flavor quicklybuilt done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-normal flavored quicklybuilt  from melt-build.tpl line 269


#@ stage 0 for warmelt-normatch flavor quicklybuilt  from melt-build.tpl line 223
...
#@ stage 0 for warmelt-normatch flavor quicklybuilt  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-normatch flavor quicklybuilt  shortmodule from melt-build.tpl line 249 
...
#@ stage 0 for warmelt-normatch flavor quicklybuilt  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-normatch.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-normatch.quicklybuilt.so ; @true

#@ stage 0 for warmelt-normatch flavor quicklybuilt done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-normatch flavored quicklybuilt  from melt-build.tpl line 269


#@ stage 0 for warmelt-genobj flavor quicklybuilt  from melt-build.tpl line 223
...
#@ stage 0 for warmelt-genobj flavor quicklybuilt  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-genobj flavor quicklybuilt  shortmodule from melt-build.tpl line 249 
...
#@ stage 0 for warmelt-genobj flavor quicklybuilt  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-genobj.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-genobj.quicklybuilt.so ; @true

#@ stage 0 for warmelt-genobj flavor quicklybuilt done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-genobj flavored quicklybuilt  from melt-build.tpl line 269


#@ stage 0 for warmelt-outobj flavor quicklybuilt  from melt-build.tpl line 223
...
#@ stage 0 for warmelt-outobj flavor quicklybuilt  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-outobj flavor quicklybuilt  shortmodule from melt-build.tpl line 249 
...
#@ stage 0 for warmelt-outobj flavor quicklybuilt  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-outobj.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-outobj.quicklybuilt.so ; @true

#@ stage 0 for warmelt-outobj flavor quicklybuilt done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-outobj flavored quicklybuilt  from melt-build.tpl line 269


#@ stage 0 for warmelt-modes flavor quicklybuilt  from melt-build.tpl line 223
...
#@ stage 0 for warmelt-modes flavor quicklybuilt  descfiles from melt-build.tpl line 242 
...
#@ stage 0 for warmelt-modes flavor quicklybuilt  shortmodule from melt-build.tpl line 249 
...
#@ stage 0 for warmelt-modes flavor quicklybuilt  stamp from melt-build.tpl line 263 
melt-stage0-warmelt-modes.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-modes.quicklybuilt.so ; @true

#@ stage 0 for warmelt-modes flavor quicklybuilt done  from melt-build.tpl line 267

#### end STAGE0 of warmelt-modes flavored quicklybuilt  from melt-build.tpl line 269



#@ stage 0 flavor quicklybuilt modulelist  from melt-build.tpl line 273 
...
#@ stage 0 flavor quicklybuilt fullstage stamp  from melt-build.tpl line 287 
...
##@ end STAGE0  flavor quicklybuilt  from melt-build.tpl line 295
####-------------------------------------------------------------
...
################################################################
################################################################
#### making our melt stages  from melt-build.tpl line 303


#@  for melt-stage1 from melt-build.tpl line 306
#### rules for melt-stage1, previous $(MELT_STAGE_ZERO)


### the C source of melt-stage1 for warmelt-first from melt-build.tpl line 316

## the timestamp C header file  for warmelt-first from melt-build.tpl line 318
melt-stage1/warmelt-first+melttime.h: melt-stage1/warmelt-first+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-first from melt-build.tpl line 321
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-first+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-first+melt-stage1.args: ; cat warmelt-first+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-first+melt-stage1  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-first+melt-stage1.args
	@ls -l melt-stage1/warmelt-first.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-first.c from melt-build.tpl line 353 ; exit 1 )
...
melt-stage1/warmelt-first.quicklybuilt.so: melt-stage1/warmelt-first.c \
              ...
              $(melt_make_cc1_dependency)
	@echo doing $@  from melt-build.tpl line 361
	+$(MELT_MAKE_MODULE) melt_module \
              GCCMELT_MODULE_WORKSPACE=melt-workdir \
	      GCCMELT_CFLAGS="$(melt_cflags)" \
              GCCMELT_MODULE_FLAVOR=quicklybuilt \
	...
	touch -c $@
	@echo '@@touched' $@  from melt-build.tpl line 369
...
melt-stage1/warmelt-first.debugnoline.so:   melt-stage1/warmelt-first.c \
              ...
              melt-run.h melt-runtime.h melt-predef.h melt-workdir-directory.stamp \
              $(melt_make_cc1_dependency)
	@echo doing $@  from melt-build.tpl line 384
...
### the C source of melt-stage1 for warmelt-base from melt-build.tpl line 316

## the timestamp C header file  for warmelt-base from melt-build.tpl line 318
melt-stage1/warmelt-base+melttime.h: melt-stage1/warmelt-base+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-base from melt-build.tpl line 321
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-base+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-base+melt-stage1.args: ; cat warmelt-base+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-base+melt-stage1  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-base+melt-stage1.args
	@ls -l melt-stage1/warmelt-base.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-base.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage1 for warmelt-debug from melt-build.tpl line 316

## the timestamp C header file  for warmelt-debug from melt-build.tpl line 318
melt-stage1/warmelt-debug+melttime.h: melt-stage1/warmelt-debug+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-debug from melt-build.tpl line 321
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-debug+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-debug+melt-stage1.args: ; cat warmelt-debug+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-debug+melt-stage1  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-debug+melt-stage1.args
	@ls -l melt-stage1/warmelt-debug.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-debug.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage1 for warmelt-macro from melt-build.tpl line 316

## the timestamp C header file  for warmelt-macro from melt-build.tpl line 318
melt-stage1/warmelt-macro+melttime.h: melt-stage1/warmelt-macro+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-macro from melt-build.tpl line 321
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-macro+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-macro+melt-stage1.args: ; cat warmelt-macro+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-macro+melt-stage1  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-macro+melt-stage1.args
	@ls -l melt-stage1/warmelt-macro.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-macro.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage1 for warmelt-normal from melt-build.tpl line 316

## the timestamp C header file  for warmelt-normal from melt-build.tpl line 318
melt-stage1/warmelt-normal+melttime.h: melt-stage1/warmelt-normal+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-normal from melt-build.tpl line 321
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-normal+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-normal+melt-stage1.args: ; cat warmelt-normal+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-normal+melt-stage1  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-normal+melt-stage1.args
	@ls -l melt-stage1/warmelt-normal.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-normal.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage1 for warmelt-normatch from melt-build.tpl line 316

## the timestamp C header file  for warmelt-normatch from melt-build.tpl line 318
melt-stage1/warmelt-normatch+melttime.h: melt-stage1/warmelt-normatch+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-normatch from melt-build.tpl line 321
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-normatch+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-normatch+melt-stage1.args: ; cat warmelt-normatch+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-normatch+melt-stage1  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-normatch+melt-stage1.args
	@ls -l melt-stage1/warmelt-normatch.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-normatch.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage1 for warmelt-genobj from melt-build.tpl line 316

## the timestamp C header file  for warmelt-genobj from melt-build.tpl line 318
melt-stage1/warmelt-genobj+melttime.h: melt-stage1/warmelt-genobj+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-genobj from melt-build.tpl line 321
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-genobj+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-genobj+melt-stage1.args: ; cat warmelt-genobj+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-genobj+melt-stage1  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-genobj+melt-stage1.args
	@ls -l melt-stage1/warmelt-genobj.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-genobj.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage1 for warmelt-outobj from melt-build.tpl line 316

## the timestamp C header file  for warmelt-outobj from melt-build.tpl line 318
melt-stage1/warmelt-outobj+melttime.h: melt-stage1/warmelt-outobj+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-outobj from melt-build.tpl line 321
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-outobj+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-outobj+melt-stage1.args: ; cat warmelt-outobj+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-outobj+melt-stage1  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-outobj+melt-stage1.args
	@ls -l melt-stage1/warmelt-outobj.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-outobj.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage1 for warmelt-modes from melt-build.tpl line 316

## the timestamp C header file  for warmelt-modes from melt-build.tpl line 318
melt-stage1/warmelt-modes+melttime.h: melt-stage1/warmelt-modes+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-modes from melt-build.tpl line 321
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-modes+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-modes+melt-stage1.args: ; cat warmelt-modes+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-modes+melt-stage1  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-modes+melt-stage1.args
	@ls -l melt-stage1/warmelt-modes.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-modes.c from melt-build.tpl line 353 ; exit 1 )
...
#@ from melt-build.tpl line 437 melt-stage1 directory and stamp
melt-stage1:
...
### end of melt-stage1 from melt-build.tpl line 444 


#@  for melt-stage2 from melt-build.tpl line 306
#### rules for melt-stage2, previous melt-stage1


### the C source of melt-stage2 for warmelt-first from melt-build.tpl line 316

## the timestamp C header file  for warmelt-first from melt-build.tpl line 318
melt-stage2/warmelt-first+melttime.h: melt-stage2/warmelt-first+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-first from melt-build.tpl line 321
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-first+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-first+melt-stage2.args: ; cat warmelt-first+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-first+melt-stage2  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-first+melt-stage2.args
	@ls -l melt-stage2/warmelt-first.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-first.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage2 for warmelt-base from melt-build.tpl line 316

## the timestamp C header file  for warmelt-base from melt-build.tpl line 318
melt-stage2/warmelt-base+melttime.h: melt-stage2/warmelt-base+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-base from melt-build.tpl line 321
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-base+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-base+melt-stage2.args: ; cat warmelt-base+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-base+melt-stage2  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-base+melt-stage2.args
	@ls -l melt-stage2/warmelt-base.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-base.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage2 for warmelt-debug from melt-build.tpl line 316

## the timestamp C header file  for warmelt-debug from melt-build.tpl line 318
melt-stage2/warmelt-debug+melttime.h: melt-stage2/warmelt-debug+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-debug from melt-build.tpl line 321
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-debug+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-debug+melt-stage2.args: ; cat warmelt-debug+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-debug+melt-stage2  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-debug+melt-stage2.args
	@ls -l melt-stage2/warmelt-debug.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-debug.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage2 for warmelt-macro from melt-build.tpl line 316

## the timestamp C header file  for warmelt-macro from melt-build.tpl line 318
melt-stage2/warmelt-macro+melttime.h: melt-stage2/warmelt-macro+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-macro from melt-build.tpl line 321
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-macro+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-macro+melt-stage2.args: ; cat warmelt-macro+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-macro+melt-stage2  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-macro+melt-stage2.args
	@ls -l melt-stage2/warmelt-macro.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-macro.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage2 for warmelt-normal from melt-build.tpl line 316

## the timestamp C header file  for warmelt-normal from melt-build.tpl line 318
melt-stage2/warmelt-normal+melttime.h: melt-stage2/warmelt-normal+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-normal from melt-build.tpl line 321
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-normal+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-normal+melt-stage2.args: ; cat warmelt-normal+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-normal+melt-stage2  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-normal+melt-stage2.args
	@ls -l melt-stage2/warmelt-normal.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-normal.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage2 for warmelt-normatch from melt-build.tpl line 316

## the timestamp C header file  for warmelt-normatch from melt-build.tpl line 318
melt-stage2/warmelt-normatch+melttime.h: melt-stage2/warmelt-normatch+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-normatch from melt-build.tpl line 321
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-normatch+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-normatch+melt-stage2.args: ; cat warmelt-normatch+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-normatch+melt-stage2  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-normatch+melt-stage2.args
	@ls -l melt-stage2/warmelt-normatch.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-normatch.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage2 for warmelt-genobj from melt-build.tpl line 316

## the timestamp C header file  for warmelt-genobj from melt-build.tpl line 318
melt-stage2/warmelt-genobj+melttime.h: melt-stage2/warmelt-genobj+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-genobj from melt-build.tpl line 321
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-genobj+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-genobj+melt-stage2.args: ; cat warmelt-genobj+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-genobj+melt-stage2  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-genobj+melt-stage2.args
	@ls -l melt-stage2/warmelt-genobj.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-genobj.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage2 for warmelt-outobj from melt-build.tpl line 316

## the timestamp C header file  for warmelt-outobj from melt-build.tpl line 318
melt-stage2/warmelt-outobj+melttime.h: melt-stage2/warmelt-outobj+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-outobj from melt-build.tpl line 321
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-outobj+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-outobj+melt-stage2.args: ; cat warmelt-outobj+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-outobj+melt-stage2  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-outobj+melt-stage2.args
	@ls -l melt-stage2/warmelt-outobj.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-outobj.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage2 for warmelt-modes from melt-build.tpl line 316

## the timestamp C header file  for warmelt-modes from melt-build.tpl line 318
melt-stage2/warmelt-modes+melttime.h: melt-stage2/warmelt-modes+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-modes from melt-build.tpl line 321
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-modes+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-modes+melt-stage2.args: ; cat warmelt-modes+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-modes+melt-stage2  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-modes+melt-stage2.args
	@ls -l melt-stage2/warmelt-modes.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-modes.c from melt-build.tpl line 353 ; exit 1 )
...
#@ from melt-build.tpl line 437 melt-stage2 directory and stamp
melt-stage2:
...
### end of melt-stage2 from melt-build.tpl line 444 


#@  for melt-stage3 from melt-build.tpl line 306
#### rules for melt-stage3, previous melt-stage2


### the C source of melt-stage3 for warmelt-first from melt-build.tpl line 316

## the timestamp C header file  for warmelt-first from melt-build.tpl line 318
melt-stage3/warmelt-first+melttime.h: melt-stage3/warmelt-first+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-first from melt-build.tpl line 321
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-first+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-first+melt-stage3.args: ; cat warmelt-first+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-first+melt-stage3  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-first+melt-stage3.args
	@ls -l melt-stage3/warmelt-first.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-first.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage3 for warmelt-base from melt-build.tpl line 316

## the timestamp C header file  for warmelt-base from melt-build.tpl line 318
melt-stage3/warmelt-base+melttime.h: melt-stage3/warmelt-base+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-base from melt-build.tpl line 321
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-base+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-base+melt-stage3.args: ; cat warmelt-base+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-base+melt-stage3  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-base+melt-stage3.args
	@ls -l melt-stage3/warmelt-base.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-base.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage3 for warmelt-debug from melt-build.tpl line 316

## the timestamp C header file  for warmelt-debug from melt-build.tpl line 318
melt-stage3/warmelt-debug+melttime.h: melt-stage3/warmelt-debug+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-debug from melt-build.tpl line 321
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-debug+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-debug+melt-stage3.args: ; cat warmelt-debug+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-debug+melt-stage3  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-debug+melt-stage3.args
	@ls -l melt-stage3/warmelt-debug.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-debug.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage3 for warmelt-macro from melt-build.tpl line 316

## the timestamp C header file  for warmelt-macro from melt-build.tpl line 318
melt-stage3/warmelt-macro+melttime.h: melt-stage3/warmelt-macro+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-macro from melt-build.tpl line 321
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-macro+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-macro+melt-stage3.args: ; cat warmelt-macro+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-macro+melt-stage3  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-macro+melt-stage3.args
	@ls -l melt-stage3/warmelt-macro.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-macro.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage3 for warmelt-normal from melt-build.tpl line 316

## the timestamp C header file  for warmelt-normal from melt-build.tpl line 318
melt-stage3/warmelt-normal+melttime.h: melt-stage3/warmelt-normal+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-normal from melt-build.tpl line 321
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-normal+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-normal+melt-stage3.args: ; cat warmelt-normal+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-normal+melt-stage3  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-normal+melt-stage3.args
	@ls -l melt-stage3/warmelt-normal.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-normal.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage3 for warmelt-normatch from melt-build.tpl line 316

## the timestamp C header file  for warmelt-normatch from melt-build.tpl line 318
melt-stage3/warmelt-normatch+melttime.h: melt-stage3/warmelt-normatch+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-normatch from melt-build.tpl line 321
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-normatch+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-normatch+melt-stage3.args: ; cat warmelt-normatch+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-normatch+melt-stage3  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-normatch+melt-stage3.args
	@ls -l melt-stage3/warmelt-normatch.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-normatch.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage3 for warmelt-genobj from melt-build.tpl line 316

## the timestamp C header file  for warmelt-genobj from melt-build.tpl line 318
melt-stage3/warmelt-genobj+melttime.h: melt-stage3/warmelt-genobj+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-genobj from melt-build.tpl line 321
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-genobj+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-genobj+melt-stage3.args: ; cat warmelt-genobj+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-genobj+melt-stage3  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-genobj+melt-stage3.args
	@ls -l melt-stage3/warmelt-genobj.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-genobj.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage3 for warmelt-outobj from melt-build.tpl line 316

## the timestamp C header file  for warmelt-outobj from melt-build.tpl line 318
melt-stage3/warmelt-outobj+melttime.h: melt-stage3/warmelt-outobj+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-outobj from melt-build.tpl line 321
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-outobj+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-outobj+melt-stage3.args: ; cat warmelt-outobj+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-outobj+melt-stage3  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-outobj+melt-stage3.args
	@ls -l melt-stage3/warmelt-outobj.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-outobj.c from melt-build.tpl line 353 ; exit 1 )
...
### the C source of melt-stage3 for warmelt-modes from melt-build.tpl line 316

## the timestamp C header file  for warmelt-modes from melt-build.tpl line 318
melt-stage3/warmelt-modes+melttime.h: melt-stage3/warmelt-modes+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-modes from melt-build.tpl line 321
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-modes+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-modes+melt-stage3.args: ; cat warmelt-modes+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 350
	@echo doing warmelt-modes+melt-stage3  from melt-build.tpl line 351
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-modes+melt-stage3.args
	@ls -l melt-stage3/warmelt-modes.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-modes.c from melt-build.tpl line 353 ; exit 1 )
...
#@ from melt-build.tpl line 437 melt-stage3 directory and stamp
melt-stage3:
...
### end of melt-stage3 from melt-build.tpl line 444 
...
####### final targets from melt-build.tpl line 464
...
### the final module directory from melt-build.tpl line 469
melt-modules: 
...
### the final source directory from melt-build.tpl line 475
melt-sources: 
...
### all sources from melt-build.tpl line 482
...
#### melt-sources translator files from melt-build.tpl line 494

#@ from melt-build.tpl line 496


## melt translator warmelt-first # 0 from melt-build.tpl line 499
melt-sources/warmelt-first.melt: $(melt_make_source_dir)/warmelt-first.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 501; ls -l $(melt_make_source_dir)/warmelt-first.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-first.melt warmelt-first.melt

### melt included files with (load ...) macro from melt-build.tpl line 504


# MELT translator warmelt-first in melt-sources/ timestamp from melt-build.tpl line 513
...
# MELT translator warmelt-first in melt-sources/ C files from melt-build.tpl line 517
melt-sources/warmelt-first.c melt-sources/warmelt-first+meltdesc.c: \
    melt-sources/warmelt-first.melt  melt-sources-directory.stamp  \
                    ...
                    $(melt_make_cc1_dependency)
	@echo doing $@  from melt-build.tpl line 524
	...
	@echo; echo; echo; echo -n warmelt-first+sources.args: ; cat warmelt-first+sources.args ; echo "***** doing " $@ from melt-build.tpl line 533
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-first+sources.args



#@  base= warmelt-first from melt-build.tpl line 538
melt-modules/warmelt-first.optimized.so: melt-sources/warmelt-first.c \
	...
	@echo doing $@  from melt-build.tpl line 543
	+$(MELT_MAKE_MODULE) melt_module \
	      GCCMELT_CFLAGS="$(melt_cflags)" \
...
#@  base= warmelt-first from melt-build.tpl line 551
melt-modules/warmelt-first.debugnoline.so: melt-sources/warmelt-first.c \
   $(wildcard  melt-sources/warmelt-first+*.c) \
   melt-modules-directory.stamp melt-sources-directory.stamp  melt-workdir-directory.stamp \
   melt-run.h melt-runtime.h 
	@echo doing $@  from melt-build.tpl line 556
	+$(MELT_MAKE_MODULE) melt_module \
	      GCCMELT_CFLAGS="$(melt_cflags)" \
	      GCCMELT_MODULE_FLAVOR=debugnoline \
              GCCMELT_MODULE_WORKSPACE=melt-workdir \
...
melt-modules/warmelt-first.quicklybuilt.so: melt-sources/warmelt-first.c \
    ...
    melt-modules-directory.stamp melt-sources-directory.stamp  melt-workdir-directory.stamp \
    melt-run.h melt-runtime.h 
	@echo doing $@  from melt-build.tpl line 569
	+$(MELT_MAKE_MODULE) melt_module \
	      GCCMELT_MODULE_FLAVOR=quicklybuilt \
	      GCCMELT_CFLAGS="$(melt_cflags)" \
	      GCCMELT_MODULE_SOURCEBASE=melt-sources/warmelt-first \
...
#@  warmelt-first from melt-build.tpl line 578

#@ from melt-build.tpl line 496


## melt translator warmelt-base # 1 from melt-build.tpl line 499
melt-sources/warmelt-base.melt: $(melt_make_source_dir)/warmelt-base.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 501; ls -l $(melt_make_source_dir)/warmelt-base.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-base.melt warmelt-base.melt

### melt included files with (load ...) macro from melt-build.tpl line 504


# MELT translator warmelt-base in melt-sources/ timestamp from melt-build.tpl line 513
...
# MELT translator warmelt-base in melt-sources/ C files from melt-build.tpl line 517
melt-sources/warmelt-base.c melt-sources/warmelt-base+meltdesc.c: \
	...
	@echo; echo; echo; echo -n warmelt-base+sources.args: ; cat warmelt-base+sources.args ; echo "***** doing " $@ from melt-build.tpl line 533
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-base+sources.args



#@  base= warmelt-base from melt-build.tpl line 538
...
#@  base= warmelt-base from melt-build.tpl line 551
...
#@  warmelt-base from melt-build.tpl line 578

#@ from melt-build.tpl line 496


## melt translator warmelt-debug # 2 from melt-build.tpl line 499
melt-sources/warmelt-debug.melt: $(melt_make_source_dir)/warmelt-debug.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 501; ls -l $(melt_make_source_dir)/warmelt-debug.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-debug.melt warmelt-debug.melt

### melt included files with (load ...) macro from melt-build.tpl line 504


# MELT translator warmelt-debug in melt-sources/ timestamp from melt-build.tpl line 513
...
# MELT translator warmelt-debug in melt-sources/ C files from melt-build.tpl line 517
melt-sources/warmelt-debug.c melt-sources/warmelt-debug+meltdesc.c: \
	...
	@echo; echo; echo; echo -n warmelt-debug+sources.args: ; cat warmelt-debug+sources.args ; echo "***** doing " $@ from melt-build.tpl line 533
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-debug+sources.args



#@  base= warmelt-debug from melt-build.tpl line 538
...
#@  base= warmelt-debug from melt-build.tpl line 551
...
#@  warmelt-debug from melt-build.tpl line 578

#@ from melt-build.tpl line 496


## melt translator warmelt-macro # 3 from melt-build.tpl line 499
melt-sources/warmelt-macro.melt: $(melt_make_source_dir)/warmelt-macro.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 501; ls -l $(melt_make_source_dir)/warmelt-macro.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-macro.melt warmelt-macro.melt

### melt included files with (load ...) macro from melt-build.tpl line 504


# MELT translator warmelt-macro in melt-sources/ timestamp from melt-build.tpl line 513
...
# MELT translator warmelt-macro in melt-sources/ C files from melt-build.tpl line 517
melt-sources/warmelt-macro.c melt-sources/warmelt-macro+meltdesc.c: \
	...
	@echo; echo; echo; echo -n warmelt-macro+sources.args: ; cat warmelt-macro+sources.args ; echo "***** doing " $@ from melt-build.tpl line 533
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-macro+sources.args



#@  base= warmelt-macro from melt-build.tpl line 538
...
#@  base= warmelt-macro from melt-build.tpl line 551
...
#@  warmelt-macro from melt-build.tpl line 578

#@ from melt-build.tpl line 496


## melt translator warmelt-normal # 4 from melt-build.tpl line 499
melt-sources/warmelt-normal.melt: $(melt_make_source_dir)/warmelt-normal.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 501; ls -l $(melt_make_source_dir)/warmelt-normal.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-normal.melt warmelt-normal.melt

### melt included files with (load ...) macro from melt-build.tpl line 504

# included warmelt-predef.melt from melt-build.tpl line 506
...
# MELT translator warmelt-normal in melt-sources/ timestamp from melt-build.tpl line 513
...
# MELT translator warmelt-normal in melt-sources/ C files from melt-build.tpl line 517
melt-sources/warmelt-normal.c melt-sources/warmelt-normal+meltdesc.c: \
	...
	@echo; echo; echo; echo -n warmelt-normal+sources.args: ; cat warmelt-normal+sources.args ; echo "***** doing " $@ from melt-build.tpl line 533
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-normal+sources.args



#@  base= warmelt-normal from melt-build.tpl line 538
...
#@  base= warmelt-normal from melt-build.tpl line 551
...
#@  warmelt-normal from melt-build.tpl line 578

#@ from melt-build.tpl line 496


## melt translator warmelt-normatch # 5 from melt-build.tpl line 499
melt-sources/warmelt-normatch.melt: $(melt_make_source_dir)/warmelt-normatch.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 501; ls -l $(melt_make_source_dir)/warmelt-normatch.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-normatch.melt warmelt-normatch.melt

### melt included files with (load ...) macro from melt-build.tpl line 504


# MELT translator warmelt-normatch in melt-sources/ timestamp from melt-build.tpl line 513
...
# MELT translator warmelt-normatch in melt-sources/ C files from melt-build.tpl line 517
melt-sources/warmelt-normatch.c melt-sources/warmelt-normatch+meltdesc.c: \
	...
	@echo; echo; echo; echo -n warmelt-normatch+sources.args: ; cat warmelt-normatch+sources.args ; echo "***** doing " $@ from melt-build.tpl line 533
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-normatch+sources.args



#@  base= warmelt-normatch from melt-build.tpl line 538
...
#@  base= warmelt-normatch from melt-build.tpl line 551
...
#@  warmelt-normatch from melt-build.tpl line 578

#@ from melt-build.tpl line 496


## melt translator warmelt-genobj # 6 from melt-build.tpl line 499
melt-sources/warmelt-genobj.melt: $(melt_make_source_dir)/warmelt-genobj.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 501; ls -l $(melt_make_source_dir)/warmelt-genobj.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-genobj.melt warmelt-genobj.melt

### melt included files with (load ...) macro from melt-build.tpl line 504


# MELT translator warmelt-genobj in melt-sources/ timestamp from melt-build.tpl line 513
...
# MELT translator warmelt-genobj in melt-sources/ C files from melt-build.tpl line 517
melt-sources/warmelt-genobj.c melt-sources/warmelt-genobj+meltdesc.c: \
	...
	@echo; echo; echo; echo -n warmelt-genobj+sources.args: ; cat warmelt-genobj+sources.args ; echo "***** doing " $@ from melt-build.tpl line 533
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-genobj+sources.args



#@  base= warmelt-genobj from melt-build.tpl line 538
...
#@  base= warmelt-genobj from melt-build.tpl line 551
...
#@  warmelt-genobj from melt-build.tpl line 578

#@ from melt-build.tpl line 496


## melt translator warmelt-outobj # 7 from melt-build.tpl line 499
melt-sources/warmelt-outobj.melt: $(melt_make_source_dir)/warmelt-outobj.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 501; ls -l $(melt_make_source_dir)/warmelt-outobj.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-outobj.melt warmelt-outobj.melt

### melt included files with (load ...) macro from melt-build.tpl line 504


# MELT translator warmelt-outobj in melt-sources/ timestamp from melt-build.tpl line 513
...
# MELT translator warmelt-outobj in melt-sources/ C files from melt-build.tpl line 517
melt-sources/warmelt-outobj.c melt-sources/warmelt-outobj+meltdesc.c: \
	...
	@echo; echo; echo; echo -n warmelt-outobj+sources.args: ; cat warmelt-outobj+sources.args ; echo "***** doing " $@ from melt-build.tpl line 533
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-outobj+sources.args



#@  base= warmelt-outobj from melt-build.tpl line 538
...
#@  base= warmelt-outobj from melt-build.tpl line 551
...
#@  warmelt-outobj from melt-build.tpl line 578

#@ from melt-build.tpl line 496


## melt translator warmelt-modes # 8 from melt-build.tpl line 499
melt-sources/warmelt-modes.melt: $(melt_make_source_dir)/warmelt-modes.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 501; ls -l $(melt_make_source_dir)/warmelt-modes.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-modes.melt warmelt-modes.melt

### melt included files with (load ...) macro from melt-build.tpl line 504


# MELT translator warmelt-modes in melt-sources/ timestamp from melt-build.tpl line 513
...
# MELT translator warmelt-modes in melt-sources/ C files from melt-build.tpl line 517
melt-sources/warmelt-modes.c melt-sources/warmelt-modes+meltdesc.c: \
	...
	@echo; echo; echo; echo -n warmelt-modes+sources.args: ; cat warmelt-modes+sources.args ; echo "***** doing " $@ from melt-build.tpl line 533
	$(MELT_RUNNER) $(melt_make_cc1) @warmelt-modes+sources.args



#@  base= warmelt-modes from melt-build.tpl line 538
...
#@  base= warmelt-modes from melt-build.tpl line 551
...
#@  warmelt-modes from melt-build.tpl line 578


#@ from melt-build.tpl line 581


#@ from melt-build.tpl line 584
...
melt-modules/warmelt-modes.optimized.so 
	@echo building quicklybuilt module list $@ from melt-build.tpl line 587
...
melt-modules/warmelt-outobj.optimized.so  \
melt-modules/warmelt-modes.optimized.so 
	@echo building optimized module list $@ from melt-build.tpl line 587
...
melt-modules/warmelt-outobj.optimized.so  \
melt-modules/warmelt-modes.optimized.so 
	@echo building debugnoline module list $@ from melt-build.tpl line 587
...
melt-sources/xtramelt-ana-base.c: \
  ...
  \
   ...
   empty-file-for-melt.c melt-run.h melt-runtime.h \
   $(melt_make_cc1_dependency)
	@echo doing $@  from melt-build.tpl line 621 with quicklybuilt warmelt
	...
	@echo; echo; echo; echo -n $(notdir $(basename $@))-quickb.args: ; cat $(notdir $(basename $@))-quickb.args ; echo "***** doing " $@ from melt-build.tpl line 630
	$(MELT_RUNNER) $(melt_make_cc1) @$(notdir $(basename $@))-quickb.args
#@ from melt-build.tpl line 632
	@echo doing $@  from melt-build.tpl line 633 with optimized warmelt
	@echo 	$(MELTCCAPPLICATION1ARGS) \
	     $(meltarg_arg)=$<  -frandom-seed=$(shell $(MD5SUM) $< | cut -b-24) \
	     $(meltarg_module_path)=$(realpath melt-modules) \
	     $(meltarg_source_path)=$(realpath melt-sources) \
	...
	@echo; echo; echo; echo -n $(notdir $(basename $@))-optim.args: ; cat $(notdir $(basename $@))-optim.args ; echo "***** doing " $@ from melt-build.tpl line 642
...
## melt application xtramelt-ana-base flavor quicklybuilt  from melt-build.tpl line 649
melt-modules/xtramelt-ana-base.quicklybuilt.so: melt-sources-directory.stamp \
     ...
     melt-run.h melt-runtime.h 
	@echo doing $@  from melt-build.tpl line 654
	+$(MELT_MAKE_MODULE) melt_module \
	      GCCMELT_MODULE_FLAVOR=quicklybuilt \
	      GCCMELT_CFLAGS="$(melt_cflags)" \
              GCCMELT_MODULE_WORKSPACE=melt-workdir \
...
#@ from melt-build.tpl line 662 xtramelt-ana-base.quicklybuilt

## melt application xtramelt-ana-base flavor optimized  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-ana-base.optimized

## melt application xtramelt-ana-base flavor debugnoline  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-ana-base.debugnoline

#@ from melt-build.tpl line 664

# end application xtramelt-ana-base

#@ from melt-build.tpl line 668
...
## melt application xtramelt-ana-tree flavor quicklybuilt  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-ana-tree.quicklybuilt

## melt application xtramelt-ana-tree flavor optimized  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-ana-tree.optimized

## melt application xtramelt-ana-tree flavor debugnoline  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-ana-tree.debugnoline
...
## melt application xtramelt-ana-gimple flavor quicklybuilt  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-ana-gimple.quicklybuilt

## melt application xtramelt-ana-gimple flavor optimized  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-ana-gimple.optimized

## melt application xtramelt-ana-gimple flavor debugnoline  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-ana-gimple.debugnoline
...
## melt application xtramelt-probe flavor quicklybuilt  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-probe.quicklybuilt

## melt application xtramelt-probe flavor optimized  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-probe.optimized

## melt application xtramelt-probe flavor debugnoline  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-probe.debugnoline
...
## melt application xtramelt-ana-simple flavor quicklybuilt  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-ana-simple.quicklybuilt

## melt application xtramelt-ana-simple flavor optimized  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-ana-simple.optimized

## melt application xtramelt-ana-simple flavor debugnoline  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-ana-simple.debugnoline
...
## melt application xtramelt-c-generator flavor quicklybuilt  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-c-generator.quicklybuilt

## melt application xtramelt-c-generator flavor optimized  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-c-generator.optimized

## melt application xtramelt-c-generator flavor debugnoline  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-c-generator.debugnoline
...
## melt application xtramelt-opengpu flavor quicklybuilt  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-opengpu.quicklybuilt

## melt application xtramelt-opengpu flavor optimized  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-opengpu.optimized

## melt application xtramelt-opengpu flavor debugnoline  from melt-build.tpl line 649
...
#@ from melt-build.tpl line 662 xtramelt-opengpu.debugnoline
...
melt-tiny-tests: melt-sayhello.melt melt-modules melt-sources \
		...
		$(MELT_RUNTIME_C)
# test that a helloworld can be translated from melt-build.tpl line 682
	@echo doing $@  from melt-build.tpl line 683
	@echo	$(MELTCCAPPLICATION1ARGS) \
	     $(meltarg_arg)=$<  -frandom-seed=$(shell $(MD5SUM) $< | cut -b-24) \
	     $(meltarg_module_path)=$(realpath melt-modules) \
	     $(meltarg_source_path)=$(realpath melt-sources) \
	...
	@echo; echo; echo; echo -n $(basename $<).args: ; cat $(basename $<).args ; echo "***** doing " $(basename $<)  from melt-build.tpl line 691
	$(MELT_RUNNER) $(melt_make_cc1) @$(basename $<).args
# test that a helloworld can be run from melt-build.tpl line 693
	...
	@echo; echo; echo; echo -n $(basename $<)-run.args: ; cat $(basename $<)-run.args ; echo "***** doing " $(basename $<)-run  from melt-build.tpl line 701
...
# test melt-runtime from melt-build.tpl line 705
	...
	@echo; echo; echo; echo -n meltframe.args: ; cat meltframe.args ; echo "***** doing " meltframe  from melt-build.tpl line 721
...
#@ from melt-build.tpl line 774
### MELT upgrade
.PHONY: warmelt-upgrade-translator meltrun-generate


#@ from melt-build.tpl line 779
...
#@ from melt-build.tpl line 817

#@ from melt-build.tpl line 819
	@echo upgrading MELT translator warmelt-first
## dont indent the warmelt-first+meltdesc.c or warmelt-first+melttime.h ::: from melt-build.tpl line 821
...
#@ from melt-build.tpl line 840
#

#@ from melt-build.tpl line 819
	@echo upgrading MELT translator warmelt-base
## dont indent the warmelt-base+meltdesc.c or warmelt-base+melttime.h ::: from melt-build.tpl line 821
...
## dont indent the warmelt-debug+meltdesc.c or warmelt-debug+melttime.h ::: from melt-build.tpl line 821
...
## dont indent the warmelt-macro+meltdesc.c or warmelt-macro+melttime.h ::: from melt-build.tpl line 821
...
## dont indent the warmelt-normal+meltdesc.c or warmelt-normal+melttime.h ::: from melt-build.tpl line 821
...
## dont indent the warmelt-normatch+meltdesc.c or warmelt-normatch+melttime.h ::: from melt-build.tpl line 821
...
## dont indent the warmelt-genobj+meltdesc.c or warmelt-genobj+melttime.h ::: from melt-build.tpl line 821
...
## dont indent the warmelt-outobj+meltdesc.c or warmelt-outobj+melttime.h ::: from melt-build.tpl line 821
...
## dont indent the warmelt-modes+meltdesc.c or warmelt-modes+melttime.h ::: from melt-build.tpl line 821
...
### MELT cleanup  from melt-build.tpl line 876
.PHONY: melt-clean
melt-clean:
