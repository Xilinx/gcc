...
#@#@# 
#@#@# It has been AutoGen-ed  January 13, 2012 at 12:15:58 PM by AutoGen 5.12
...
#@ from melt-build.tpl line 62 name= melt_make_move comment=   a move if change command for MELT
ifndef melt_make_move
$(warning unknown melt_make_move :::  a move if change command for MELT)
endif
...
## The base name of the MELT translator files from melt-build.tpl line 147
...
## the MELT translator MELT source files from melt-build.tpl line 151
MELT_TRANSLATOR_SOURCE= $(patsubst %,$(melt_make_source_dir)/%.melt,$(MELT_TRANSLATOR_BASE))

## The base name of the MELT application files from melt-build.tpl line 154
...
## The MELT application source files from melt-build.tpl line 158
MELT_APPLICATION_SOURCE= $(patsubst %,$(melt_make_source_dir)/%.melt,$(MELT_APPLICATION_BASE))

## The cold stage 0 of the translator from melt-build.tpl line 161

#@ The C files of the stage 0 are deposited from melt-build.tpl line 163
...
# The base names of stage 0 files from melt-build.tpl line 167
MELT_ZERO_GENERATED_FIRST_BASE= \
                  $(basename $(notdir $(MELT_GENERATED_FIRST_C_FILES)))
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 170
## avoid spaces in MELT_GENERATED_FIRST_CUMULMD5 below from melt-build.tpl line 171
...
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 170
## avoid spaces in MELT_GENERATED_BASE_CUMULMD5 below from melt-build.tpl line 171
...
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 170
## avoid spaces in MELT_GENERATED_DEBUG_CUMULMD5 below from melt-build.tpl line 171
...
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 170
## avoid spaces in MELT_GENERATED_MACRO_CUMULMD5 below from melt-build.tpl line 171
...
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 170
## avoid spaces in MELT_GENERATED_NORMAL_CUMULMD5 below from melt-build.tpl line 171
...
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 170
## avoid spaces in MELT_GENERATED_NORMATCH_CUMULMD5 below from melt-build.tpl line 171
...
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 170
## avoid spaces in MELT_GENERATED_GENOBJ_CUMULMD5 below from melt-build.tpl line 171
...
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 170
## avoid spaces in MELT_GENERATED_OUTOBJ_CUMULMD5 below from melt-build.tpl line 171
...
# for stage 0 files, we don't compute the checksum, we extract what was deposited from melt-build.tpl line 170
## avoid spaces in MELT_GENERATED_MODES_CUMULMD5 below from melt-build.tpl line 171
...
#@ the required work directory from melt-build.tpl line 175
melt-workdir:
	mkdir -p melt-workdir
	ls -ld $$PWD/melt-workdir > melt-workdir-directory.stamp

#@ the work directory timestamp  from melt-build.tpl line 180
melt-workdir-directory.stamp: melt-workdir ; @true

####----------------------------------------------------------------


## An empty file is needed for every MELT translation from melt-build.tpl line 186
empty-file-for-melt.c:
	date +"/* empty-file-for-melt.c %c */" > $@-tmp
	mv $@-tmp $@

## can be overridden manually to either melt-stage0-dynamic or
## melt-stage0-quicklybuilt  from melt-build.tpl line 192
.PHONY: warmelt0
...
melt-stage0-dynamic/warmelt-first.$(MELT_ZERO_GENERATED_FIRST_CUMULMD5).dynamic.so:  $(MELT_ZERO_GENERATED_FIRST_C_FILES) \
	...
	@echo  from melt-build.tpl line 227 $@
	-ls -l melt-stage0-dynamic/warmelt-first* melt-workdir/$(notdir $@) $@

#@ stage 0 for warmelt-first flavor dynamic  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-first flavor dynamic  shortmodule from melt-build.tpl line 237 
melt-stage0-dynamic/warmelt-first.dynamic.so: \
  melt-stage0-dynamic/warmelt-first.$(MELT_ZERO_GENERATED_FIRST_CUMULMD5).dynamic.so
	@echo  from melt-build.tpl line 240 $@
	-ls -l $< $@
	@echo  from melt-build.tpl line 242 $@
	cd melt-stage0-dynamic/ ; $(LN_S) -v -f $(notdir $<) $(notdir $@)
	-ls -l $< $@
	$(MD5SUM) $@ > melt-stage0-warmelt-first.dynamic-module.stamp-tmp
	$(melt_make_move) melt-stage0-warmelt-first.dynamic-module.stamp-tmp \
             melt-stage0-warmelt-first.dynamic-module.stamp

#@ stage 0 for warmelt-first flavor dynamic  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-first.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-first.dynamic.so ; @true

#@ stage 0 for warmelt-first flavor dynamic done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-first flavored dynamic  from melt-build.tpl line 255
...
#@ stage 0 for warmelt-base flavor dynamic  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-base flavor dynamic  shortmodule from melt-build.tpl line 237 
melt-stage0-dynamic/warmelt-base.dynamic.so: \
  melt-stage0-dynamic/warmelt-base.$(MELT_ZERO_GENERATED_BASE_CUMULMD5).dynamic.so
	...
	$(melt_make_move) melt-stage0-warmelt-base.dynamic-module.stamp-tmp \
             melt-stage0-warmelt-base.dynamic-module.stamp

#@ stage 0 for warmelt-base flavor dynamic  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-base.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-base.dynamic.so ; @true

#@ stage 0 for warmelt-base flavor dynamic done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-base flavored dynamic  from melt-build.tpl line 255
...
#@ stage 0 for warmelt-debug flavor dynamic  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-debug flavor dynamic  shortmodule from melt-build.tpl line 237 
melt-stage0-dynamic/warmelt-debug.dynamic.so: \
  melt-stage0-dynamic/warmelt-debug.$(MELT_ZERO_GENERATED_DEBUG_CUMULMD5).dynamic.so
	...
	$(melt_make_move) melt-stage0-warmelt-debug.dynamic-module.stamp-tmp \
             melt-stage0-warmelt-debug.dynamic-module.stamp

#@ stage 0 for warmelt-debug flavor dynamic  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-debug.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-debug.dynamic.so ; @true

#@ stage 0 for warmelt-debug flavor dynamic done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-debug flavored dynamic  from melt-build.tpl line 255
...
#@ stage 0 for warmelt-macro flavor dynamic  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-macro flavor dynamic  shortmodule from melt-build.tpl line 237 
melt-stage0-dynamic/warmelt-macro.dynamic.so: \
  melt-stage0-dynamic/warmelt-macro.$(MELT_ZERO_GENERATED_MACRO_CUMULMD5).dynamic.so
	...
	$(melt_make_move) melt-stage0-warmelt-macro.dynamic-module.stamp-tmp \
             melt-stage0-warmelt-macro.dynamic-module.stamp

#@ stage 0 for warmelt-macro flavor dynamic  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-macro.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-macro.dynamic.so ; @true

#@ stage 0 for warmelt-macro flavor dynamic done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-macro flavored dynamic  from melt-build.tpl line 255
...
#@ stage 0 for warmelt-normal flavor dynamic  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-normal flavor dynamic  shortmodule from melt-build.tpl line 237 
melt-stage0-dynamic/warmelt-normal.dynamic.so: \
  melt-stage0-dynamic/warmelt-normal.$(MELT_ZERO_GENERATED_NORMAL_CUMULMD5).dynamic.so
	...
	$(melt_make_move) melt-stage0-warmelt-normal.dynamic-module.stamp-tmp \
             melt-stage0-warmelt-normal.dynamic-module.stamp

#@ stage 0 for warmelt-normal flavor dynamic  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-normal.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-normal.dynamic.so ; @true

#@ stage 0 for warmelt-normal flavor dynamic done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-normal flavored dynamic  from melt-build.tpl line 255
...
#@ stage 0 for warmelt-normatch flavor dynamic  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-normatch flavor dynamic  shortmodule from melt-build.tpl line 237 
melt-stage0-dynamic/warmelt-normatch.dynamic.so: \
  melt-stage0-dynamic/warmelt-normatch.$(MELT_ZERO_GENERATED_NORMATCH_CUMULMD5).dynamic.so
	...
	$(melt_make_move) melt-stage0-warmelt-normatch.dynamic-module.stamp-tmp \
             melt-stage0-warmelt-normatch.dynamic-module.stamp

#@ stage 0 for warmelt-normatch flavor dynamic  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-normatch.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-normatch.dynamic.so ; @true

#@ stage 0 for warmelt-normatch flavor dynamic done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-normatch flavored dynamic  from melt-build.tpl line 255
...
#@ stage 0 for warmelt-genobj flavor dynamic  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-genobj flavor dynamic  shortmodule from melt-build.tpl line 237 
melt-stage0-dynamic/warmelt-genobj.dynamic.so: \
  melt-stage0-dynamic/warmelt-genobj.$(MELT_ZERO_GENERATED_GENOBJ_CUMULMD5).dynamic.so
	...
	$(melt_make_move) melt-stage0-warmelt-genobj.dynamic-module.stamp-tmp \
             melt-stage0-warmelt-genobj.dynamic-module.stamp

#@ stage 0 for warmelt-genobj flavor dynamic  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-genobj.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-genobj.dynamic.so ; @true

#@ stage 0 for warmelt-genobj flavor dynamic done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-genobj flavored dynamic  from melt-build.tpl line 255
...
#@ stage 0 for warmelt-outobj flavor dynamic  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-outobj flavor dynamic  shortmodule from melt-build.tpl line 237 
melt-stage0-dynamic/warmelt-outobj.dynamic.so: \
  melt-stage0-dynamic/warmelt-outobj.$(MELT_ZERO_GENERATED_OUTOBJ_CUMULMD5).dynamic.so
	...
	$(melt_make_move) melt-stage0-warmelt-outobj.dynamic-module.stamp-tmp \
             melt-stage0-warmelt-outobj.dynamic-module.stamp

#@ stage 0 for warmelt-outobj flavor dynamic  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-outobj.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-outobj.dynamic.so ; @true

#@ stage 0 for warmelt-outobj flavor dynamic done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-outobj flavored dynamic  from melt-build.tpl line 255
...
#@ stage 0 for warmelt-modes flavor dynamic  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-modes flavor dynamic  shortmodule from melt-build.tpl line 237 
melt-stage0-dynamic/warmelt-modes.dynamic.so: \
  melt-stage0-dynamic/warmelt-modes.$(MELT_ZERO_GENERATED_MODES_CUMULMD5).dynamic.so
	...
	$(melt_make_move) melt-stage0-warmelt-modes.dynamic-module.stamp-tmp \
             melt-stage0-warmelt-modes.dynamic-module.stamp

#@ stage 0 for warmelt-modes flavor dynamic  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-modes.dynamic-module.stamp: \
  melt-stage0-dynamic/warmelt-modes.dynamic.so ; @true

#@ stage 0 for warmelt-modes flavor dynamic done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-modes flavored dynamic  from melt-build.tpl line 255



#@ stage 0 flavor dynamic modulelist  from melt-build.tpl line 259 
...
#@ stage 0 flavor dynamic fullstage stamp  from melt-build.tpl line 273 
...
##@ end STAGE0  flavor dynamic  from melt-build.tpl line 279
####-------------------------------------------------------------
...
#@ stage 0 for warmelt-first flavor quicklybuilt  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-first flavor quicklybuilt  shortmodule from melt-build.tpl line 237 
melt-stage0-quicklybuilt/warmelt-first.quicklybuilt.so: \
  melt-stage0-quicklybuilt/warmelt-first.$(MELT_ZERO_GENERATED_FIRST_CUMULMD5).quicklybuilt.so
	...
	$(melt_make_move) melt-stage0-warmelt-first.quicklybuilt-module.stamp-tmp \
             melt-stage0-warmelt-first.quicklybuilt-module.stamp

#@ stage 0 for warmelt-first flavor quicklybuilt  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-first.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-first.quicklybuilt.so ; @true

#@ stage 0 for warmelt-first flavor quicklybuilt done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-first flavored quicklybuilt  from melt-build.tpl line 255
...
#@ stage 0 for warmelt-base flavor quicklybuilt  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-base flavor quicklybuilt  shortmodule from melt-build.tpl line 237 
melt-stage0-quicklybuilt/warmelt-base.quicklybuilt.so: \
  melt-stage0-quicklybuilt/warmelt-base.$(MELT_ZERO_GENERATED_BASE_CUMULMD5).quicklybuilt.so
	...
	$(melt_make_move) melt-stage0-warmelt-base.quicklybuilt-module.stamp-tmp \
             melt-stage0-warmelt-base.quicklybuilt-module.stamp

#@ stage 0 for warmelt-base flavor quicklybuilt  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-base.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-base.quicklybuilt.so ; @true

#@ stage 0 for warmelt-base flavor quicklybuilt done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-base flavored quicklybuilt  from melt-build.tpl line 255
...
#@ stage 0 for warmelt-debug flavor quicklybuilt  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-debug flavor quicklybuilt  shortmodule from melt-build.tpl line 237 
melt-stage0-quicklybuilt/warmelt-debug.quicklybuilt.so: \
  melt-stage0-quicklybuilt/warmelt-debug.$(MELT_ZERO_GENERATED_DEBUG_CUMULMD5).quicklybuilt.so
	...
	$(melt_make_move) melt-stage0-warmelt-debug.quicklybuilt-module.stamp-tmp \
             melt-stage0-warmelt-debug.quicklybuilt-module.stamp

#@ stage 0 for warmelt-debug flavor quicklybuilt  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-debug.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-debug.quicklybuilt.so ; @true

#@ stage 0 for warmelt-debug flavor quicklybuilt done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-debug flavored quicklybuilt  from melt-build.tpl line 255
...
#@ stage 0 for warmelt-macro flavor quicklybuilt  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-macro flavor quicklybuilt  shortmodule from melt-build.tpl line 237 
melt-stage0-quicklybuilt/warmelt-macro.quicklybuilt.so: \
  melt-stage0-quicklybuilt/warmelt-macro.$(MELT_ZERO_GENERATED_MACRO_CUMULMD5).quicklybuilt.so
	...
	$(melt_make_move) melt-stage0-warmelt-macro.quicklybuilt-module.stamp-tmp \
             melt-stage0-warmelt-macro.quicklybuilt-module.stamp

#@ stage 0 for warmelt-macro flavor quicklybuilt  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-macro.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-macro.quicklybuilt.so ; @true

#@ stage 0 for warmelt-macro flavor quicklybuilt done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-macro flavored quicklybuilt  from melt-build.tpl line 255
...
#@ stage 0 for warmelt-normal flavor quicklybuilt  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-normal flavor quicklybuilt  shortmodule from melt-build.tpl line 237 
melt-stage0-quicklybuilt/warmelt-normal.quicklybuilt.so: \
  melt-stage0-quicklybuilt/warmelt-normal.$(MELT_ZERO_GENERATED_NORMAL_CUMULMD5).quicklybuilt.so
	...
	$(melt_make_move) melt-stage0-warmelt-normal.quicklybuilt-module.stamp-tmp \
             melt-stage0-warmelt-normal.quicklybuilt-module.stamp

#@ stage 0 for warmelt-normal flavor quicklybuilt  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-normal.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-normal.quicklybuilt.so ; @true

#@ stage 0 for warmelt-normal flavor quicklybuilt done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-normal flavored quicklybuilt  from melt-build.tpl line 255
...
#@ stage 0 for warmelt-normatch flavor quicklybuilt  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-normatch flavor quicklybuilt  shortmodule from melt-build.tpl line 237 
melt-stage0-quicklybuilt/warmelt-normatch.quicklybuilt.so: \
  melt-stage0-quicklybuilt/warmelt-normatch.$(MELT_ZERO_GENERATED_NORMATCH_CUMULMD5).quicklybuilt.so
	...
	$(melt_make_move) melt-stage0-warmelt-normatch.quicklybuilt-module.stamp-tmp \
             melt-stage0-warmelt-normatch.quicklybuilt-module.stamp

#@ stage 0 for warmelt-normatch flavor quicklybuilt  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-normatch.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-normatch.quicklybuilt.so ; @true

#@ stage 0 for warmelt-normatch flavor quicklybuilt done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-normatch flavored quicklybuilt  from melt-build.tpl line 255
...
#@ stage 0 for warmelt-genobj flavor quicklybuilt  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-genobj flavor quicklybuilt  shortmodule from melt-build.tpl line 237 
melt-stage0-quicklybuilt/warmelt-genobj.quicklybuilt.so: \
  melt-stage0-quicklybuilt/warmelt-genobj.$(MELT_ZERO_GENERATED_GENOBJ_CUMULMD5).quicklybuilt.so
	...
	$(melt_make_move) melt-stage0-warmelt-genobj.quicklybuilt-module.stamp-tmp \
             melt-stage0-warmelt-genobj.quicklybuilt-module.stamp

#@ stage 0 for warmelt-genobj flavor quicklybuilt  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-genobj.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-genobj.quicklybuilt.so ; @true

#@ stage 0 for warmelt-genobj flavor quicklybuilt done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-genobj flavored quicklybuilt  from melt-build.tpl line 255
...
#@ stage 0 for warmelt-outobj flavor quicklybuilt  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-outobj flavor quicklybuilt  shortmodule from melt-build.tpl line 237 
melt-stage0-quicklybuilt/warmelt-outobj.quicklybuilt.so: \
  melt-stage0-quicklybuilt/warmelt-outobj.$(MELT_ZERO_GENERATED_OUTOBJ_CUMULMD5).quicklybuilt.so
	...
	$(melt_make_move) melt-stage0-warmelt-outobj.quicklybuilt-module.stamp-tmp \
             melt-stage0-warmelt-outobj.quicklybuilt-module.stamp

#@ stage 0 for warmelt-outobj flavor quicklybuilt  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-outobj.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-outobj.quicklybuilt.so ; @true

#@ stage 0 for warmelt-outobj flavor quicklybuilt done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-outobj flavored quicklybuilt  from melt-build.tpl line 255
...
#@ stage 0 for warmelt-modes flavor quicklybuilt  descfiles from melt-build.tpl line 230 
...
#@ stage 0 for warmelt-modes flavor quicklybuilt  shortmodule from melt-build.tpl line 237 
melt-stage0-quicklybuilt/warmelt-modes.quicklybuilt.so: \
  melt-stage0-quicklybuilt/warmelt-modes.$(MELT_ZERO_GENERATED_MODES_CUMULMD5).quicklybuilt.so
	...
	$(melt_make_move) melt-stage0-warmelt-modes.quicklybuilt-module.stamp-tmp \
             melt-stage0-warmelt-modes.quicklybuilt-module.stamp

#@ stage 0 for warmelt-modes flavor quicklybuilt  stamp from melt-build.tpl line 249 
melt-stage0-warmelt-modes.quicklybuilt-module.stamp: \
  melt-stage0-quicklybuilt/warmelt-modes.quicklybuilt.so ; @true

#@ stage 0 for warmelt-modes flavor quicklybuilt done  from melt-build.tpl line 253

#### end STAGE0 of warmelt-modes flavored quicklybuilt  from melt-build.tpl line 255



#@ stage 0 flavor quicklybuilt modulelist  from melt-build.tpl line 259 
...
#@ stage 0 flavor quicklybuilt fullstage stamp  from melt-build.tpl line 273 
...
##@ end STAGE0  flavor quicklybuilt  from melt-build.tpl line 279
####-------------------------------------------------------------
...
################################################################
################################################################
#### making our melt stages  from melt-build.tpl line 287


#@  for melt-stage1 from melt-build.tpl line 290
#### rules for melt-stage1, previous $(MELT_STAGE_ZERO)


### the C source of melt-stage1 for warmelt-first from melt-build.tpl line 300

## the timestamp C header file  for warmelt-first from melt-build.tpl line 302
melt-stage1/warmelt-first+melttime.h: melt-stage1/warmelt-first+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-first from melt-build.tpl line 305
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-first+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-first+melt-stage1.args: ; cat warmelt-first+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-first+melt-stage1.args
	@ls -l melt-stage1/warmelt-first.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-first.c from melt-build.tpl line 336 ; exit 1 )

#@ from melt-build.tpl line 338
...
#@ from melt-build.tpl line 354 time stamp for module
...
### the C source of melt-stage1 for warmelt-base from melt-build.tpl line 300

## the timestamp C header file  for warmelt-base from melt-build.tpl line 302
melt-stage1/warmelt-base+melttime.h: melt-stage1/warmelt-base+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-base from melt-build.tpl line 305
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-base+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-base+melt-stage1.args: ; cat warmelt-base+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-base+melt-stage1.args
	@ls -l melt-stage1/warmelt-base.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-base.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage1 for warmelt-debug from melt-build.tpl line 300

## the timestamp C header file  for warmelt-debug from melt-build.tpl line 302
melt-stage1/warmelt-debug+melttime.h: melt-stage1/warmelt-debug+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-debug from melt-build.tpl line 305
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-debug+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-debug+melt-stage1.args: ; cat warmelt-debug+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-debug+melt-stage1.args
	@ls -l melt-stage1/warmelt-debug.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-debug.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage1 for warmelt-macro from melt-build.tpl line 300

## the timestamp C header file  for warmelt-macro from melt-build.tpl line 302
melt-stage1/warmelt-macro+melttime.h: melt-stage1/warmelt-macro+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-macro from melt-build.tpl line 305
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-macro+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-macro+melt-stage1.args: ; cat warmelt-macro+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-macro+melt-stage1.args
	@ls -l melt-stage1/warmelt-macro.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-macro.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage1 for warmelt-normal from melt-build.tpl line 300

## the timestamp C header file  for warmelt-normal from melt-build.tpl line 302
melt-stage1/warmelt-normal+melttime.h: melt-stage1/warmelt-normal+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-normal from melt-build.tpl line 305
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-normal+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-normal+melt-stage1.args: ; cat warmelt-normal+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-normal+melt-stage1.args
	@ls -l melt-stage1/warmelt-normal.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-normal.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage1 for warmelt-normatch from melt-build.tpl line 300

## the timestamp C header file  for warmelt-normatch from melt-build.tpl line 302
melt-stage1/warmelt-normatch+melttime.h: melt-stage1/warmelt-normatch+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-normatch from melt-build.tpl line 305
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-normatch+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-normatch+melt-stage1.args: ; cat warmelt-normatch+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-normatch+melt-stage1.args
	@ls -l melt-stage1/warmelt-normatch.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-normatch.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage1 for warmelt-genobj from melt-build.tpl line 300

## the timestamp C header file  for warmelt-genobj from melt-build.tpl line 302
melt-stage1/warmelt-genobj+melttime.h: melt-stage1/warmelt-genobj+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-genobj from melt-build.tpl line 305
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-genobj+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-genobj+melt-stage1.args: ; cat warmelt-genobj+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-genobj+melt-stage1.args
	@ls -l melt-stage1/warmelt-genobj.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-genobj.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage1 for warmelt-outobj from melt-build.tpl line 300

## the timestamp C header file  for warmelt-outobj from melt-build.tpl line 302
melt-stage1/warmelt-outobj+melttime.h: melt-stage1/warmelt-outobj+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-outobj from melt-build.tpl line 305
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-outobj+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-outobj+melt-stage1.args: ; cat warmelt-outobj+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-outobj+melt-stage1.args
	@ls -l melt-stage1/warmelt-outobj.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-outobj.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage1 for warmelt-modes from melt-build.tpl line 300

## the timestamp C header file  for warmelt-modes from melt-build.tpl line 302
melt-stage1/warmelt-modes+melttime.h: melt-stage1/warmelt-modes+meltdesc.c; @true

## the descriptive C of melt-stage1 for warmelt-modes from melt-build.tpl line 305
...
$(MELT_STAGE_ZERO)/warmelt-modes.$(MELT_ZERO_FLAVOR) > warmelt-modes+melt-stage1.args-tmp
	...
	@echo; echo; echo -n  warmelt-modes+melt-stage1.args: ; cat warmelt-modes+melt-stage1.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-modes+melt-stage1.args
	@ls -l melt-stage1/warmelt-modes.c  || ( echo "*@*MISSING "  melt-stage1/warmelt-modes.c from melt-build.tpl line 336 ; exit 1 )
...
#@ from melt-build.tpl line 415 melt-stage1 directory and stamp
melt-stage1:
...
### end of melt-stage1 from melt-build.tpl line 422 


#@  for melt-stage2 from melt-build.tpl line 290
#### rules for melt-stage2, previous melt-stage1


### the C source of melt-stage2 for warmelt-first from melt-build.tpl line 300

## the timestamp C header file  for warmelt-first from melt-build.tpl line 302
melt-stage2/warmelt-first+melttime.h: melt-stage2/warmelt-first+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-first from melt-build.tpl line 305
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-first+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-first+melt-stage2.args: ; cat warmelt-first+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-first+melt-stage2.args
	@ls -l melt-stage2/warmelt-first.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-first.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage2 for warmelt-base from melt-build.tpl line 300

## the timestamp C header file  for warmelt-base from melt-build.tpl line 302
melt-stage2/warmelt-base+melttime.h: melt-stage2/warmelt-base+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-base from melt-build.tpl line 305
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-base+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-base+melt-stage2.args: ; cat warmelt-base+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-base+melt-stage2.args
	@ls -l melt-stage2/warmelt-base.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-base.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage2 for warmelt-debug from melt-build.tpl line 300

## the timestamp C header file  for warmelt-debug from melt-build.tpl line 302
melt-stage2/warmelt-debug+melttime.h: melt-stage2/warmelt-debug+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-debug from melt-build.tpl line 305
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-debug+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-debug+melt-stage2.args: ; cat warmelt-debug+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-debug+melt-stage2.args
	@ls -l melt-stage2/warmelt-debug.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-debug.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage2 for warmelt-macro from melt-build.tpl line 300

## the timestamp C header file  for warmelt-macro from melt-build.tpl line 302
melt-stage2/warmelt-macro+melttime.h: melt-stage2/warmelt-macro+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-macro from melt-build.tpl line 305
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-macro+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-macro+melt-stage2.args: ; cat warmelt-macro+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-macro+melt-stage2.args
	@ls -l melt-stage2/warmelt-macro.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-macro.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage2 for warmelt-normal from melt-build.tpl line 300

## the timestamp C header file  for warmelt-normal from melt-build.tpl line 302
melt-stage2/warmelt-normal+melttime.h: melt-stage2/warmelt-normal+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-normal from melt-build.tpl line 305
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-normal+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-normal+melt-stage2.args: ; cat warmelt-normal+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-normal+melt-stage2.args
	@ls -l melt-stage2/warmelt-normal.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-normal.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage2 for warmelt-normatch from melt-build.tpl line 300

## the timestamp C header file  for warmelt-normatch from melt-build.tpl line 302
melt-stage2/warmelt-normatch+melttime.h: melt-stage2/warmelt-normatch+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-normatch from melt-build.tpl line 305
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-normatch+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-normatch+melt-stage2.args: ; cat warmelt-normatch+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-normatch+melt-stage2.args
	@ls -l melt-stage2/warmelt-normatch.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-normatch.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage2 for warmelt-genobj from melt-build.tpl line 300

## the timestamp C header file  for warmelt-genobj from melt-build.tpl line 302
melt-stage2/warmelt-genobj+melttime.h: melt-stage2/warmelt-genobj+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-genobj from melt-build.tpl line 305
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-genobj+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-genobj+melt-stage2.args: ; cat warmelt-genobj+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-genobj+melt-stage2.args
	@ls -l melt-stage2/warmelt-genobj.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-genobj.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage2 for warmelt-outobj from melt-build.tpl line 300

## the timestamp C header file  for warmelt-outobj from melt-build.tpl line 302
melt-stage2/warmelt-outobj+melttime.h: melt-stage2/warmelt-outobj+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-outobj from melt-build.tpl line 305
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-outobj+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-outobj+melt-stage2.args: ; cat warmelt-outobj+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-outobj+melt-stage2.args
	@ls -l melt-stage2/warmelt-outobj.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-outobj.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage2 for warmelt-modes from melt-build.tpl line 300

## the timestamp C header file  for warmelt-modes from melt-build.tpl line 302
melt-stage2/warmelt-modes+melttime.h: melt-stage2/warmelt-modes+meltdesc.c; @true

## the descriptive C of melt-stage2 for warmelt-modes from melt-build.tpl line 305
...
melt-stage1/warmelt-modes.quicklybuilt > warmelt-modes+melt-stage2.args-tmp
	...
	@echo; echo; echo -n  warmelt-modes+melt-stage2.args: ; cat warmelt-modes+melt-stage2.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-modes+melt-stage2.args
	@ls -l melt-stage2/warmelt-modes.c  || ( echo "*@*MISSING "  melt-stage2/warmelt-modes.c from melt-build.tpl line 336 ; exit 1 )
...
#@ from melt-build.tpl line 415 melt-stage2 directory and stamp
melt-stage2:
...
### end of melt-stage2 from melt-build.tpl line 422 


#@  for melt-stage3 from melt-build.tpl line 290
#### rules for melt-stage3, previous melt-stage2


### the C source of melt-stage3 for warmelt-first from melt-build.tpl line 300

## the timestamp C header file  for warmelt-first from melt-build.tpl line 302
melt-stage3/warmelt-first+melttime.h: melt-stage3/warmelt-first+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-first from melt-build.tpl line 305
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-first+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-first+melt-stage3.args: ; cat warmelt-first+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-first+melt-stage3.args
	@ls -l melt-stage3/warmelt-first.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-first.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage3 for warmelt-base from melt-build.tpl line 300

## the timestamp C header file  for warmelt-base from melt-build.tpl line 302
melt-stage3/warmelt-base+melttime.h: melt-stage3/warmelt-base+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-base from melt-build.tpl line 305
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-base+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-base+melt-stage3.args: ; cat warmelt-base+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-base+melt-stage3.args
	@ls -l melt-stage3/warmelt-base.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-base.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage3 for warmelt-debug from melt-build.tpl line 300

## the timestamp C header file  for warmelt-debug from melt-build.tpl line 302
melt-stage3/warmelt-debug+melttime.h: melt-stage3/warmelt-debug+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-debug from melt-build.tpl line 305
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-debug+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-debug+melt-stage3.args: ; cat warmelt-debug+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-debug+melt-stage3.args
	@ls -l melt-stage3/warmelt-debug.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-debug.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage3 for warmelt-macro from melt-build.tpl line 300

## the timestamp C header file  for warmelt-macro from melt-build.tpl line 302
melt-stage3/warmelt-macro+melttime.h: melt-stage3/warmelt-macro+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-macro from melt-build.tpl line 305
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-macro+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-macro+melt-stage3.args: ; cat warmelt-macro+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-macro+melt-stage3.args
	@ls -l melt-stage3/warmelt-macro.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-macro.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage3 for warmelt-normal from melt-build.tpl line 300

## the timestamp C header file  for warmelt-normal from melt-build.tpl line 302
melt-stage3/warmelt-normal+melttime.h: melt-stage3/warmelt-normal+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-normal from melt-build.tpl line 305
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-normal+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-normal+melt-stage3.args: ; cat warmelt-normal+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-normal+melt-stage3.args
	@ls -l melt-stage3/warmelt-normal.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-normal.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage3 for warmelt-normatch from melt-build.tpl line 300

## the timestamp C header file  for warmelt-normatch from melt-build.tpl line 302
melt-stage3/warmelt-normatch+melttime.h: melt-stage3/warmelt-normatch+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-normatch from melt-build.tpl line 305
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-normatch+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-normatch+melt-stage3.args: ; cat warmelt-normatch+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-normatch+melt-stage3.args
	@ls -l melt-stage3/warmelt-normatch.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-normatch.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage3 for warmelt-genobj from melt-build.tpl line 300

## the timestamp C header file  for warmelt-genobj from melt-build.tpl line 302
melt-stage3/warmelt-genobj+melttime.h: melt-stage3/warmelt-genobj+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-genobj from melt-build.tpl line 305
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-genobj+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-genobj+melt-stage3.args: ; cat warmelt-genobj+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-genobj+melt-stage3.args
	@ls -l melt-stage3/warmelt-genobj.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-genobj.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage3 for warmelt-outobj from melt-build.tpl line 300

## the timestamp C header file  for warmelt-outobj from melt-build.tpl line 302
melt-stage3/warmelt-outobj+melttime.h: melt-stage3/warmelt-outobj+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-outobj from melt-build.tpl line 305
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-outobj+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-outobj+melt-stage3.args: ; cat warmelt-outobj+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-outobj+melt-stage3.args
	@ls -l melt-stage3/warmelt-outobj.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-outobj.c from melt-build.tpl line 336 ; exit 1 )
...
### the C source of melt-stage3 for warmelt-modes from melt-build.tpl line 300

## the timestamp C header file  for warmelt-modes from melt-build.tpl line 302
melt-stage3/warmelt-modes+melttime.h: melt-stage3/warmelt-modes+meltdesc.c; @true

## the descriptive C of melt-stage3 for warmelt-modes from melt-build.tpl line 305
...
melt-stage2/warmelt-modes.quicklybuilt > warmelt-modes+melt-stage3.args-tmp
	...
	@echo; echo; echo -n  warmelt-modes+melt-stage3.args: ; cat warmelt-modes+melt-stage3.args ; echo; echo; echo "***** doing " $@  from melt-build.tpl line 334
	$(melt_make_cc1) @warmelt-modes+melt-stage3.args
	@ls -l melt-stage3/warmelt-modes.c  || ( echo "*@*MISSING "  melt-stage3/warmelt-modes.c from melt-build.tpl line 336 ; exit 1 )
...
#@ from melt-build.tpl line 415 melt-stage3 directory and stamp
melt-stage3:
...
### end of melt-stage3 from melt-build.tpl line 422 
...
####### final targets from melt-build.tpl line 438
...
### the final module directory from melt-build.tpl line 443
melt-modules: 
...
### the final source directory from melt-build.tpl line 449
melt-sources: 
...
### all sources from melt-build.tpl line 456
...
#@ from melt-build.tpl line 470


## melt translator warmelt-first # 0 from melt-build.tpl line 473
melt-sources/warmelt-first.melt: $(melt_make_source_dir)/warmelt-first.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 475; ls -l $(melt_make_source_dir)/warmelt-first.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-first.melt warmelt-first.melt

### melt included files with (load ...) macro from melt-build.tpl line 478


# MELT translator warmelt-first in melt-sources/ timestamp from melt-build.tpl line 487
...
# MELT translator warmelt-first in melt-sources/ C files from melt-build.tpl line 491
melt-sources/warmelt-first.c melt-sources/warmelt-first+meltdesc.c: \
	...
	@echo; echo; echo; echo -n warmelt-first+sources.args: ; cat warmelt-first+sources.args ; echo "***** doing " $@ from melt-build.tpl line 507
	$(melt_make_cc1) @warmelt-first+sources.args



#@  base= warmelt-first from melt-build.tpl line 512
...
#@  base= warmelt-first from melt-build.tpl line 524
...
#@  warmelt-first from melt-build.tpl line 549

#@ from melt-build.tpl line 470


## melt translator warmelt-base # 1 from melt-build.tpl line 473
melt-sources/warmelt-base.melt: $(melt_make_source_dir)/warmelt-base.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 475; ls -l $(melt_make_source_dir)/warmelt-base.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-base.melt warmelt-base.melt

### melt included files with (load ...) macro from melt-build.tpl line 478


# MELT translator warmelt-base in melt-sources/ timestamp from melt-build.tpl line 487
...
# MELT translator warmelt-base in melt-sources/ C files from melt-build.tpl line 491
melt-sources/warmelt-base.c melt-sources/warmelt-base+meltdesc.c: \
	...
	@echo; echo; echo; echo -n warmelt-base+sources.args: ; cat warmelt-base+sources.args ; echo "***** doing " $@ from melt-build.tpl line 507
	$(melt_make_cc1) @warmelt-base+sources.args



#@  base= warmelt-base from melt-build.tpl line 512
...
#@  base= warmelt-base from melt-build.tpl line 524
...
#@  warmelt-base from melt-build.tpl line 549

#@ from melt-build.tpl line 470


## melt translator warmelt-debug # 2 from melt-build.tpl line 473
melt-sources/warmelt-debug.melt: $(melt_make_source_dir)/warmelt-debug.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 475; ls -l $(melt_make_source_dir)/warmelt-debug.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-debug.melt warmelt-debug.melt

### melt included files with (load ...) macro from melt-build.tpl line 478


# MELT translator warmelt-debug in melt-sources/ timestamp from melt-build.tpl line 487
...
# MELT translator warmelt-debug in melt-sources/ C files from melt-build.tpl line 491
melt-sources/warmelt-debug.c melt-sources/warmelt-debug+meltdesc.c: \
	...
	@echo; echo; echo; echo -n warmelt-debug+sources.args: ; cat warmelt-debug+sources.args ; echo "***** doing " $@ from melt-build.tpl line 507
	$(melt_make_cc1) @warmelt-debug+sources.args



#@  base= warmelt-debug from melt-build.tpl line 512
...
#@  base= warmelt-debug from melt-build.tpl line 524
...
#@  warmelt-debug from melt-build.tpl line 549

#@ from melt-build.tpl line 470


## melt translator warmelt-macro # 3 from melt-build.tpl line 473
melt-sources/warmelt-macro.melt: $(melt_make_source_dir)/warmelt-macro.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 475; ls -l $(melt_make_source_dir)/warmelt-macro.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-macro.melt warmelt-macro.melt

### melt included files with (load ...) macro from melt-build.tpl line 478


# MELT translator warmelt-macro in melt-sources/ timestamp from melt-build.tpl line 487
...
# MELT translator warmelt-macro in melt-sources/ C files from melt-build.tpl line 491
melt-sources/warmelt-macro.c melt-sources/warmelt-macro+meltdesc.c: \
	...
	@echo; echo; echo; echo -n warmelt-macro+sources.args: ; cat warmelt-macro+sources.args ; echo "***** doing " $@ from melt-build.tpl line 507
	$(melt_make_cc1) @warmelt-macro+sources.args



#@  base= warmelt-macro from melt-build.tpl line 512
...
#@  base= warmelt-macro from melt-build.tpl line 524
...
#@  warmelt-macro from melt-build.tpl line 549

#@ from melt-build.tpl line 470


## melt translator warmelt-normal # 4 from melt-build.tpl line 473
melt-sources/warmelt-normal.melt: $(melt_make_source_dir)/warmelt-normal.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 475; ls -l $(melt_make_source_dir)/warmelt-normal.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-normal.melt warmelt-normal.melt

### melt included files with (load ...) macro from melt-build.tpl line 478

# included warmelt-predef.melt from melt-build.tpl line 480
...
# MELT translator warmelt-normal in melt-sources/ timestamp from melt-build.tpl line 487
...
# MELT translator warmelt-normal in melt-sources/ C files from melt-build.tpl line 491
melt-sources/warmelt-normal.c melt-sources/warmelt-normal+meltdesc.c: \
	...
	@echo; echo; echo; echo -n warmelt-normal+sources.args: ; cat warmelt-normal+sources.args ; echo "***** doing " $@ from melt-build.tpl line 507
	$(melt_make_cc1) @warmelt-normal+sources.args



#@  base= warmelt-normal from melt-build.tpl line 512
...
#@  base= warmelt-normal from melt-build.tpl line 524
...
#@  warmelt-normal from melt-build.tpl line 549

#@ from melt-build.tpl line 470


## melt translator warmelt-normatch # 5 from melt-build.tpl line 473
melt-sources/warmelt-normatch.melt: $(melt_make_source_dir)/warmelt-normatch.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 475; ls -l $(melt_make_source_dir)/warmelt-normatch.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-normatch.melt warmelt-normatch.melt

### melt included files with (load ...) macro from melt-build.tpl line 478


# MELT translator warmelt-normatch in melt-sources/ timestamp from melt-build.tpl line 487
...
# MELT translator warmelt-normatch in melt-sources/ C files from melt-build.tpl line 491
melt-sources/warmelt-normatch.c melt-sources/warmelt-normatch+meltdesc.c: \
	...
	@echo; echo; echo; echo -n warmelt-normatch+sources.args: ; cat warmelt-normatch+sources.args ; echo "***** doing " $@ from melt-build.tpl line 507
	$(melt_make_cc1) @warmelt-normatch+sources.args



#@  base= warmelt-normatch from melt-build.tpl line 512
...
#@  base= warmelt-normatch from melt-build.tpl line 524
...
#@  warmelt-normatch from melt-build.tpl line 549

#@ from melt-build.tpl line 470


## melt translator warmelt-genobj # 6 from melt-build.tpl line 473
melt-sources/warmelt-genobj.melt: $(melt_make_source_dir)/warmelt-genobj.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 475; ls -l $(melt_make_source_dir)/warmelt-genobj.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-genobj.melt warmelt-genobj.melt

### melt included files with (load ...) macro from melt-build.tpl line 478


# MELT translator warmelt-genobj in melt-sources/ timestamp from melt-build.tpl line 487
...
# MELT translator warmelt-genobj in melt-sources/ C files from melt-build.tpl line 491
melt-sources/warmelt-genobj.c melt-sources/warmelt-genobj+meltdesc.c: \
	...
	@echo; echo; echo; echo -n warmelt-genobj+sources.args: ; cat warmelt-genobj+sources.args ; echo "***** doing " $@ from melt-build.tpl line 507
	$(melt_make_cc1) @warmelt-genobj+sources.args



#@  base= warmelt-genobj from melt-build.tpl line 512
...
#@  base= warmelt-genobj from melt-build.tpl line 524
...
#@  warmelt-genobj from melt-build.tpl line 549

#@ from melt-build.tpl line 470


## melt translator warmelt-outobj # 7 from melt-build.tpl line 473
melt-sources/warmelt-outobj.melt: $(melt_make_source_dir)/warmelt-outobj.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 475; ls -l $(melt_make_source_dir)/warmelt-outobj.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-outobj.melt warmelt-outobj.melt

### melt included files with (load ...) macro from melt-build.tpl line 478


# MELT translator warmelt-outobj in melt-sources/ timestamp from melt-build.tpl line 487
...
# MELT translator warmelt-outobj in melt-sources/ C files from melt-build.tpl line 491
melt-sources/warmelt-outobj.c melt-sources/warmelt-outobj+meltdesc.c: \
	...
	@echo; echo; echo; echo -n warmelt-outobj+sources.args: ; cat warmelt-outobj+sources.args ; echo "***** doing " $@ from melt-build.tpl line 507
	$(melt_make_cc1) @warmelt-outobj+sources.args



#@  base= warmelt-outobj from melt-build.tpl line 512
...
#@  base= warmelt-outobj from melt-build.tpl line 524
...
#@  warmelt-outobj from melt-build.tpl line 549

#@ from melt-build.tpl line 470


## melt translator warmelt-modes # 8 from melt-build.tpl line 473
melt-sources/warmelt-modes.melt: $(melt_make_source_dir)/warmelt-modes.melt melt-sources-directory.stamp
	@echo  from melt-build.tpl line 475; ls -l $(melt_make_source_dir)/warmelt-modes.melt 
	cd melt-sources; $(LN_S) -v -f  $(realpath $(melt_make_source_dir))/warmelt-modes.melt warmelt-modes.melt

### melt included files with (load ...) macro from melt-build.tpl line 478


# MELT translator warmelt-modes in melt-sources/ timestamp from melt-build.tpl line 487
...
# MELT translator warmelt-modes in melt-sources/ C files from melt-build.tpl line 491
melt-sources/warmelt-modes.c melt-sources/warmelt-modes+meltdesc.c: \
	...
	@echo; echo; echo; echo -n warmelt-modes+sources.args: ; cat warmelt-modes+sources.args ; echo "***** doing " $@ from melt-build.tpl line 507
	$(melt_make_cc1) @warmelt-modes+sources.args



#@  base= warmelt-modes from melt-build.tpl line 512
...
#@  base= warmelt-modes from melt-build.tpl line 524
...
#@  warmelt-modes from melt-build.tpl line 549


#@ from melt-build.tpl line 552


#@ from melt-build.tpl line 555
...
melt-sources/xtramelt-parse-infix-syntax.c: \
  ...
  \
   ...
   $(melt_make_cc1_dependency)
	...
	@echo; echo; echo; echo -n $(notdir $(basename $@)).args: ; cat $(notdir $(basename $@)).args ; echo "***** doing " $@ from melt-build.tpl line 598
...
## melt application xtramelt-parse-infix-syntax flavor optimized  from melt-build.tpl line 605
...
## melt application xtramelt-parse-infix-syntax flavor quicklybuilt  from melt-build.tpl line 605
...
## melt application xtramelt-parse-infix-syntax flavor debugnoline  from melt-build.tpl line 605
...
## melt application xtramelt-ana-base flavor optimized  from melt-build.tpl line 605
...
## melt application xtramelt-ana-base flavor quicklybuilt  from melt-build.tpl line 605
...
## melt application xtramelt-ana-base flavor debugnoline  from melt-build.tpl line 605
...
## melt application xtramelt-ana-simple flavor optimized  from melt-build.tpl line 605
...
## melt application xtramelt-ana-simple flavor quicklybuilt  from melt-build.tpl line 605
...
## melt application xtramelt-ana-simple flavor debugnoline  from melt-build.tpl line 605
...
## melt application xtramelt-c-generator flavor optimized  from melt-build.tpl line 605
...
## melt application xtramelt-c-generator flavor quicklybuilt  from melt-build.tpl line 605
...
## melt application xtramelt-c-generator flavor debugnoline  from melt-build.tpl line 605
...
## melt application xtramelt-opengpu flavor optimized  from melt-build.tpl line 605
...
## melt application xtramelt-opengpu flavor quicklybuilt  from melt-build.tpl line 605
...
## melt application xtramelt-opengpu flavor debugnoline  from melt-build.tpl line 605
...
melt-tiny-tests: melt-sayhello.melt melt-modules melt-sources \
		...
		$(MELT_RUNTIME_C)
# test that a helloworld can be translated from melt-build.tpl line 636
	@echo	$(MELTCCAPPLICATION1ARGS) \
	     $(meltarg_arg)=$<  -frandom-seed=$(shell md5sum $< | cut -b-24) \
	     $(meltarg_module_path)=$(realpath melt-modules) \
	     $(meltarg_source_path)=$(realpath melt-sources) \
	...
	@echo; echo; echo; echo -n $(basename $<).args: ; cat $(basename $<).args ; echo "***** doing " $(basename $<)  from melt-build.tpl line 644
	$(melt_make_cc1) @$(basename $<).args
# test that a helloworld can be run from melt-build.tpl line 646
	...
	@echo; echo; echo; echo -n $(basename $<)-run.args: ; cat $(basename $<)-run.args ; echo "***** doing " $(basename $<)-run  from melt-build.tpl line 654
...
# test melt-runtime from melt-build.tpl line 658
