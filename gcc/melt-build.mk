...
#@#@# 
#@#@# It has been AutoGen-ed  March 12, 2012 at 10:23:20 AM by AutoGen 5.12
...
MELT_ZERO_GENERATED_FIRST_CUMULMD5:=$(shell $(GAWK) -F\" '/melt_cumulated_hexmd5/{print $$2}' $(melt_make_source_dir)/generated/warmelt-first+meltdesc.c)
...
MELT_ZERO_GENERATED_BASE_CUMULMD5:=$(shell $(GAWK) -F\" '/melt_cumulated_hexmd5/{print $$2}' $(melt_make_source_dir)/generated/warmelt-base+meltdesc.c)
...
MELT_ZERO_GENERATED_DEBUG_CUMULMD5:=$(shell $(GAWK) -F\" '/melt_cumulated_hexmd5/{print $$2}' $(melt_make_source_dir)/generated/warmelt-debug+meltdesc.c)
...
MELT_ZERO_GENERATED_MACRO_CUMULMD5:=$(shell $(GAWK) -F\" '/melt_cumulated_hexmd5/{print $$2}' $(melt_make_source_dir)/generated/warmelt-macro+meltdesc.c)
...
MELT_ZERO_GENERATED_NORMAL_CUMULMD5:=$(shell $(GAWK) -F\" '/melt_cumulated_hexmd5/{print $$2}' $(melt_make_source_dir)/generated/warmelt-normal+meltdesc.c)
...
MELT_ZERO_GENERATED_NORMATCH_CUMULMD5:=$(shell $(GAWK) -F\" '/melt_cumulated_hexmd5/{print $$2}' $(melt_make_source_dir)/generated/warmelt-normatch+meltdesc.c)
...
MELT_ZERO_GENERATED_GENOBJ_CUMULMD5:=$(shell $(GAWK) -F\" '/melt_cumulated_hexmd5/{print $$2}' $(melt_make_source_dir)/generated/warmelt-genobj+meltdesc.c)
...
MELT_ZERO_GENERATED_OUTOBJ_CUMULMD5:=$(shell $(GAWK) -F\" '/melt_cumulated_hexmd5/{print $$2}' $(melt_make_source_dir)/generated/warmelt-outobj+meltdesc.c)
...
MELT_ZERO_GENERATED_MODES_CUMULMD5:=$(shell $(GAWK) -F\" '/melt_cumulated_hexmd5/{print $$2}' $(melt_make_source_dir)/generated/warmelt-modes+meltdesc.c)
...
melt-stage1-fullstage.stamp:  melt-run.h  melt-stage1/warmelt.modlis \
 ...
 melt-stage1-warmelt-genobj-module.stamp \
 melt-stage1-warmelt-outobj-module.stamp \
 melt-stage1-warmelt-modes-module.stamp 
	echo "#$@ generated" > $@-tmp
...
melt-stage2-fullstage.stamp:  melt-run.h  melt-stage2/warmelt.modlis \
 ...
 melt-stage2-warmelt-genobj-module.stamp \
 melt-stage2-warmelt-outobj-module.stamp \
 melt-stage2-warmelt-modes-module.stamp 
	echo "#$@ generated" > $@-tmp
	$(MD5SUM) melt-run.h >> $@-tmp
...
melt-stage3-fullstage.stamp:  melt-run.h  melt-stage3/warmelt.modlis \
 ...
 melt-stage3-warmelt-genobj-module.stamp \
 melt-stage3-warmelt-outobj-module.stamp \
 melt-stage3-warmelt-modes-module.stamp 
	echo "#$@ generated" > $@-tmp
	$(MD5SUM) melt-run.h >> $@-tmp
...
melt-sources/xtramelt-ana-base.c: \
  ...
  \
   ...
   empty-file-for-melt.c melt-run.h melt-runtime.h \
   $(melt_make_cc1_dependency)
	@echo doing $@  from melt-build.tpl line 614
	...
	@echo; echo; echo; echo -n $(notdir $(basename $@)).args: ; cat $(notdir $(basename $@)).args ; echo "***** doing " $@ from melt-build.tpl line 623
...
## melt application xtramelt-ana-base flavor optimized  from melt-build.tpl line 630
melt-modules/xtramelt-ana-base.optimized.so: melt-sources-directory.stamp \
     ...
     melt-run.h melt-runtime.h 
	@echo doing $@  from melt-build.tpl line 635
	+$(MELT_MAKE_MODULE) melt_module \
	      GCCMELT_MODULE_FLAVOR=optimized \
	      GCCMELT_CFLAGS="$(melt_cflags)" \
              GCCMELT_MODULE_WORKSPACE=melt-workdir \
...
## melt application xtramelt-ana-base flavor quicklybuilt  from melt-build.tpl line 630
...
## melt application xtramelt-ana-base flavor debugnoline  from melt-build.tpl line 630
...
#@ from melt-build.tpl line 644

# end application xtramelt-ana-base

#@ from melt-build.tpl line 648
...
## melt application xtramelt-ana-simple flavor optimized  from melt-build.tpl line 630
...
## melt application xtramelt-ana-simple flavor quicklybuilt  from melt-build.tpl line 630
...
## melt application xtramelt-ana-simple flavor debugnoline  from melt-build.tpl line 630
  ...
  \
   ...
   $(melt_make_cc1_dependency)
	...
	@echo 	$(MELTCCAPPLICATION1ARGS) \
	     ...
	     $(meltarg_source_path)=$(realpath melt-sources) \
             $(meltarg_workdir)=melt-workdir $(meltarg_inhibitautobuild) \
	     $(meltarg_init)=@warmelt-optimized:xtramelt-ana-base:xtramelt-ana-simple \
	     $(meltarg_output)=$(basename $@) empty-file-for-melt.c > $(notdir $(basename $@)).args-tmp
	@$(melt_move_if_change) $(notdir $(basename $@)).args-tmp $(notdir $(basename $@)).args
	@echo; echo; echo; echo -n $(notdir $(basename $@)).args: ; cat $(notdir $(basename $@)).args ; echo "***** doing " $@ from melt-build.tpl line 623
	$(melt_make_cc1) @$(notdir $(basename $@)).args
...
## melt application xtramelt-c-generator flavor optimized  from melt-build.tpl line 630
...
## melt application xtramelt-c-generator flavor quicklybuilt  from melt-build.tpl line 630
...
## melt application xtramelt-c-generator flavor debugnoline  from melt-build.tpl line 630
  ...
  \
   ...
   $(melt_make_cc1_dependency)
	...
	@echo 	$(MELTCCAPPLICATION1ARGS) \
	     ...
	     $(meltarg_source_path)=$(realpath melt-sources) \
             $(meltarg_workdir)=melt-workdir $(meltarg_inhibitautobuild) \
	     $(meltarg_init)=@warmelt-optimized:xtramelt-ana-base:xtramelt-ana-simple:xtramelt-c-generator \
	     $(meltarg_output)=$(basename $@) empty-file-for-melt.c > $(notdir $(basename $@)).args-tmp
	@$(melt_move_if_change) $(notdir $(basename $@)).args-tmp $(notdir $(basename $@)).args
	@echo; echo; echo; echo -n $(notdir $(basename $@)).args: ; cat $(notdir $(basename $@)).args ; echo "***** doing " $@ from melt-build.tpl line 623
	$(melt_make_cc1) @$(notdir $(basename $@)).args
...
## melt application xtramelt-opengpu flavor optimized  from melt-build.tpl line 630
...
## melt application xtramelt-opengpu flavor quicklybuilt  from melt-build.tpl line 630
...
## melt application xtramelt-opengpu flavor debugnoline  from melt-build.tpl line 630
...
melt-tiny-tests: melt-sayhello.melt melt-modules melt-sources \
		...
		$(MELT_RUNTIME_C)
# test that a helloworld can be translated from melt-build.tpl line 662
	@echo doing $@  from melt-build.tpl line 663
	@echo	$(MELTCCAPPLICATION1ARGS) \
	     $(meltarg_arg)=$<  -frandom-seed=$(shell $(MD5SUM) $< | cut -b-24) \
	     $(meltarg_module_path)=$(realpath melt-modules) \
	     $(meltarg_source_path)=$(realpath melt-sources) \
	...
	@echo; echo; echo; echo -n $(basename $<).args: ; cat $(basename $<).args ; echo "***** doing " $(basename $<)  from melt-build.tpl line 671
	$(melt_make_cc1) @$(basename $<).args
# test that a helloworld can be run from melt-build.tpl line 673
	...
	@echo; echo; echo; echo -n $(basename $<)-run.args: ; cat $(basename $<)-run.args ; echo "***** doing " $(basename $<)-run  from melt-build.tpl line 681
...
# test melt-runtime from melt-build.tpl line 685
	...
	@echo; echo; echo; echo -n meltframe.args: ; cat meltframe.args ; echo "***** doing " meltframe  from melt-build.tpl line 701
...
#@ from melt-build.tpl line 797

#@ from melt-build.tpl line 799
	@echo upgrading MELT translator warmelt-first
## dont indent the warmelt-first+meltdesc.c or warmelt-first+melttime.h ::: from melt-build.tpl line 801
...
#@ from melt-build.tpl line 820
#

#@ from melt-build.tpl line 799
	@echo upgrading MELT translator warmelt-base
## dont indent the warmelt-base+meltdesc.c or warmelt-base+melttime.h ::: from melt-build.tpl line 801
...
## dont indent the warmelt-debug+meltdesc.c or warmelt-debug+melttime.h ::: from melt-build.tpl line 801
...
## dont indent the warmelt-macro+meltdesc.c or warmelt-macro+melttime.h ::: from melt-build.tpl line 801
...
## dont indent the warmelt-normal+meltdesc.c or warmelt-normal+melttime.h ::: from melt-build.tpl line 801
...
## dont indent the warmelt-normatch+meltdesc.c or warmelt-normatch+melttime.h ::: from melt-build.tpl line 801
...
## dont indent the warmelt-genobj+meltdesc.c or warmelt-genobj+melttime.h ::: from melt-build.tpl line 801
...
## dont indent the warmelt-outobj+meltdesc.c or warmelt-outobj+melttime.h ::: from melt-build.tpl line 801
...
## dont indent the warmelt-modes+meltdesc.c or warmelt-modes+melttime.h ::: from melt-build.tpl line 801
...
xtramelt-ana-base.melt,xtramelt-ana-simple.melt,xtramelt-c-generator.melt,xtramelt-opengpu.melt \
