...
$(MELTMODULE_QUICKLY): $(MELTMODULE_OBJQUIPICFILES) $(MELTSTAMP)
	$(GCCMELT_CC)  -O0 -DMELTGCC_MODULE_QUICKLY -DMELT_HAVE_DEBUG=1 $(GCCMELT_CFLAGS) \
...
$(GCCMELT_MODULE_WORKSPACE)/%.quipic.o: $(MELTMODULE_SRCDIR)/%.c
	$(GCCMELT_CC) -DMELTGCC_MODULE_QUICKLY  -O0  -DMELT_HAVE_DEBUG=1 $(GCCMELT_CFLAGS)   -fPIC -c -o $@ $<
