...
#warning temporary MELTGLOB_CLASS_MELT_COMMAND & FSYSDAT_COMMAND_DICT
#define MELTGLOB_CLASS_MELT_COMMAND MELTGLOB_CLASS_MELT_MODE
#define FSYSDAT_COMMAND_DICT FSYSDAT_MODE_DICT
/* eof run-melt.h */
