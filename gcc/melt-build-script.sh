...
#@#@# 
#@#@# It has been AutoGen-ed  July 29, 2012 at 01:46:38 PM by AutoGen 5.12
...
function meltbuild_do_applications () {
  ...
  ## meltbuild_do_applications xtramelt-ana-base melt-build-script.tpl:516/437
  if [ ! -f meltbuild-sources/xtramelt-ana-base.c -o  ! -f meltbuild-sources/xtramelt-ana-base+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:522/438 emit application C code for xtramelt-ana-base
      meltbuild_emit melt-build-script.tpl:523/439 \
	  translatefile \
	  xtramelt-ana-base \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:530/440 failed to generate C code of application xtramelt-ana-base
  else
      meltbuild_info melt-build-script.tpl:532/441 DONT emit application C code for xtramelt-ana-base
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-base.meltmod-$meltapp_ANA_BASE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:540/442 compiling application module for xtramelt-ana-base quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/443 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:548/444 in meltbuild-modules failed to compile application xtramelt-ana-base quicklybuilt
  else
      meltbuild_info melt-build-script.tpl:550/445 not compiling application module for xtramelt-ana-base quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-base.meltmod-$meltapp_ANA_BASE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:540/446 compiling application module for xtramelt-ana-base optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/447 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-base \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-base \
	  || meltbuild_error  melt-build-script.tpl:548/448 in meltbuild-modules failed to compile application xtramelt-ana-base optimized
  else
      meltbuild_info melt-build-script.tpl:550/449 not compiling application module for xtramelt-ana-base optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-base.meltmod-$meltapp_ANA_BASE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:540/450 compiling application module for xtramelt-ana-base debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/451 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-base \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-base \
	  || meltbuild_error  melt-build-script.tpl:548/452 in meltbuild-modules failed to compile application xtramelt-ana-base debugnoline
  else
      meltbuild_info melt-build-script.tpl:550/453 not compiling application module for xtramelt-ana-base debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-ana-tree melt-build-script.tpl:512/454
  ...
  ## meltbuild_do_applications xtramelt-ana-tree melt-build-script.tpl:516/455
 ...
 -o meltbuild-sources/xtramelt-ana-base+meltdesc.c -ot meltbuild-sources/xtramelt-ana-tree+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:522/456 emit application C code for xtramelt-ana-tree
      meltbuild_emit melt-build-script.tpl:523/457 \
	  translatefile \
	  xtramelt-ana-tree \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:530/458 failed to generate C code of application xtramelt-ana-tree
  else
      meltbuild_info melt-build-script.tpl:532/459 DONT emit application C code for xtramelt-ana-tree
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-tree.meltmod-$meltapp_ANA_TREE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:540/460 compiling application module for xtramelt-ana-tree quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/461 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:548/462 in meltbuild-modules failed to compile application xtramelt-ana-tree quicklybuilt
  else
      meltbuild_info melt-build-script.tpl:550/463 not compiling application module for xtramelt-ana-tree quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-tree.meltmod-$meltapp_ANA_TREE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:540/464 compiling application module for xtramelt-ana-tree optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/465 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-tree \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-tree \
	  || meltbuild_error  melt-build-script.tpl:548/466 in meltbuild-modules failed to compile application xtramelt-ana-tree optimized
  else
      meltbuild_info melt-build-script.tpl:550/467 not compiling application module for xtramelt-ana-tree optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-tree.meltmod-$meltapp_ANA_TREE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:540/468 compiling application module for xtramelt-ana-tree debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/469 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-tree \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-tree \
	  || meltbuild_error  melt-build-script.tpl:548/470 in meltbuild-modules failed to compile application xtramelt-ana-tree debugnoline
  else
      meltbuild_info melt-build-script.tpl:550/471 not compiling application module for xtramelt-ana-tree debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-ana-gimple melt-build-script.tpl:512/472
  ...
  ## meltbuild_do_applications xtramelt-ana-gimple melt-build-script.tpl:516/473
 ...
 -o meltbuild-sources/xtramelt-ana-tree+meltdesc.c -ot meltbuild-sources/xtramelt-ana-gimple+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:522/474 emit application C code for xtramelt-ana-gimple
      meltbuild_emit melt-build-script.tpl:523/475 \
	  translatefile \
	  xtramelt-ana-gimple \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:530/476 failed to generate C code of application xtramelt-ana-gimple
  else
      meltbuild_info melt-build-script.tpl:532/477 DONT emit application C code for xtramelt-ana-gimple
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-gimple.meltmod-$meltapp_ANA_GIMPLE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:540/478 compiling application module for xtramelt-ana-gimple quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/479 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:548/480 in meltbuild-modules failed to compile application xtramelt-ana-gimple quicklybuilt
  else
      meltbuild_info melt-build-script.tpl:550/481 not compiling application module for xtramelt-ana-gimple quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-gimple.meltmod-$meltapp_ANA_GIMPLE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:540/482 compiling application module for xtramelt-ana-gimple optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/483 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-gimple \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-gimple \
	  || meltbuild_error  melt-build-script.tpl:548/484 in meltbuild-modules failed to compile application xtramelt-ana-gimple optimized
  else
      meltbuild_info melt-build-script.tpl:550/485 not compiling application module for xtramelt-ana-gimple optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-gimple.meltmod-$meltapp_ANA_GIMPLE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:540/486 compiling application module for xtramelt-ana-gimple debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/487 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-gimple \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-gimple \
	  || meltbuild_error  melt-build-script.tpl:548/488 in meltbuild-modules failed to compile application xtramelt-ana-gimple debugnoline
  else
      meltbuild_info melt-build-script.tpl:550/489 not compiling application module for xtramelt-ana-gimple debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-probe melt-build-script.tpl:512/490
  ...
  ## meltbuild_do_applications xtramelt-probe melt-build-script.tpl:516/491
 ...
 -o meltbuild-sources/xtramelt-ana-gimple+meltdesc.c -ot meltbuild-sources/xtramelt-probe+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:522/492 emit application C code for xtramelt-probe
      meltbuild_emit melt-build-script.tpl:523/493 \
	  translatefile \
	  xtramelt-probe \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:530/494 failed to generate C code of application xtramelt-probe
  else
      meltbuild_info melt-build-script.tpl:532/495 DONT emit application C code for xtramelt-probe
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltapp_PROBE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:540/496 compiling application module for xtramelt-probe quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/497 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
	  || meltbuild_error  melt-build-script.tpl:548/498 in meltbuild-modules failed to compile application xtramelt-probe quicklybuilt
  else
      meltbuild_info melt-build-script.tpl:550/499 not compiling application module for xtramelt-probe quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltapp_PROBE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:540/500 compiling application module for xtramelt-probe optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/501 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
	  || meltbuild_error  melt-build-script.tpl:548/502 in meltbuild-modules failed to compile application xtramelt-probe optimized
  else
      meltbuild_info melt-build-script.tpl:550/503 not compiling application module for xtramelt-probe optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltapp_PROBE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:540/504 compiling application module for xtramelt-probe debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/505 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
	  || meltbuild_error  melt-build-script.tpl:548/506 in meltbuild-modules failed to compile application xtramelt-probe debugnoline
  else
      meltbuild_info melt-build-script.tpl:550/507 not compiling application module for xtramelt-probe debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-ana-simple melt-build-script.tpl:512/508
  ...
  ## meltbuild_do_applications xtramelt-ana-simple melt-build-script.tpl:516/509
 ...
 -o meltbuild-sources/xtramelt-probe+meltdesc.c -ot meltbuild-sources/xtramelt-ana-simple+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:522/510 emit application C code for xtramelt-ana-simple
      meltbuild_emit melt-build-script.tpl:523/511 \
	  translatefile \
	  xtramelt-ana-simple \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:530/512 failed to generate C code of application xtramelt-ana-simple
  else
      meltbuild_info melt-build-script.tpl:532/513 DONT emit application C code for xtramelt-ana-simple
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltapp_ANA_SIMPLE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:540/514 compiling application module for xtramelt-ana-simple quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/515 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:548/516 in meltbuild-modules failed to compile application xtramelt-ana-simple quicklybuilt
  else
      meltbuild_info melt-build-script.tpl:550/517 not compiling application module for xtramelt-ana-simple quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltapp_ANA_SIMPLE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:540/518 compiling application module for xtramelt-ana-simple optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/519 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
	  || meltbuild_error  melt-build-script.tpl:548/520 in meltbuild-modules failed to compile application xtramelt-ana-simple optimized
  else
      meltbuild_info melt-build-script.tpl:550/521 not compiling application module for xtramelt-ana-simple optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltapp_ANA_SIMPLE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:540/522 compiling application module for xtramelt-ana-simple debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/523 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
	  || meltbuild_error  melt-build-script.tpl:548/524 in meltbuild-modules failed to compile application xtramelt-ana-simple debugnoline
  else
      meltbuild_info melt-build-script.tpl:550/525 not compiling application module for xtramelt-ana-simple debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-c-generator melt-build-script.tpl:512/526
  ...
  ## meltbuild_do_applications xtramelt-c-generator melt-build-script.tpl:516/527
 ...
 -o meltbuild-sources/xtramelt-ana-simple+meltdesc.c -ot meltbuild-sources/xtramelt-c-generator+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:522/528 emit application C code for xtramelt-c-generator
      meltbuild_emit melt-build-script.tpl:523/529 \
	  translatefile \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:530/530 failed to generate C code of application xtramelt-c-generator
  else
      meltbuild_info melt-build-script.tpl:532/531 DONT emit application C code for xtramelt-c-generator
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-c-generator.meltmod-$meltapp_C_GENERATOR_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:540/532 compiling application module for xtramelt-c-generator quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/533 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:548/534 in meltbuild-modules failed to compile application xtramelt-c-generator quicklybuilt
  else
      meltbuild_info melt-build-script.tpl:550/535 not compiling application module for xtramelt-c-generator quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-c-generator.meltmod-$meltapp_C_GENERATOR_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:540/536 compiling application module for xtramelt-c-generator optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/537 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-c-generator \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-c-generator \
	  || meltbuild_error  melt-build-script.tpl:548/538 in meltbuild-modules failed to compile application xtramelt-c-generator optimized
  else
      meltbuild_info melt-build-script.tpl:550/539 not compiling application module for xtramelt-c-generator optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-c-generator.meltmod-$meltapp_C_GENERATOR_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:540/540 compiling application module for xtramelt-c-generator debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/541 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-c-generator \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-c-generator \
	  || meltbuild_error  melt-build-script.tpl:548/542 in meltbuild-modules failed to compile application xtramelt-c-generator debugnoline
  else
      meltbuild_info melt-build-script.tpl:550/543 not compiling application module for xtramelt-c-generator debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-opengpu melt-build-script.tpl:512/544
  ...
  ## meltbuild_do_applications xtramelt-opengpu melt-build-script.tpl:516/545
 ...
 -o meltbuild-sources/xtramelt-c-generator+meltdesc.c -ot meltbuild-sources/xtramelt-opengpu+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:522/546 emit application C code for xtramelt-opengpu
      meltbuild_emit melt-build-script.tpl:523/547 \
	  translatefile \
	  xtramelt-opengpu \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:530/548 failed to generate C code of application xtramelt-opengpu
  else
      meltbuild_info melt-build-script.tpl:532/549 DONT emit application C code for xtramelt-opengpu
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-opengpu.meltmod-$meltapp_OPENGPU_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:540/550 compiling application module for xtramelt-opengpu quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/551 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-opengpu \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-opengpu \
	  || meltbuild_error  melt-build-script.tpl:548/552 in meltbuild-modules failed to compile application xtramelt-opengpu quicklybuilt
  else
      meltbuild_info melt-build-script.tpl:550/553 not compiling application module for xtramelt-opengpu quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-opengpu.meltmod-$meltapp_OPENGPU_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:540/554 compiling application module for xtramelt-opengpu optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/555 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-opengpu \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-opengpu \
	  || meltbuild_error  melt-build-script.tpl:548/556 in meltbuild-modules failed to compile application xtramelt-opengpu optimized
  else
      meltbuild_info melt-build-script.tpl:550/557 not compiling application module for xtramelt-opengpu optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-opengpu.meltmod-$meltapp_OPENGPU_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:540/558 compiling application module for xtramelt-opengpu debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:542/559 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-opengpu \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-opengpu \
	  || meltbuild_error  melt-build-script.tpl:548/560 in meltbuild-modules failed to compile application xtramelt-opengpu debugnoline
  else
      meltbuild_info melt-build-script.tpl:550/561 not compiling application module for xtramelt-opengpu debugnoline
  fi
 

  ## meltbuild_do_applications  melt-build-script.tpl:554/562
...
meltbuild_info melt-build-script.tpl:567/563 times after applications at `date '+%x %H:%M:%S'`: ;  times > /dev/stderr
} ## end meltbuild_do_applications  melt-build-script.tpl:568/564
...
if [ ! -f  "$melt_final_application_stamp" \
 ...
 -o "$melt_final_application_stamp" -ot "$GCCMELT_MELTSOURCEDIR/xtramelt-opengpu.melt" \
    ...
    meltbuild_info melt-build-script.tpl:574/565 building MELT applications
    meltbuild_do_applications
else
    meltbuild_info melt-build-script.tpl:577/566 not building MELT applications because of applstamp  "$melt_final_application_stamp"
fi

################################################################
################################################################
### the modules lists melt-build-script.tpl:582/567
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis" \
  ...
  #  melt-build-script.tpl:587/568 module list quicklybuilt
  meltbuild_info  melt-build-script.tpl:588/569 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis"
  ...
  meltbuild_info  melt-build-script.tpl:602/571 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis" \
  ...
  #  melt-build-script.tpl:587/572 module list optimized
  meltbuild_info  melt-build-script.tpl:588/573 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"
  ...
  meltbuild_info  melt-build-script.tpl:602/575 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis" \
  ...
  #  melt-build-script.tpl:587/576 module list debugnoline
  meltbuild_info  melt-build-script.tpl:588/577 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"
  ...
  meltbuild_info  melt-build-script.tpl:602/579 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"  
fi


#@ melt-build-script.tpl:606/580
...
################################################################
################################################################
### the generated documentation meltgendoc.texi melt-build-script.tpl:613/581
...
if [ ! -f meltgendoc.texi  -o meltbuild-sources/warmelt-first.melt -nt meltgendoc.texi  \
 ...
 -o meltbuild-sources/xtramelt-opengpu.melt -nt meltgendoc.texi  ]; then
   meltbuild_info melt-build-script.tpl:617/582 generating meltgendoc.texi
   meltgen_args=meltbuild-gendoc.args-tmp$$
   echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:619/583"' > $meltgen_args
   ...
   meltbuild_info melt-build-script.tpl:631/584  meltbuild-gendoc.args is
   cat meltbuild-gendoc.args > /dev/stderr
   $GCCMELT_CC1_PREFIX $GCCMELT_CC1 @meltbuild-gendoc.args \
     || meltbuild_error melt-build-script.tpl:634/585 failed with arguments @meltbuild-gendoc.args
else
   meltbuild_info melt-build-script.tpl:636/586 keeping meltgendoc.texi
fi

################
meltbuild_info melt-build-script.tpl:640/587 successfully done with times at `date '+%x %H:%M:%S'`: ; times > /dev/stderr

#@ eof melt-build-script.tpl:642/588 end of generated melt-build-script.sh
