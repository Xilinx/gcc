...
#@#@# 
#@#@# It has been AutoGen-ed  July 30, 2012 at 11:01:29 AM by AutoGen 5.16
...
case $melt_overall_goal in
    ...
    gendoc) ;;
    regenerate) ;;
    *) meltbuild_error  melt-build-script.tpl:103/8 bad MELT overall goal "$melt_overall_goal:" \
...
## The base name of the MELT translator files melt-build-script.tpl:112/9
...
case $GCCMELT_ZERO_FLAVOR in
    ...
    debugnoline) ;;
    quicklybuilt) ;;
    *) meltbuild_error  melt-build-script.tpl:120/10 bad zero flavor $GCCMELT_ZERO_FLAVOR ;;
esac


## our stage0 melt-build-script.tpl:124/11
...
function meltbuild_do_stage_zero () {
  ...
  meltbuild_info making stage0 warmelt-first  melt-build-script.tpl:131/12

##  stage0 melt-build-script.tpl:133/13 symlink descriptor file warmelt-first
...
##  stage0 melt-build-script.tpl:138/14 symlink melt/generated source code warmelt-first
...
##  stage0 melt-build-script.tpl:146/15 symlink stamp warmelt-first
...
## manually generate the stage0 warmelt-first+meltbuild.mk file  melt-build-script.tpl:154/16
  ...
  echo "# generated " melt-build-script.tpl:158/17 >> $MELT_ZERO_GENERATED_FIRST_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-first melt-build-script.tpl:162/18' >> $MELT_ZERO_GENERATED_FIRST_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_FIRST_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-first melt-build-script.tpl:170/19'  >> $MELT_ZERO_GENERATED_FIRST_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:183/20 generated stagezero makedep $MELT_ZERO_GENERATED_FIRST_BUILDMK
  ls -l $MELT_ZERO_GENERATED_FIRST_BUILDMK > /dev/stderr

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:187/21 \
      ...
      || meltbuild_error  melt-build-script.tpl:197/22 stage0 warmelt-first did not build with $GCCMELT_MAKE 

  meltbuild_info melt-build-script.tpl:199/23 stage0 warmelt-first module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-first.meltmod-$MELT_ZERO_GENERATED_FIRST_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" > /dev/stderr \
      || meltbuild_error  melt-build-script.tpl:201/24 stage0 warmelt-first fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-first.meltmod-$MELT_ZERO_GENERATED_FIRST_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:204/25 successfully build stage0 warmelt-first
# end stage0  melt-build-script.tpl:205/26 base  warmelt-first

  meltbuild_info making stage0 warmelt-base  melt-build-script.tpl:131/27

##  stage0 melt-build-script.tpl:133/28 symlink descriptor file warmelt-base
...
##  stage0 melt-build-script.tpl:138/29 symlink melt/generated source code warmelt-base
...
##  stage0 melt-build-script.tpl:146/30 symlink stamp warmelt-base
...
## manually generate the stage0 warmelt-base+meltbuild.mk file  melt-build-script.tpl:154/31
  ...
  echo "# generated " melt-build-script.tpl:158/32 >> $MELT_ZERO_GENERATED_BASE_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-base melt-build-script.tpl:162/33' >> $MELT_ZERO_GENERATED_BASE_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_BASE_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-base melt-build-script.tpl:170/34'  >> $MELT_ZERO_GENERATED_BASE_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:183/35 generated stagezero makedep $MELT_ZERO_GENERATED_BASE_BUILDMK
  ls -l $MELT_ZERO_GENERATED_BASE_BUILDMK > /dev/stderr

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:187/36 \
      GCCMELT_CC="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:197/37 stage0 warmelt-base did not build with $GCCMELT_MAKE 

  meltbuild_info melt-build-script.tpl:199/38 stage0 warmelt-base module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-base.meltmod-$MELT_ZERO_GENERATED_BASE_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" > /dev/stderr \
      || meltbuild_error  melt-build-script.tpl:201/39 stage0 warmelt-base fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-base.meltmod-$MELT_ZERO_GENERATED_BASE_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:204/40 successfully build stage0 warmelt-base
# end stage0  melt-build-script.tpl:205/41 base  warmelt-base

  meltbuild_info making stage0 warmelt-debug  melt-build-script.tpl:131/42

##  stage0 melt-build-script.tpl:133/43 symlink descriptor file warmelt-debug
...
##  stage0 melt-build-script.tpl:138/44 symlink melt/generated source code warmelt-debug
...
##  stage0 melt-build-script.tpl:146/45 symlink stamp warmelt-debug
...
## manually generate the stage0 warmelt-debug+meltbuild.mk file  melt-build-script.tpl:154/46
  ...
  echo "# generated " melt-build-script.tpl:158/47 >> $MELT_ZERO_GENERATED_DEBUG_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-debug melt-build-script.tpl:162/48' >> $MELT_ZERO_GENERATED_DEBUG_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_DEBUG_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-debug melt-build-script.tpl:170/49'  >> $MELT_ZERO_GENERATED_DEBUG_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:183/50 generated stagezero makedep $MELT_ZERO_GENERATED_DEBUG_BUILDMK
  ls -l $MELT_ZERO_GENERATED_DEBUG_BUILDMK > /dev/stderr

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:187/51 \
      GCCMELT_CC="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:197/52 stage0 warmelt-debug did not build with $GCCMELT_MAKE 

  meltbuild_info melt-build-script.tpl:199/53 stage0 warmelt-debug module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-debug.meltmod-$MELT_ZERO_GENERATED_DEBUG_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" > /dev/stderr \
      || meltbuild_error  melt-build-script.tpl:201/54 stage0 warmelt-debug fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-debug.meltmod-$MELT_ZERO_GENERATED_DEBUG_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:204/55 successfully build stage0 warmelt-debug
# end stage0  melt-build-script.tpl:205/56 base  warmelt-debug

  meltbuild_info making stage0 warmelt-macro  melt-build-script.tpl:131/57

##  stage0 melt-build-script.tpl:133/58 symlink descriptor file warmelt-macro
...
##  stage0 melt-build-script.tpl:138/59 symlink melt/generated source code warmelt-macro
...
##  stage0 melt-build-script.tpl:146/60 symlink stamp warmelt-macro
...
## manually generate the stage0 warmelt-macro+meltbuild.mk file  melt-build-script.tpl:154/61
  ...
  echo "# generated " melt-build-script.tpl:158/62 >> $MELT_ZERO_GENERATED_MACRO_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-macro melt-build-script.tpl:162/63' >> $MELT_ZERO_GENERATED_MACRO_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_MACRO_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-macro melt-build-script.tpl:170/64'  >> $MELT_ZERO_GENERATED_MACRO_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:183/65 generated stagezero makedep $MELT_ZERO_GENERATED_MACRO_BUILDMK
  ls -l $MELT_ZERO_GENERATED_MACRO_BUILDMK > /dev/stderr

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:187/66 \
      GCCMELT_CC="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:197/67 stage0 warmelt-macro did not build with $GCCMELT_MAKE 

  meltbuild_info melt-build-script.tpl:199/68 stage0 warmelt-macro module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-macro.meltmod-$MELT_ZERO_GENERATED_MACRO_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" > /dev/stderr \
      || meltbuild_error  melt-build-script.tpl:201/69 stage0 warmelt-macro fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-macro.meltmod-$MELT_ZERO_GENERATED_MACRO_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:204/70 successfully build stage0 warmelt-macro
# end stage0  melt-build-script.tpl:205/71 base  warmelt-macro

  meltbuild_info making stage0 warmelt-normal  melt-build-script.tpl:131/72

##  stage0 melt-build-script.tpl:133/73 symlink descriptor file warmelt-normal
...
##  stage0 melt-build-script.tpl:138/74 symlink melt/generated source code warmelt-normal
...
##  stage0 melt-build-script.tpl:146/75 symlink stamp warmelt-normal
...
## manually generate the stage0 warmelt-normal+meltbuild.mk file  melt-build-script.tpl:154/76
  ...
  echo "# generated " melt-build-script.tpl:158/77 >> $MELT_ZERO_GENERATED_NORMAL_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-normal melt-build-script.tpl:162/78' >> $MELT_ZERO_GENERATED_NORMAL_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_NORMAL_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-normal melt-build-script.tpl:170/79'  >> $MELT_ZERO_GENERATED_NORMAL_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:183/80 generated stagezero makedep $MELT_ZERO_GENERATED_NORMAL_BUILDMK
  ls -l $MELT_ZERO_GENERATED_NORMAL_BUILDMK > /dev/stderr

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:187/81 \
      GCCMELT_CC="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:197/82 stage0 warmelt-normal did not build with $GCCMELT_MAKE 

  meltbuild_info melt-build-script.tpl:199/83 stage0 warmelt-normal module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-normal.meltmod-$MELT_ZERO_GENERATED_NORMAL_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" > /dev/stderr \
      || meltbuild_error  melt-build-script.tpl:201/84 stage0 warmelt-normal fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-normal.meltmod-$MELT_ZERO_GENERATED_NORMAL_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:204/85 successfully build stage0 warmelt-normal
# end stage0  melt-build-script.tpl:205/86 base  warmelt-normal

  meltbuild_info making stage0 warmelt-normatch  melt-build-script.tpl:131/87

##  stage0 melt-build-script.tpl:133/88 symlink descriptor file warmelt-normatch
...
##  stage0 melt-build-script.tpl:138/89 symlink melt/generated source code warmelt-normatch
...
##  stage0 melt-build-script.tpl:146/90 symlink stamp warmelt-normatch
...
## manually generate the stage0 warmelt-normatch+meltbuild.mk file  melt-build-script.tpl:154/91
  ...
  echo "# generated " melt-build-script.tpl:158/92 >> $MELT_ZERO_GENERATED_NORMATCH_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-normatch melt-build-script.tpl:162/93' >> $MELT_ZERO_GENERATED_NORMATCH_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_NORMATCH_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-normatch melt-build-script.tpl:170/94'  >> $MELT_ZERO_GENERATED_NORMATCH_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:183/95 generated stagezero makedep $MELT_ZERO_GENERATED_NORMATCH_BUILDMK
  ls -l $MELT_ZERO_GENERATED_NORMATCH_BUILDMK > /dev/stderr

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:187/96 \
      GCCMELT_CC="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:197/97 stage0 warmelt-normatch did not build with $GCCMELT_MAKE 

  meltbuild_info melt-build-script.tpl:199/98 stage0 warmelt-normatch module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-normatch.meltmod-$MELT_ZERO_GENERATED_NORMATCH_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" > /dev/stderr \
      || meltbuild_error  melt-build-script.tpl:201/99 stage0 warmelt-normatch fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-normatch.meltmod-$MELT_ZERO_GENERATED_NORMATCH_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:204/100 successfully build stage0 warmelt-normatch
# end stage0  melt-build-script.tpl:205/101 base  warmelt-normatch

  meltbuild_info making stage0 warmelt-genobj  melt-build-script.tpl:131/102

##  stage0 melt-build-script.tpl:133/103 symlink descriptor file warmelt-genobj
...
##  stage0 melt-build-script.tpl:138/104 symlink melt/generated source code warmelt-genobj
...
##  stage0 melt-build-script.tpl:146/105 symlink stamp warmelt-genobj
...
## manually generate the stage0 warmelt-genobj+meltbuild.mk file  melt-build-script.tpl:154/106
  ...
  echo "# generated " melt-build-script.tpl:158/107 >> $MELT_ZERO_GENERATED_GENOBJ_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-genobj melt-build-script.tpl:162/108' >> $MELT_ZERO_GENERATED_GENOBJ_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_GENOBJ_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-genobj melt-build-script.tpl:170/109'  >> $MELT_ZERO_GENERATED_GENOBJ_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:183/110 generated stagezero makedep $MELT_ZERO_GENERATED_GENOBJ_BUILDMK
  ls -l $MELT_ZERO_GENERATED_GENOBJ_BUILDMK > /dev/stderr

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:187/111 \
      GCCMELT_CC="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:197/112 stage0 warmelt-genobj did not build with $GCCMELT_MAKE 

  meltbuild_info melt-build-script.tpl:199/113 stage0 warmelt-genobj module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-genobj.meltmod-$MELT_ZERO_GENERATED_GENOBJ_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" > /dev/stderr \
      || meltbuild_error  melt-build-script.tpl:201/114 stage0 warmelt-genobj fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-genobj.meltmod-$MELT_ZERO_GENERATED_GENOBJ_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:204/115 successfully build stage0 warmelt-genobj
# end stage0  melt-build-script.tpl:205/116 base  warmelt-genobj

  meltbuild_info making stage0 warmelt-outobj  melt-build-script.tpl:131/117

##  stage0 melt-build-script.tpl:133/118 symlink descriptor file warmelt-outobj
...
##  stage0 melt-build-script.tpl:138/119 symlink melt/generated source code warmelt-outobj
...
##  stage0 melt-build-script.tpl:146/120 symlink stamp warmelt-outobj
...
## manually generate the stage0 warmelt-outobj+meltbuild.mk file  melt-build-script.tpl:154/121
  ...
  echo "# generated " melt-build-script.tpl:158/122 >> $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-outobj melt-build-script.tpl:162/123' >> $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-outobj melt-build-script.tpl:170/124'  >> $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:183/125 generated stagezero makedep $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK
  ls -l $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK > /dev/stderr

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:187/126 \
      GCCMELT_CC="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:197/127 stage0 warmelt-outobj did not build with $GCCMELT_MAKE 

  meltbuild_info melt-build-script.tpl:199/128 stage0 warmelt-outobj module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-outobj.meltmod-$MELT_ZERO_GENERATED_OUTOBJ_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" > /dev/stderr \
      || meltbuild_error  melt-build-script.tpl:201/129 stage0 warmelt-outobj fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-outobj.meltmod-$MELT_ZERO_GENERATED_OUTOBJ_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:204/130 successfully build stage0 warmelt-outobj
# end stage0  melt-build-script.tpl:205/131 base  warmelt-outobj

  meltbuild_info making stage0 warmelt-modes  melt-build-script.tpl:131/132

##  stage0 melt-build-script.tpl:133/133 symlink descriptor file warmelt-modes
...
##  stage0 melt-build-script.tpl:138/134 symlink melt/generated source code warmelt-modes
...
##  stage0 melt-build-script.tpl:146/135 symlink stamp warmelt-modes
...
## manually generate the stage0 warmelt-modes+meltbuild.mk file  melt-build-script.tpl:154/136
  ...
  echo "# generated " melt-build-script.tpl:158/137 >> $MELT_ZERO_GENERATED_MODES_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-modes melt-build-script.tpl:162/138' >> $MELT_ZERO_GENERATED_MODES_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_MODES_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-modes melt-build-script.tpl:170/139'  >> $MELT_ZERO_GENERATED_MODES_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:183/140 generated stagezero makedep $MELT_ZERO_GENERATED_MODES_BUILDMK
  ls -l $MELT_ZERO_GENERATED_MODES_BUILDMK > /dev/stderr

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:187/141 \
      GCCMELT_CC="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:197/142 stage0 warmelt-modes did not build with $GCCMELT_MAKE 

  meltbuild_info melt-build-script.tpl:199/143 stage0 warmelt-modes module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-modes.meltmod-$MELT_ZERO_GENERATED_MODES_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" > /dev/stderr \
      || meltbuild_error  melt-build-script.tpl:201/144 stage0 warmelt-modes fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-modes.meltmod-$MELT_ZERO_GENERATED_MODES_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:204/145 successfully build stage0 warmelt-modes
# end stage0  melt-build-script.tpl:205/146 base  warmelt-modes

} ################ end of function meltbuild_do_stage_zero melt-build-script.tpl:207/147
################################################################

## stage0 stamp file melt-build-script.tpl:210/148
melt_stagezero_stamp=$GCCMELT_STAGE_ZERO/$GCCMELT_STAGE_ZERO.stamp

## test if stage0 should be skipped then do it  melt-build-script.tpl:213/149
if [ ! -f "$melt_stagezero_stamp" -o "$melt_stagezero_stamp" -ot "$GCCMELT_RUNTIME_DEPENDENCY" ]; then
   meltbuild_do_stage_zero
    ...
    echo MELT stagezero stampfile $GCCMELT_STAGE_ZERO.stamp for MELT $MELTGCCBUILTIN_VERSION_STRING from melt-build-script.tpl:217/150 >  $melt_stagezero_stamptemp
    echo $GCCMELT_RUNTIME_DEPENDENCY_MD5SUM $GCCMELT_RUNTIME_DEPENDENCY >> $melt_stagezero_stamptemp

#  stagezero stamp melt-build-script.tpl:220/151 base  warmelt-first
...
#  stagezero stamp melt-build-script.tpl:220/152 base  warmelt-base
...
#  stagezero stamp melt-build-script.tpl:220/153 base  warmelt-debug
...
#  stagezero stamp melt-build-script.tpl:220/154 base  warmelt-macro
...
#  stagezero stamp melt-build-script.tpl:220/155 base  warmelt-normal
...
#  stagezero stamp melt-build-script.tpl:220/156 base  warmelt-normatch
...
#  stagezero stamp melt-build-script.tpl:220/157 base  warmelt-genobj
...
#  stagezero stamp melt-build-script.tpl:220/158 base  warmelt-outobj
...
#  stagezero stamp melt-build-script.tpl:220/159 base  warmelt-modes
   ...
   meltbuild_info melt-build-script.tpl:226/160 skipped stage0 because of stamp file $melt_stagezero_stamp
fi

meltbuild_info melt-build-script.tpl:229/161 times after stagezero at `date '+%x %H:%M:%S'`: ;  times > /dev/stderr



################################################################
## function to run MELT to emit C code  melt-build-script.tpl:234/162
function meltbuild_emit () {
	...
	for meltcsecfil in $meltstage/$meltbase+[0-9][0-9].c ; do
		...
		: # at  melt-build-script.tpl:286/163
	    else
...
################################################################
################################################################
#################@ before our stages melt-build-script.tpl:306/164 
### Our stages  
...
################################################################
#### function to do a stage melt-build-script.tpl:315/165
...
####  meltbuild_do_stage melt-build-script.tpl:328/166
    ...
    #in meltbuild_do_stage melt-build-script.tpl:338/167 base warmelt-first
    meltbuild_info melt-build-script.tpl:339/168 from $meltfrom generating C code of warmelt-first in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:341/169 emit C code for warmelt-first
    meltbuild_emit melt-build-script.tpl:342/170-$meltfrom \
	translateinit \
	warmelt-first \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:354/171 checksum C code for warmelt-first
    meltchecksum_cumul_FIRST=$(cat "$meltcurstagedir"/warmelt-first.c "$meltcurstagedir"/warmelt-first+[0-9][0-9].c | $MD5SUM | cut -b 1-32)

    #in meltbuild_do_stage melt-build-script.tpl:357/172 perhaps compiling C code for warmelt-first
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:359/173-$meltfrom compiling module warmelt-first in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:361/174-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	...
	|| meltbuild_error  melt-build-script.tpl:367/175-$meltfrom in "$meltcurstagedir/" failed to make module warmelt-first
    else
	meltbuild_info melt-build-script.tpl:369/176-$meltfrom NOT compiling module warmelt-first "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:375/177 done base warmelt-first


    #in meltbuild_do_stage melt-build-script.tpl:338/178 base warmelt-base
    meltbuild_info melt-build-script.tpl:339/179 from $meltfrom generating C code of warmelt-base in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:341/180 emit C code for warmelt-base
    meltbuild_emit melt-build-script.tpl:342/181-$meltfrom \
	translatefile \
	warmelt-base \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:354/182 checksum C code for warmelt-base
    meltchecksum_cumul_BASE=$(cat "$meltcurstagedir"/warmelt-base.c "$meltcurstagedir"/warmelt-base+[0-9][0-9].c | $MD5SUM | cut -b 1-32)

    #in meltbuild_do_stage melt-build-script.tpl:357/183 perhaps compiling C code for warmelt-base
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:359/184-$meltfrom compiling module warmelt-base in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:361/185-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-base" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-base" \
	|| meltbuild_error  melt-build-script.tpl:367/186-$meltfrom in "$meltcurstagedir/" failed to make module warmelt-base
    else
	meltbuild_info melt-build-script.tpl:369/187-$meltfrom NOT compiling module warmelt-base "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:375/188 done base warmelt-base


    #in meltbuild_do_stage melt-build-script.tpl:338/189 base warmelt-debug
    meltbuild_info melt-build-script.tpl:339/190 from $meltfrom generating C code of warmelt-debug in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:341/191 emit C code for warmelt-debug
    meltbuild_emit melt-build-script.tpl:342/192-$meltfrom \
	translatefile \
	warmelt-debug \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:354/193 checksum C code for warmelt-debug
    meltchecksum_cumul_DEBUG=$(cat "$meltcurstagedir"/warmelt-debug.c "$meltcurstagedir"/warmelt-debug+[0-9][0-9].c | $MD5SUM | cut -b 1-32)

    #in meltbuild_do_stage melt-build-script.tpl:357/194 perhaps compiling C code for warmelt-debug
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:359/195-$meltfrom compiling module warmelt-debug in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:361/196-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-debug" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-debug" \
	|| meltbuild_error  melt-build-script.tpl:367/197-$meltfrom in "$meltcurstagedir/" failed to make module warmelt-debug
    else
	meltbuild_info melt-build-script.tpl:369/198-$meltfrom NOT compiling module warmelt-debug "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:375/199 done base warmelt-debug


    #in meltbuild_do_stage melt-build-script.tpl:338/200 base warmelt-macro
    meltbuild_info melt-build-script.tpl:339/201 from $meltfrom generating C code of warmelt-macro in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:341/202 emit C code for warmelt-macro
    meltbuild_emit melt-build-script.tpl:342/203-$meltfrom \
	translatefile \
	warmelt-macro \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:354/204 checksum C code for warmelt-macro
    meltchecksum_cumul_MACRO=$(cat "$meltcurstagedir"/warmelt-macro.c "$meltcurstagedir"/warmelt-macro+[0-9][0-9].c | $MD5SUM | cut -b 1-32)

    #in meltbuild_do_stage melt-build-script.tpl:357/205 perhaps compiling C code for warmelt-macro
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:359/206-$meltfrom compiling module warmelt-macro in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:361/207-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-macro" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-macro" \
	|| meltbuild_error  melt-build-script.tpl:367/208-$meltfrom in "$meltcurstagedir/" failed to make module warmelt-macro
    else
	meltbuild_info melt-build-script.tpl:369/209-$meltfrom NOT compiling module warmelt-macro "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:375/210 done base warmelt-macro


    #in meltbuild_do_stage melt-build-script.tpl:338/211 base warmelt-normal
    meltbuild_info melt-build-script.tpl:339/212 from $meltfrom generating C code of warmelt-normal in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:341/213 emit C code for warmelt-normal
    meltbuild_emit melt-build-script.tpl:342/214-$meltfrom \
	translatefile \
	warmelt-normal \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:354/215 checksum C code for warmelt-normal
    ...
    #in meltbuild_do_stage melt-build-script.tpl:357/216 perhaps compiling C code for warmelt-normal
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:359/217-$meltfrom compiling module warmelt-normal in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:361/218-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-normal" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-normal" \
	|| meltbuild_error  melt-build-script.tpl:367/219-$meltfrom in "$meltcurstagedir/" failed to make module warmelt-normal
    else
	meltbuild_info melt-build-script.tpl:369/220-$meltfrom NOT compiling module warmelt-normal "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:375/221 done base warmelt-normal


    #in meltbuild_do_stage melt-build-script.tpl:338/222 base warmelt-normatch
    meltbuild_info melt-build-script.tpl:339/223 from $meltfrom generating C code of warmelt-normatch in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:341/224 emit C code for warmelt-normatch
    meltbuild_emit melt-build-script.tpl:342/225-$meltfrom \
	translatefile \
	warmelt-normatch \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:354/226 checksum C code for warmelt-normatch
    ...
    #in meltbuild_do_stage melt-build-script.tpl:357/227 perhaps compiling C code for warmelt-normatch
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:359/228-$meltfrom compiling module warmelt-normatch in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:361/229-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-normatch" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-normatch" \
	|| meltbuild_error  melt-build-script.tpl:367/230-$meltfrom in "$meltcurstagedir/" failed to make module warmelt-normatch
    else
	meltbuild_info melt-build-script.tpl:369/231-$meltfrom NOT compiling module warmelt-normatch "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:375/232 done base warmelt-normatch


    #in meltbuild_do_stage melt-build-script.tpl:338/233 base warmelt-genobj
    meltbuild_info melt-build-script.tpl:339/234 from $meltfrom generating C code of warmelt-genobj in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:341/235 emit C code for warmelt-genobj
    meltbuild_emit melt-build-script.tpl:342/236-$meltfrom \
	translatefile \
	warmelt-genobj \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:354/237 checksum C code for warmelt-genobj
    ...
    #in meltbuild_do_stage melt-build-script.tpl:357/238 perhaps compiling C code for warmelt-genobj
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:359/239-$meltfrom compiling module warmelt-genobj in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:361/240-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-genobj" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-genobj" \
	|| meltbuild_error  melt-build-script.tpl:367/241-$meltfrom in "$meltcurstagedir/" failed to make module warmelt-genobj
    else
	meltbuild_info melt-build-script.tpl:369/242-$meltfrom NOT compiling module warmelt-genobj "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:375/243 done base warmelt-genobj


    #in meltbuild_do_stage melt-build-script.tpl:338/244 base warmelt-outobj
    meltbuild_info melt-build-script.tpl:339/245 from $meltfrom generating C code of warmelt-outobj in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:341/246 emit C code for warmelt-outobj
    meltbuild_emit melt-build-script.tpl:342/247-$meltfrom \
	translatefile \
	warmelt-outobj \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:354/248 checksum C code for warmelt-outobj
    ...
    #in meltbuild_do_stage melt-build-script.tpl:357/249 perhaps compiling C code for warmelt-outobj
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:359/250-$meltfrom compiling module warmelt-outobj in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:361/251-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-outobj" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-outobj" \
	|| meltbuild_error  melt-build-script.tpl:367/252-$meltfrom in "$meltcurstagedir/" failed to make module warmelt-outobj
    else
	meltbuild_info melt-build-script.tpl:369/253-$meltfrom NOT compiling module warmelt-outobj "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:375/254 done base warmelt-outobj


    #in meltbuild_do_stage melt-build-script.tpl:338/255 base warmelt-modes
    meltbuild_info melt-build-script.tpl:339/256 from $meltfrom generating C code of warmelt-modes in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:341/257 emit C code for warmelt-modes
    meltbuild_emit melt-build-script.tpl:342/258-$meltfrom \
	translatefile \
	warmelt-modes \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:354/259 checksum C code for warmelt-modes
    meltchecksum_cumul_MODES=$(cat "$meltcurstagedir"/warmelt-modes.c "$meltcurstagedir"/warmelt-modes+[0-9][0-9].c | $MD5SUM | cut -b 1-32)

    #in meltbuild_do_stage melt-build-script.tpl:357/260 perhaps compiling C code for warmelt-modes
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:359/261-$meltfrom compiling module warmelt-modes in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:361/262-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-modes" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-modes" \
	|| meltbuild_error  melt-build-script.tpl:367/263-$meltfrom in "$meltcurstagedir/" failed to make module warmelt-modes
    else
	meltbuild_info melt-build-script.tpl:369/264-$meltfrom NOT compiling module warmelt-modes "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:375/265 done base warmelt-modes


    #in meltbuild_do_stage melt-build-script.tpl:378/266 generating the stampfile
    ...
    #in meltbuild_do_stage melt-build-script.tpl:390/267 ending
...
}				#### end meltbuild_do_stage melt-build-script.tpl:393/268
################################################################

##### possibly run all our stages  melt-build-script.tpl:396/269

#@  melt-build-script.tpl:398/270 stagedir meltbuild-stage1
GCCMELT_SKIPEMITC=
if [ ! -f meltbuild-stage1/meltbuild-stage1.stamp -o meltbuild-stage1/meltbuild-stage1.stamp -ot $GCCMELT_RUNTIME_DEPENDENCY \
 ...
 -o meltbuild-stage1/meltbuild-stage1.stamp -ot $GCCMELT_MELTSOURCEDIR/warmelt-modes.melt \
    ...
    meltbuild_info  melt-build-script.tpl:403/271 building stage meltbuild-stage1
    ## building stage meltbuild-stage1 previous $GCCMELT_STAGE_ZERO  melt-build-script.tpl:404/272
    meltbuild_do_stage  melt-build-script.tpl:405/273 meltbuild-stage1 quicklybuilt $GCCMELT_STAGE_ZERO $GCCMELT_ZERO_FLAVOR
else
    meltbuild_info  melt-build-script.tpl:407/274 skipping stage meltbuild-stage1
fi

##  melt-build-script.tpl:410/275
GCCMELT_LASTSTAGE=meltbuild-stage1


#@  melt-build-script.tpl:398/276 stagedir meltbuild-stage2
GCCMELT_SKIPEMITC=
if [ ! -f meltbuild-stage2/meltbuild-stage2.stamp -o meltbuild-stage2/meltbuild-stage2.stamp -ot $GCCMELT_RUNTIME_DEPENDENCY \
 ...
 -o meltbuild-stage2/meltbuild-stage2.stamp -ot $GCCMELT_MELTSOURCEDIR/warmelt-modes.melt \
    ...
    meltbuild_info  melt-build-script.tpl:403/277 building stage meltbuild-stage2
    ## building stage meltbuild-stage2 previous meltbuild-stage1  melt-build-script.tpl:404/278
    meltbuild_do_stage  melt-build-script.tpl:405/279 meltbuild-stage2 quicklybuilt meltbuild-stage1 quicklybuilt
else
    meltbuild_info  melt-build-script.tpl:407/280 skipping stage meltbuild-stage2
fi

##  melt-build-script.tpl:410/281
GCCMELT_LASTSTAGE=meltbuild-stage2


#@  melt-build-script.tpl:398/282 stagedir meltbuild-stage3
GCCMELT_SKIPEMITC=
if [ ! -f meltbuild-stage3/meltbuild-stage3.stamp -o meltbuild-stage3/meltbuild-stage3.stamp -ot $GCCMELT_RUNTIME_DEPENDENCY \
 ...
 -o meltbuild-stage3/meltbuild-stage3.stamp -ot $GCCMELT_MELTSOURCEDIR/warmelt-modes.melt \
    ...
    meltbuild_info  melt-build-script.tpl:403/283 building stage meltbuild-stage3
    ## building stage meltbuild-stage3 previous meltbuild-stage2  melt-build-script.tpl:404/284
    meltbuild_do_stage  melt-build-script.tpl:405/285 meltbuild-stage3 quicklybuilt meltbuild-stage2 quicklybuilt
else
    meltbuild_info  melt-build-script.tpl:407/286 skipping stage meltbuild-stage3
fi

##  melt-build-script.tpl:410/287
...
meltbuild_info melt-build-script.tpl:420/288 last stage $GCCMELT_LASTSTAGE

################################################################
################################################################
###########@ before generating meltbuild-sources melt-build-script.tpl:424/289
...
#@ from  melt-build-script.tpl:433/290  compiling the modules
[ -d meltbuild-modules ] || mkdir meltbuild-modules

################################################################
function meltbuild_emit_translator_sources () {

  ## meltbuild_emit_source  melt-build-script.tpl:439/291 base warmelt-first
  meltbuild_info melt-build-script.tpl:440/292 generating C code of warmelt-first in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:441/293 \
      translatefile \
      warmelt-first \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:439/294 base warmelt-base
  meltbuild_info melt-build-script.tpl:440/295 generating C code of warmelt-base in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:441/296 \
      translatefile \
      warmelt-base \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:439/297 base warmelt-debug
  meltbuild_info melt-build-script.tpl:440/298 generating C code of warmelt-debug in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:441/299 \
      translatefile \
      warmelt-debug \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:439/300 base warmelt-macro
  meltbuild_info melt-build-script.tpl:440/301 generating C code of warmelt-macro in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:441/302 \
      translatefile \
      warmelt-macro \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:439/303 base warmelt-normal
  meltbuild_info melt-build-script.tpl:440/304 generating C code of warmelt-normal in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:441/305 \
      translatefile \
      warmelt-normal \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:439/306 base warmelt-normatch
  meltbuild_info melt-build-script.tpl:440/307 generating C code of warmelt-normatch in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:441/308 \
      translatefile \
      warmelt-normatch \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:439/309 base warmelt-genobj
  meltbuild_info melt-build-script.tpl:440/310 generating C code of warmelt-genobj in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:441/311 \
      translatefile \
      warmelt-genobj \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:439/312 base warmelt-outobj
  meltbuild_info melt-build-script.tpl:440/313 generating C code of warmelt-outobj in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:441/314 \
      translatefile \
      warmelt-outobj \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:439/315 base warmelt-modes
  meltbuild_info melt-build-script.tpl:440/316 generating C code of warmelt-modes in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:441/317 \
      translatefile \
      warmelt-modes \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
...
function meltbuild_compile_translator_modules () {
  ...
  # in meltbuild_compile_translator_sources quicklybuilt melt-build-script.tpl:456/318
  meltbuild_info melt-build-script.tpl:457/319 compiling translator quicklybuilt


   #@ melt-build-script.tpl:460/320 flavor quicklybuilt base warmelt-first
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/321 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
 ...
 || meltbuild_error  melt-build-script.tpl:468/322 in meltbuild-modules failed to compile translator warmelt-first quicklybuilt

   #@ melt-build-script.tpl:460/323 flavor quicklybuilt base warmelt-base
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/324 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-base \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-base \
 || meltbuild_error  melt-build-script.tpl:468/325 in meltbuild-modules failed to compile translator warmelt-base quicklybuilt

   #@ melt-build-script.tpl:460/326 flavor quicklybuilt base warmelt-debug
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/327 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-debug \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-debug \
 || meltbuild_error  melt-build-script.tpl:468/328 in meltbuild-modules failed to compile translator warmelt-debug quicklybuilt

   #@ melt-build-script.tpl:460/329 flavor quicklybuilt base warmelt-macro
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/330 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-macro \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-macro \
 || meltbuild_error  melt-build-script.tpl:468/331 in meltbuild-modules failed to compile translator warmelt-macro quicklybuilt

   #@ melt-build-script.tpl:460/332 flavor quicklybuilt base warmelt-normal
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/333 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-normal \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-normal \
 || meltbuild_error  melt-build-script.tpl:468/334 in meltbuild-modules failed to compile translator warmelt-normal quicklybuilt

   #@ melt-build-script.tpl:460/335 flavor quicklybuilt base warmelt-normatch
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/336 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-normatch \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-normatch \
 || meltbuild_error  melt-build-script.tpl:468/337 in meltbuild-modules failed to compile translator warmelt-normatch quicklybuilt

   #@ melt-build-script.tpl:460/338 flavor quicklybuilt base warmelt-genobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/339 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-genobj \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-genobj \
 || meltbuild_error  melt-build-script.tpl:468/340 in meltbuild-modules failed to compile translator warmelt-genobj quicklybuilt

   #@ melt-build-script.tpl:460/341 flavor quicklybuilt base warmelt-outobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/342 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-outobj \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-outobj \
 || meltbuild_error  melt-build-script.tpl:468/343 in meltbuild-modules failed to compile translator warmelt-outobj quicklybuilt

   #@ melt-build-script.tpl:460/344 flavor quicklybuilt base warmelt-modes
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/345 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-modes \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-modes \
 || meltbuild_error  melt-build-script.tpl:468/346 in meltbuild-modules failed to compile translator warmelt-modes quicklybuilt




  # in meltbuild_compile_translator_sources optimized melt-build-script.tpl:456/347
  meltbuild_info melt-build-script.tpl:457/348 compiling translator optimized


   #@ melt-build-script.tpl:460/349 flavor optimized base warmelt-first
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/350 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-first \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-first \
 || meltbuild_error  melt-build-script.tpl:468/351 in meltbuild-modules failed to compile translator warmelt-first optimized

   #@ melt-build-script.tpl:460/352 flavor optimized base warmelt-base
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/353 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-base \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-base \
 || meltbuild_error  melt-build-script.tpl:468/354 in meltbuild-modules failed to compile translator warmelt-base optimized

   #@ melt-build-script.tpl:460/355 flavor optimized base warmelt-debug
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/356 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-debug \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-debug \
 || meltbuild_error  melt-build-script.tpl:468/357 in meltbuild-modules failed to compile translator warmelt-debug optimized

   #@ melt-build-script.tpl:460/358 flavor optimized base warmelt-macro
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/359 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-macro \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-macro \
 || meltbuild_error  melt-build-script.tpl:468/360 in meltbuild-modules failed to compile translator warmelt-macro optimized

   #@ melt-build-script.tpl:460/361 flavor optimized base warmelt-normal
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/362 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-normal \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-normal \
 || meltbuild_error  melt-build-script.tpl:468/363 in meltbuild-modules failed to compile translator warmelt-normal optimized

   #@ melt-build-script.tpl:460/364 flavor optimized base warmelt-normatch
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/365 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-normatch \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-normatch \
 || meltbuild_error  melt-build-script.tpl:468/366 in meltbuild-modules failed to compile translator warmelt-normatch optimized

   #@ melt-build-script.tpl:460/367 flavor optimized base warmelt-genobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/368 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-genobj \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-genobj \
 || meltbuild_error  melt-build-script.tpl:468/369 in meltbuild-modules failed to compile translator warmelt-genobj optimized

   #@ melt-build-script.tpl:460/370 flavor optimized base warmelt-outobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/371 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-outobj \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-outobj \
 || meltbuild_error  melt-build-script.tpl:468/372 in meltbuild-modules failed to compile translator warmelt-outobj optimized

   #@ melt-build-script.tpl:460/373 flavor optimized base warmelt-modes
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/374 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-modes \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-modes \
 || meltbuild_error  melt-build-script.tpl:468/375 in meltbuild-modules failed to compile translator warmelt-modes optimized




  # in meltbuild_compile_translator_sources debugnoline melt-build-script.tpl:456/376
  meltbuild_info melt-build-script.tpl:457/377 compiling translator debugnoline


   #@ melt-build-script.tpl:460/378 flavor debugnoline base warmelt-first
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/379 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-first \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-first \
 || meltbuild_error  melt-build-script.tpl:468/380 in meltbuild-modules failed to compile translator warmelt-first debugnoline

   #@ melt-build-script.tpl:460/381 flavor debugnoline base warmelt-base
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/382 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-base \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-base \
 || meltbuild_error  melt-build-script.tpl:468/383 in meltbuild-modules failed to compile translator warmelt-base debugnoline

   #@ melt-build-script.tpl:460/384 flavor debugnoline base warmelt-debug
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/385 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-debug \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-debug \
 || meltbuild_error  melt-build-script.tpl:468/386 in meltbuild-modules failed to compile translator warmelt-debug debugnoline

   #@ melt-build-script.tpl:460/387 flavor debugnoline base warmelt-macro
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/388 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-macro \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-macro \
 || meltbuild_error  melt-build-script.tpl:468/389 in meltbuild-modules failed to compile translator warmelt-macro debugnoline

   #@ melt-build-script.tpl:460/390 flavor debugnoline base warmelt-normal
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/391 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-normal \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-normal \
 || meltbuild_error  melt-build-script.tpl:468/392 in meltbuild-modules failed to compile translator warmelt-normal debugnoline

   #@ melt-build-script.tpl:460/393 flavor debugnoline base warmelt-normatch
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/394 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-normatch \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-normatch \
 || meltbuild_error  melt-build-script.tpl:468/395 in meltbuild-modules failed to compile translator warmelt-normatch debugnoline

   #@ melt-build-script.tpl:460/396 flavor debugnoline base warmelt-genobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/397 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-genobj \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-genobj \
 || meltbuild_error  melt-build-script.tpl:468/398 in meltbuild-modules failed to compile translator warmelt-genobj debugnoline

   #@ melt-build-script.tpl:460/399 flavor debugnoline base warmelt-outobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/400 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-outobj \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-outobj \
 || meltbuild_error  melt-build-script.tpl:468/401 in meltbuild-modules failed to compile translator warmelt-outobj debugnoline

   #@ melt-build-script.tpl:460/402 flavor debugnoline base warmelt-modes
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:462/403 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-modes \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-modes \
 || meltbuild_error  melt-build-script.tpl:468/404 in meltbuild-modules failed to compile translator warmelt-modes debugnoline
...
#################@ melt-build-script.tpl:476/405 
function meltbuild_symlink_melt_translator_sources () {


### symlinking the MELT translator code in meltbuild-sources for warmelt-first from melt-build-script.tpl:481/406

meltbuild_info melt-build-script.tpl:483/407 putting MELT translator code of warmelt-first in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-base from melt-build-script.tpl:481/408

meltbuild_info melt-build-script.tpl:483/409 putting MELT translator code of warmelt-base in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-debug from melt-build-script.tpl:481/410

meltbuild_info melt-build-script.tpl:483/411 putting MELT translator code of warmelt-debug in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-macro from melt-build-script.tpl:481/412

meltbuild_info melt-build-script.tpl:483/413 putting MELT translator code of warmelt-macro in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-normal from melt-build-script.tpl:481/414

meltbuild_info melt-build-script.tpl:483/415 putting MELT translator code of warmelt-normal in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-normatch from melt-build-script.tpl:481/416

meltbuild_info melt-build-script.tpl:483/417 putting MELT translator code of warmelt-normatch in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-genobj from melt-build-script.tpl:481/418

meltbuild_info melt-build-script.tpl:483/419 putting MELT translator code of warmelt-genobj in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-outobj from melt-build-script.tpl:481/420

meltbuild_info melt-build-script.tpl:483/421 putting MELT translator code of warmelt-outobj in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-modes from melt-build-script.tpl:481/422

meltbuild_info melt-build-script.tpl:483/423 putting MELT translator code of warmelt-modes in meltbuild-sources
...
if [ ! -f $melt_final_translator_stamp -o $melt_final_translator_stamp -ot $GCCMELT_RUNTIME_DEPENDENCY \
 ...
 -o $melt_final_translator_stamp -ot $GCCMELT_LASTSTAGE/$GCCMELT_LASTSTAGE.stamp ]; then
    meltbuild_info melt-build-script.tpl:498/425 emit then translate the compile translator for  $melt_final_translator_stamp
...
#@  melt-build-script.tpl:506/434 
    ...
    meltbuild_info melt-build-script.tpl:517/435 skip final translation of translator stamp  $melt_final_translator_stamp
fi

################################################################
#@ melt-build-script.tpl:521/436
if [ "$melt_overall_goal" = "translator" ]; then
    meltbuild_info melt-build-script.tpl:523/437 done translation overall goal with stamp  $melt_final_translator_stamp
    exit 0
fi

################
#@ melt-build-script.tpl:528/438 before application xtramelt* modules
################################################################
meltbuild_info melt-build-script.tpl:530/439 before applications GCCMELT_SKIPEMITC=$GCCMELT_SKIPEMITC.

meltbuild_info melt-build-script.tpl:532/440 times before applications at `date '+%x %H:%M:%S'`: ;  times > /dev/stderr
...
function meltbuild_do_applications () {
  ...
  ## meltbuild_do_applications xtramelt-ana-base melt-build-script.tpl:544/442
  if [ ! -f meltbuild-sources/xtramelt-ana-base.c -o  ! -f meltbuild-sources/xtramelt-ana-base+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:550/443 emit application C code for xtramelt-ana-base
      meltbuild_emit melt-build-script.tpl:551/444 \
	  translatefile \
	  xtramelt-ana-base \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:558/445 failed to generate C code of application xtramelt-ana-base
  else
      meltbuild_info melt-build-script.tpl:560/446 DONT emit application C code for xtramelt-ana-base
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-base.meltmod-$meltapp_ANA_BASE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:568/447 compiling application module for xtramelt-ana-base quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/448 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:576/449 in meltbuild-modules failed to compile application xtramelt-ana-base quicklybuilt
  else
      meltbuild_info melt-build-script.tpl:578/450 not compiling application module for xtramelt-ana-base quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-base.meltmod-$meltapp_ANA_BASE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:568/451 compiling application module for xtramelt-ana-base optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/452 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-base \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-base \
	  || meltbuild_error  melt-build-script.tpl:576/453 in meltbuild-modules failed to compile application xtramelt-ana-base optimized
  else
      meltbuild_info melt-build-script.tpl:578/454 not compiling application module for xtramelt-ana-base optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-base.meltmod-$meltapp_ANA_BASE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:568/455 compiling application module for xtramelt-ana-base debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/456 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-base \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-base \
	  || meltbuild_error  melt-build-script.tpl:576/457 in meltbuild-modules failed to compile application xtramelt-ana-base debugnoline
  else
      meltbuild_info melt-build-script.tpl:578/458 not compiling application module for xtramelt-ana-base debugnoline
  fi
  ...
  ## meltbuild_do_applications xtramelt-ana-tree melt-build-script.tpl:544/460
 ...
 -o meltbuild-sources/xtramelt-ana-base+meltdesc.c -ot meltbuild-sources/xtramelt-ana-tree+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:550/461 emit application C code for xtramelt-ana-tree
      meltbuild_emit melt-build-script.tpl:551/462 \
	  translatefile \
	  xtramelt-ana-tree \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:558/463 failed to generate C code of application xtramelt-ana-tree
  else
      meltbuild_info melt-build-script.tpl:560/464 DONT emit application C code for xtramelt-ana-tree
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-tree.meltmod-$meltapp_ANA_TREE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:568/465 compiling application module for xtramelt-ana-tree quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/466 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:576/467 in meltbuild-modules failed to compile application xtramelt-ana-tree quicklybuilt
  else
      meltbuild_info melt-build-script.tpl:578/468 not compiling application module for xtramelt-ana-tree quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-tree.meltmod-$meltapp_ANA_TREE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:568/469 compiling application module for xtramelt-ana-tree optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/470 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-tree \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-tree \
	  || meltbuild_error  melt-build-script.tpl:576/471 in meltbuild-modules failed to compile application xtramelt-ana-tree optimized
  else
      meltbuild_info melt-build-script.tpl:578/472 not compiling application module for xtramelt-ana-tree optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-tree.meltmod-$meltapp_ANA_TREE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:568/473 compiling application module for xtramelt-ana-tree debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/474 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-tree \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-tree \
	  || meltbuild_error  melt-build-script.tpl:576/475 in meltbuild-modules failed to compile application xtramelt-ana-tree debugnoline
  else
      meltbuild_info melt-build-script.tpl:578/476 not compiling application module for xtramelt-ana-tree debugnoline
  fi
  ...
  ## meltbuild_do_applications xtramelt-ana-gimple melt-build-script.tpl:544/478
 ...
 -o meltbuild-sources/xtramelt-ana-tree+meltdesc.c -ot meltbuild-sources/xtramelt-ana-gimple+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:550/479 emit application C code for xtramelt-ana-gimple
      meltbuild_emit melt-build-script.tpl:551/480 \
	  translatefile \
	  xtramelt-ana-gimple \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:558/481 failed to generate C code of application xtramelt-ana-gimple
  else
      meltbuild_info melt-build-script.tpl:560/482 DONT emit application C code for xtramelt-ana-gimple
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-gimple.meltmod-$meltapp_ANA_GIMPLE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:568/483 compiling application module for xtramelt-ana-gimple quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/484 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:576/485 in meltbuild-modules failed to compile application xtramelt-ana-gimple quicklybuilt
  else
      meltbuild_info melt-build-script.tpl:578/486 not compiling application module for xtramelt-ana-gimple quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-gimple.meltmod-$meltapp_ANA_GIMPLE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:568/487 compiling application module for xtramelt-ana-gimple optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/488 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-gimple \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-gimple \
	  || meltbuild_error  melt-build-script.tpl:576/489 in meltbuild-modules failed to compile application xtramelt-ana-gimple optimized
  else
      meltbuild_info melt-build-script.tpl:578/490 not compiling application module for xtramelt-ana-gimple optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-gimple.meltmod-$meltapp_ANA_GIMPLE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:568/491 compiling application module for xtramelt-ana-gimple debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/492 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-gimple \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-gimple \
	  || meltbuild_error  melt-build-script.tpl:576/493 in meltbuild-modules failed to compile application xtramelt-ana-gimple debugnoline
  else
      meltbuild_info melt-build-script.tpl:578/494 not compiling application module for xtramelt-ana-gimple debugnoline
  fi
  ...
  ## meltbuild_do_applications xtramelt-probe melt-build-script.tpl:544/496
 ...
 -o meltbuild-sources/xtramelt-ana-gimple+meltdesc.c -ot meltbuild-sources/xtramelt-probe+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:550/497 emit application C code for xtramelt-probe
      meltbuild_emit melt-build-script.tpl:551/498 \
	  translatefile \
	  xtramelt-probe \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:558/499 failed to generate C code of application xtramelt-probe
  else
      meltbuild_info melt-build-script.tpl:560/500 DONT emit application C code for xtramelt-probe
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltapp_PROBE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:568/501 compiling application module for xtramelt-probe quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/502 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
	  || meltbuild_error  melt-build-script.tpl:576/503 in meltbuild-modules failed to compile application xtramelt-probe quicklybuilt
  else
      meltbuild_info melt-build-script.tpl:578/504 not compiling application module for xtramelt-probe quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltapp_PROBE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:568/505 compiling application module for xtramelt-probe optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/506 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
	  || meltbuild_error  melt-build-script.tpl:576/507 in meltbuild-modules failed to compile application xtramelt-probe optimized
  else
      meltbuild_info melt-build-script.tpl:578/508 not compiling application module for xtramelt-probe optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltapp_PROBE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:568/509 compiling application module for xtramelt-probe debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/510 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
	  || meltbuild_error  melt-build-script.tpl:576/511 in meltbuild-modules failed to compile application xtramelt-probe debugnoline
  else
      meltbuild_info melt-build-script.tpl:578/512 not compiling application module for xtramelt-probe debugnoline
  fi
  ...
  ## meltbuild_do_applications xtramelt-ana-simple melt-build-script.tpl:544/514
 ...
 -o meltbuild-sources/xtramelt-probe+meltdesc.c -ot meltbuild-sources/xtramelt-ana-simple+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:550/515 emit application C code for xtramelt-ana-simple
      meltbuild_emit melt-build-script.tpl:551/516 \
	  translatefile \
	  xtramelt-ana-simple \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:558/517 failed to generate C code of application xtramelt-ana-simple
  else
      meltbuild_info melt-build-script.tpl:560/518 DONT emit application C code for xtramelt-ana-simple
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltapp_ANA_SIMPLE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:568/519 compiling application module for xtramelt-ana-simple quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/520 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:576/521 in meltbuild-modules failed to compile application xtramelt-ana-simple quicklybuilt
  else
      meltbuild_info melt-build-script.tpl:578/522 not compiling application module for xtramelt-ana-simple quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltapp_ANA_SIMPLE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:568/523 compiling application module for xtramelt-ana-simple optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/524 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
	  || meltbuild_error  melt-build-script.tpl:576/525 in meltbuild-modules failed to compile application xtramelt-ana-simple optimized
  else
      meltbuild_info melt-build-script.tpl:578/526 not compiling application module for xtramelt-ana-simple optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltapp_ANA_SIMPLE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:568/527 compiling application module for xtramelt-ana-simple debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/528 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
	  || meltbuild_error  melt-build-script.tpl:576/529 in meltbuild-modules failed to compile application xtramelt-ana-simple debugnoline
  else
      meltbuild_info melt-build-script.tpl:578/530 not compiling application module for xtramelt-ana-simple debugnoline
  fi
  ...
  ## meltbuild_do_applications xtramelt-c-generator melt-build-script.tpl:544/532
 ...
 -o meltbuild-sources/xtramelt-ana-simple+meltdesc.c -ot meltbuild-sources/xtramelt-c-generator+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:550/533 emit application C code for xtramelt-c-generator
      meltbuild_emit melt-build-script.tpl:551/534 \
	  translatefile \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:558/535 failed to generate C code of application xtramelt-c-generator
  else
      meltbuild_info melt-build-script.tpl:560/536 DONT emit application C code for xtramelt-c-generator
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-c-generator.meltmod-$meltapp_C_GENERATOR_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:568/537 compiling application module for xtramelt-c-generator quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/538 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:576/539 in meltbuild-modules failed to compile application xtramelt-c-generator quicklybuilt
  else
      meltbuild_info melt-build-script.tpl:578/540 not compiling application module for xtramelt-c-generator quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-c-generator.meltmod-$meltapp_C_GENERATOR_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:568/541 compiling application module for xtramelt-c-generator optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/542 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-c-generator \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-c-generator \
	  || meltbuild_error  melt-build-script.tpl:576/543 in meltbuild-modules failed to compile application xtramelt-c-generator optimized
  else
      meltbuild_info melt-build-script.tpl:578/544 not compiling application module for xtramelt-c-generator optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-c-generator.meltmod-$meltapp_C_GENERATOR_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:568/545 compiling application module for xtramelt-c-generator debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/546 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-c-generator \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-c-generator \
	  || meltbuild_error  melt-build-script.tpl:576/547 in meltbuild-modules failed to compile application xtramelt-c-generator debugnoline
  else
      meltbuild_info melt-build-script.tpl:578/548 not compiling application module for xtramelt-c-generator debugnoline
  fi
  ...
  ## meltbuild_do_applications xtramelt-opengpu melt-build-script.tpl:544/550
 ...
 -o meltbuild-sources/xtramelt-c-generator+meltdesc.c -ot meltbuild-sources/xtramelt-opengpu+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:550/551 emit application C code for xtramelt-opengpu
      meltbuild_emit melt-build-script.tpl:551/552 \
	  translatefile \
	  xtramelt-opengpu \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:558/553 failed to generate C code of application xtramelt-opengpu
  else
      meltbuild_info melt-build-script.tpl:560/554 DONT emit application C code for xtramelt-opengpu
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-opengpu.meltmod-$meltapp_OPENGPU_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:568/555 compiling application module for xtramelt-opengpu quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/556 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-opengpu \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-opengpu \
	  || meltbuild_error  melt-build-script.tpl:576/557 in meltbuild-modules failed to compile application xtramelt-opengpu quicklybuilt
  else
      meltbuild_info melt-build-script.tpl:578/558 not compiling application module for xtramelt-opengpu quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-opengpu.meltmod-$meltapp_OPENGPU_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:568/559 compiling application module for xtramelt-opengpu optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/560 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-opengpu \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-opengpu \
	  || meltbuild_error  melt-build-script.tpl:576/561 in meltbuild-modules failed to compile application xtramelt-opengpu optimized
  else
      meltbuild_info melt-build-script.tpl:578/562 not compiling application module for xtramelt-opengpu optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-opengpu.meltmod-$meltapp_OPENGPU_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:568/563 compiling application module for xtramelt-opengpu debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:570/564 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-opengpu \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-opengpu \
	  || meltbuild_error  melt-build-script.tpl:576/565 in meltbuild-modules failed to compile application xtramelt-opengpu debugnoline
  else
      meltbuild_info melt-build-script.tpl:578/566 not compiling application module for xtramelt-opengpu debugnoline
  fi
 

  ## meltbuild_do_applications  melt-build-script.tpl:582/567
...
meltbuild_info melt-build-script.tpl:595/568 times after applications at `date '+%x %H:%M:%S'`: ;  times > /dev/stderr
} ## end meltbuild_do_applications  melt-build-script.tpl:596/569
...
if [ ! -f  "$melt_final_application_stamp" \
 ...
 -o "$melt_final_application_stamp" -ot "$GCCMELT_MELTSOURCEDIR/xtramelt-opengpu.melt" \
    ...
    meltbuild_info melt-build-script.tpl:602/570 building MELT applications
    meltbuild_do_applications
else
    meltbuild_info melt-build-script.tpl:605/571 not building MELT applications because of applstamp  "$melt_final_application_stamp"
fi

################################################################
#@ melt-build-script.tpl:609/572
if [ "$melt_overall_goal" = "applications" ]; then
    meltbuild_info melt-build-script.tpl:611/573 done applications overall goal with stamp  $melt_final_translator_stamp
    exit 0
fi
################################################################
################################################################
### the modules lists melt-build-script.tpl:616/574
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis" \
  ...
  #  melt-build-script.tpl:621/575 module list quicklybuilt
  meltbuild_info  melt-build-script.tpl:622/576 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis"
  ...
  meltbuild_info  melt-build-script.tpl:636/578 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis" \
  ...
  #  melt-build-script.tpl:621/579 module list optimized
  meltbuild_info  melt-build-script.tpl:622/580 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"
  ...
  meltbuild_info  melt-build-script.tpl:636/582 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis" \
  ...
  #  melt-build-script.tpl:621/583 module list debugnoline
  meltbuild_info  melt-build-script.tpl:622/584 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"
  ...
  meltbuild_info  melt-build-script.tpl:636/586 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"  
fi


#@ melt-build-script.tpl:640/587
...
################################################################
#@ melt-build-script.tpl:646/588
if [ "$melt_overall_goal" = "modlists" ]; then
    meltbuild_info melt-build-script.tpl:648/589 done modlists overall goal with stamp  $melt_final_translator_stamp
    exit 0
fi
################################################################
################################################################
#@ melt-build-script.tpl:653/590
if [ "$melt_overall_goal" = "regenerate" ]; then
    meltbuild_info melt-build-script.tpl:655/591 regenerating runtime support
    ...
    echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:659/592"' > $meltregen_argstemp
   ...
   meltbuild_info melt-build-script.tpl:669/593 $meltregen_args  is
   cat $meltregen_args > /dev/stderr
    $GCCMELT_CC1_PREFIX $GCCMELT_CC1 @$meltregen_args \
	|| meltbuild_error melt-build-script.tpl:672/594 failed with arguments @$meltregen_args
    meltbuild_info melt-build-script.tpl:673/595 done regeerate overall goal
    exit 0
fi

################################################################
### the generated documentation meltgendoc.texi melt-build-script.tpl:678/596
...
if [   ! -f meltgendoc.texi  -o meltbuild-sources/warmelt-first.melt -nt meltgendoc.texi  \
 ...
 -o meltbuild-sources/xtramelt-opengpu.melt -nt meltgendoc.texi   ]; then
   meltbuild_info melt-build-script.tpl:682/597 generating meltgendoc.texi
   meltgen_args=meltbuild-gendoc.args-tmp$$
   echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:684/598"' > $meltgen_args
   ...
   meltbuild_info melt-build-script.tpl:696/599  meltbuild-gendoc.args is
   cat meltbuild-gendoc.args > /dev/stderr
   $GCCMELT_CC1_PREFIX $GCCMELT_CC1 @meltbuild-gendoc.args \
     || meltbuild_error melt-build-script.tpl:699/600 failed with arguments @meltbuild-gendoc.args
else
   meltbuild_info melt-build-script.tpl:701/601 keeping meltgendoc.texi
fi

################
meltbuild_info melt-build-script.tpl:705/602 successfully done with times at `date '+%x %H:%M:%S'`: ; times > /dev/stderr

################################################################
#@ melt-build-script.tpl:708/603
if [ "$melt_overall_goal" = "gendoc" ]; then
    meltbuild_info melt-build-script.tpl:710/604 done gendoc overall goal with stamp  $melt_final_translator_stamp
    exit 0
fi

## #@ melt-build-script.tpl:714/605 if we get here something is wrong in this script
meltbuild_error  melt-build-script.tpl:715/606 unexpected MELT overall goal "$melt_overall_goal" buggy melt-build-script.tpl
#@ eof melt-build-script.tpl:716/607 end of generated melt-build-script.sh
