...
#@#@# 
#@#@# It has been AutoGen-ed  September 11, 2012 at 08:59:41 AM by AutoGen 5.12
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis" \
  ...
  #  melt-build-script.tpl:646/579 warmelt module list quicklybuilt
  ...
  meltbuild_info  melt-build-script.tpl:654/580 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis" \
  ...
  #  melt-build-script.tpl:632/581 module list optimized
  meltbuild_info  melt-build-script.tpl:633/582 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"
  ...
  #  melt-build-script.tpl:646/584 warmelt module list optimized
  ...
  meltbuild_info  melt-build-script.tpl:654/585 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis" \
  ...
  #  melt-build-script.tpl:632/586 module list debugnoline
  meltbuild_info  melt-build-script.tpl:633/587 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"
  ...
  #  melt-build-script.tpl:646/589 warmelt module list debugnoline
  ...
  meltbuild_info  melt-build-script.tpl:654/590 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"  
fi


#@ melt-build-script.tpl:658/591
...
################################################################
#@ melt-build-script.tpl:664/592 module lists
if [ "$melt_overall_goal" = "modlists" ]; then
    meltbuild_info melt-build-script.tpl:666/593 done modlists overall goal with stamp  $melt_final_application_stamp
    exit 0
fi


################################################################
#@ melt-build-script.tpl:672/594 runtime self check

##  melt-build-script.tpl:674/595 FIXME: should skip that when cross-compiler MELT plugin..
...
if [ ! -f $meltcheckruntime_stamp -o $meltcheckruntime_stamp -ot "$GCCMELT_RUNTIME_ARGS" \
    ...
    #@ melt-build-script.tpl:680/596 checkruntime
    if [ -f melt-no-check-runtime -o -n "$MELTGCC_NO_CHECK_RUNTIME" -o ! -f melt-runtime.i ]; then
	meltbuild_info melt-build-script.tpl:682/597 skipping check of MELT runtime
    else
	meltcheckruntime_args=meltbuild-checkruntime.args 
	meltcheckruntime_argstemp=$meltcheckruntime_args-tmp$$
	echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:686/598"' > $meltcheckruntime_argstemp
	...
	[ -f "$meltcheckruntime_args" ] || meltbuild_error  melt-build-script.tpl:697/599 missing check runtime args  "$meltcheckruntime_args"
	meltbuild_info melt-build-script.tpl:698/600 $meltcheckruntime_args  is
	...
	if [ -n "$MELTGCCBUILTIN_BUILD_WITH_CXX" ]; then
		...
		|| meltbuild_error melt-build-script.tpl:702/601 failed  $GCCMELT_CC1PLUS with arguments @$meltcheckruntime_args
	else
	    $GCCMELT_CC1_PREFIX $GCCMELT_CC1 @$meltcheckruntime_args \
		|| meltbuild_error melt-build-script.tpl:705/602 failed  $GCCMELT_CC1 with arguments @$meltcheckruntime_args
	fi
	meltbuild_info melt-build-script.tpl:707/603 done check runtime with $meltcheckruntime_args
    fi

   #@ melt-build-script.tpl:710/604 checkhello
    meltcheckhelloworld_args=meltbuild-checkhelloworld.args 
    meltcheckhelloworld_argstemp=$meltcheckhelloworld_args-tmp$$
    echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:713/605"' > $meltcheckhelloworld_argstemp
    ...
    [ -f "$meltcheckhelloworld_args" ] || meltbuild_error  melt-build-script.tpl:727/606 missing check helloworld args  "$meltcheckhelloworld_args"
   meltbuild_info melt-build-script.tpl:728/607 $meltcheckhelloworld_args  is
   cat $meltcheckhelloworld_args < /dev/null > /dev/stderr
    $GCCMELT_CC1_PREFIX $GCCMELT_CC1 @$meltcheckhelloworld_args \
	|| meltbuild_error melt-build-script.tpl:731/608 running helloworld failed with arguments @$meltcheckhelloworld_args
   meltbuild_info melt-build-script.tpl:732/609 done check helloworld with $meltcheckhelloworld_args
   #@ melt-build-script.tpl:733/610 runtime stamp
    meltcheckruntime_stamptemp=$meltcheckruntime_stamp-tmp$$
    [ -f "$GCCMELT_RUNTIME_C" ] || meltbuild_error melt-build-script.tpl:735/611 missing MELT runtime C file $GCCMELT_RUNTIME_C
    ...
    [ -f "$melt_final_translator_stamp" ] || meltbuild_error melt-build-script.tpl:740/612 missing final translator stamp "$melt_final_translator_stamp"
    [ -f "$melt_final_application_stamp" ] || meltbuild_error melt-build-script.tpl:741/613 missing final application stamp "$melt_final_application_stamp"
    ...
    meltbuild_info melt-build-script.tpl:745/614 done check runtime  $meltcheckruntime_stamp
else
    meltbuild_info melt-build-script.tpl:747/615 keeping runtime checks  $meltcheckruntime_stamp
fi

if [ "$melt_overall_goal" = "checkruntime" ]; then
    meltbuild_info melt-build-script.tpl:751/616 done checkruntime overall goal with stamp  $meltcheckruntime_stamp
    exit 0
fi
################################################################
################################################################
#@ melt-build-script.tpl:756/617
if [ "$melt_overall_goal" = "regenerate" ]; then
    meltbuild_info melt-build-script.tpl:758/618 regenerating runtime support
    ...
    echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:762/619"' > $meltregen_argstemp
   ...
   meltbuild_info melt-build-script.tpl:772/620 $meltregen_args  is
   cat $meltregen_args < /dev/null > /dev/stderr
    $GCCMELT_CC1_PREFIX $GCCMELT_CC1 @$meltregen_args \
	|| meltbuild_error melt-build-script.tpl:775/621 failed with arguments @$meltregen_args
    meltbuild_info melt-build-script.tpl:776/622 done regenerate overall goal
    exit 0
fi

################################################################
### the generated documentation meltgendoc.texi melt-build-script.tpl:781/623
...
if [   ! -f meltgendoc.texi  -o meltbuild-sources/warmelt-first.melt -nt meltgendoc.texi  \
 ...
 -o meltbuild-sources/xtramelt-opengpu.melt -nt meltgendoc.texi   ]; then
   meltbuild_info melt-build-script.tpl:785/624 generating meltgendoc.texi
   meltgen_args=meltbuild-gendoc.args-tmp$$
   echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:787/625"' > $meltgen_args
   ...
   meltbuild_info melt-build-script.tpl:799/626  meltbuild-gendoc.args is
   cat meltbuild-gendoc.args < /dev/null > /dev/stderr
   $GCCMELT_CC1_PREFIX $GCCMELT_CC1 @meltbuild-gendoc.args \
     || meltbuild_error melt-build-script.tpl:802/627 failed with arguments @meltbuild-gendoc.args
else
   meltbuild_info melt-build-script.tpl:804/628 keeping meltgendoc.texi
fi

################
meltbuild_info melt-build-script.tpl:808/629 successfully done with times at `date '+%x %H:%M:%S'`: ; times > /dev/stderr

################################################################
#@ melt-build-script.tpl:811/630
if [ "$melt_overall_goal" = "gendoc" ]; then
    meltbuild_info melt-build-script.tpl:813/631 done gendoc overall goal with stamp  $melt_final_translator_stamp
    exit 0
fi

## #@ melt-build-script.tpl:817/632 if we get here something is wrong in this script
meltbuild_error  melt-build-script.tpl:818/633 unexpected MELT overall goal "$melt_overall_goal" buggy melt-build-script.tpl
#@ eof melt-build-script.tpl:819/634 end of generated melt-build-script.sh
