...
/* Temporarily rename start_module_melt as melt_start_module; should
   disappear as soon as all generated C files talk of
   melt_start_module. */
#define start_module_melt melt_start_this_module
