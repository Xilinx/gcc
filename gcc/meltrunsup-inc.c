...
#define boxv meltfram__.mcfr_varptr[0]
 boxv = box_p;
 if (melt_magic_discr((melt_ptr_t)boxv) != meltgc_new_basicblock) goto end;
...
#define boxv meltfram__.mcfr_varptr[0]
 boxv = box_p;
 if (melt_magic_discr((melt_ptr_t)boxv) != meltgc_new_bitmap) goto end;
...
#define boxv meltfram__.mcfr_varptr[0]
 boxv = box_p;
 if (melt_magic_discr((melt_ptr_t)boxv) != meltgc_new_edge) goto end;
...
#define boxv meltfram__.mcfr_varptr[0]
 boxv = box_p;
 if (melt_magic_discr((melt_ptr_t)boxv) != meltgc_new_gimple) goto end;
...
#define boxv meltfram__.mcfr_varptr[0]
 boxv = box_p;
 if (melt_magic_discr((melt_ptr_t)boxv) != meltgc_new_gimpleseq) goto end;
...
#define boxv meltfram__.mcfr_varptr[0]
 boxv = box_p;
 if (melt_magic_discr((melt_ptr_t)boxv) != meltgc_new_loop) goto end;
...
#define boxv meltfram__.mcfr_varptr[0]
 boxv = box_p;
 if (melt_magic_discr((melt_ptr_t)boxv) != meltgc_new_rtvec) goto end;
...
#define boxv meltfram__.mcfr_varptr[0]
 boxv = box_p;
 if (melt_magic_discr((melt_ptr_t)boxv) != meltgc_new_rtx) goto end;
...
#define boxv meltfram__.mcfr_varptr[0]
 boxv = box_p;
 if (melt_magic_discr((melt_ptr_t)boxv) != meltgc_new_tree) goto end;
...
/*** End of code file meltrunsup-inc.c generated on 2011 Feb 09
