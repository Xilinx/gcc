...
(define_insn_and_split "*call_1_rex64_vzeroupper"
  [(call (mem:QI (match_operand:W 0 "call_insn_operand" "rzw"))
	 (match_operand 1 "" ""))
   (unspec [(match_operand 2 "const_int_operand" "")]
   	   UNSPEC_CALL_NEEDS_VZEROUPPER)]
  "TARGET_VZEROUPPER && TARGET_64BIT && !SIBLING_CALL_P (insn)
...
(define_insn_and_split "*sibcall_1_rex64_vzeroupper"
  [(call (mem:QI (match_operand:W 0 "sibcall_insn_operand" "z,U"))
	 (match_operand 1 "" ""))
   (unspec [(match_operand 2 "const_int_operand" "")]
   	   UNSPEC_CALL_NEEDS_VZEROUPPER)]
  "TARGET_VZEROUPPER && TARGET_64BIT && SIBLING_CALL_P (insn)"
...
(define_insn_and_split "*call_value_1_rex64_vzeroupper"
  [(set (match_operand 0 "" "")
	(call (mem:QI (match_operand:W 1 "call_insn_operand" "rzw"))
	      (match_operand:P 2 "" "")))
   (unspec [(match_operand 3 "const_int_operand" "")]
   	   UNSPEC_CALL_NEEDS_VZEROUPPER)]
  "TARGET_VZEROUPPER && TARGET_64BIT && !SIBLING_CALL_P (insn)
...
(define_insn_and_split "*sibcall_value_1_rex64_vzeroupper"
  [(set (match_operand 0 "" "")
	(call (mem:QI (match_operand:W 1 "sibcall_insn_operand" "z,U"))
	      (match_operand:DI 2 "" "")))
   (unspec [(match_operand 3 "const_int_operand" "")]
   	   UNSPEC_CALL_NEEDS_VZEROUPPER)]
  "TARGET_VZEROUPPER && TARGET_64BIT && SIBLING_CALL_P (insn)"
