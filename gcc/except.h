...
extern struct eh_region_d *gen_eh_region_transaction (struct eh_region_d *,
						      gimple);
extern int get_eh_region_number (struct eh_region_d *);
extern bool get_eh_region_may_contain_throw (struct eh_region_d *);
extern struct eh_region_d *get_eh_region_from_number (int);
...
extern rtx get_eh_region_rtl_label (struct eh_region_d *);

typedef void (*eh_callback) (struct eh_region_d *, void *);
extern void foreach_reachable_handler (int, bool, bool, eh_callback, void *);
