...
static tree
build_op_call_1 (tree obj, vec<tree, va_gc> **args, enum call_context spawning, 
		 tsubst_flags_t complain)
{
...
tree
build_op_call (tree obj, vec<tree, va_gc> **args, enum call_context spawning, 
	       tsubst_flags_t complain)
{
  tree ret;
  bool subtime = timevar_cond_start (TV_OVERLOAD);
		 ...
		 enum call_context spawning,  tsubst_flags_t complain)
{
  ...
  return build_cxx_call (fn, spawning, nargs, argarray, complain|decltype_flag);
}
