...
/* macro, called in the beginning of the generated module start
   function, to set the initial frame of a module; the
   initial_frame_melt is a module variable. */
#define MELT_SET_MODULE_INITIAL_FRAME(Fr) do {			\
  initial_frame_melt = (void*)&Fr;				\
  dbgprintf ("MELT_SET_MODULE_INITIAL_FRAME frame @%p to %p",	\
	    &initial_frame_melt, initial_frame_melt);		\
} while(0)

/* macro, called at the end of the generated module start
       function, to clear the initial frame of a module */
#define MELT_CLEAR_MODULE_INITIAL_FRAME() do {			\
  initial_frame_melt = NULL;					\
  dbgprintf ("MELT_CLEAR_MODULE_INITIAL_FRAME frame @%p",	\
	     &initial_frame_melt);				\
} while(0)
