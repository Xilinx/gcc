...
{
  long
    current_blocklevel_signals_meltrout_78_warmelt_modes_UNREGISTER_ALARM_TIMER_melt
...
#define meltcallcount 0L
  ...
  struct frame_meltrout_78_warmelt_modes_UNREGISTER_ALARM_TIMER_st
  {
    int mcfr_nbvar;
#if MELT_HAVE_DEBUG
...
#define meltframe meltfram__
  /*meltrout_78_warmelt_modes_UNREGISTER_ALARM_TIMER is not initial declstructinit */
...
/* declstructinit plain routine meltrout_78_warmelt_modes_UNREGISTER_ALARM_TIMER nbval 26*/
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-modes.melt:4474:/ getarg");
...
/*anyblock*/
  {
   ...
   /*_#MELT_NEED_DBG__L1*/ meltfnum[0] =
      ...
      /*cond */ if ( /*_#MELT_NEED_DBG__L1*/ meltfnum[0])	/*then */
	{
     ...
     /*_#THE_MELTCALLCOUNT__L2*/ meltfnum[1] =
	      ...
	      ;;
	    MELT_LOCATION ("warmelt-modes.melt:4476:/ checksignal");
	    MELT_CHECK_SIGNAL ();
	    ;
	    /*^apply */
	    /*apply */
...
#endif /*MELT_HAVE_DEBUG */
    ;
    MELT_LOCATION ("warmelt-modes.melt:4477:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^cond */
	...
	/*_.IFELSE___V7*/ meltfptr[3] = ( /*nil */ NULL);;
      ...
      {
	MELT_LOCATION ("warmelt-modes.melt:4477:/ cond.else");
   ...
   /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
    ...
    ;
    MELT_LOCATION ("warmelt-modes.melt:4478:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
  ...
  /*_.NEWBUCK__V16*/ meltfptr[11] =
	(meltgc_new_longsbucket
	 ((meltobject_ptr_t) ( /*!DISCR_BUCKET_LONGS */ meltfrout->tabval[4]),
	  ( /*_#OLDBUCKLEN__L5*/ meltfnum[0])));;
      MELT_LOCATION ("warmelt-modes.melt:4487:/ checksignal");
      MELT_CHECK_SIGNAL ();
      ;
      /*^cond */
	...
	{
	  MELT_LOCATION ("warmelt-modes.melt:4487:/ cond.else");

	  /*^block */
	  /*anyblock */
	  {

	    MELT_LOCATION ("warmelt-modes.melt:4489:/ checksignal");
	    MELT_CHECK_SIGNAL ();
	    ;
	    /*^cond */
	    /*cond */ if (
	    ...
	    {
	      MELT_LOCATION ("warmelt-modes.melt:4490:/ locexp");
	      melt_set_real_timer_millisec (0);
	    }
	    ;
	    MELT_LOCATION ("warmelt-modes.melt:4491:/ checksignal");
	    MELT_CHECK_SIGNAL ();
	    ;
	    /*^cond */
	    /*cond */ if (
...
#endif /*MELT_HAVE_DEBUG */
	    ;
	    MELT_LOCATION ("warmelt-modes.melt:4498:/ checksignal");
	    MELT_CHECK_SIGNAL ();
	    ;
   /*_#__L8*/ meltfnum[6] =
	      (( /*_.OLDALA__V20*/ meltfptr[17]) ==
     ...
     /*_.BUCKETLONG_PUT__V24*/ meltfptr[23] =
		    meltgc_longsbucket_put ((melt_ptr_t) /*_.NEWBUCK__V16*/
					    ...
					    meltfptr[17]);;
		  MELT_LOCATION ("warmelt-modes.melt:4499:/ compute");
		  /*_.NEWBUCK__V16*/ meltfptr[11] =
	...
	/*^clear */
      ...
      ;
      MELT_LOCATION ("warmelt-modes.melt:4501:/ checksignal");
      MELT_CHECK_SIGNAL ();
      ;
      /*^cond */
      /*cond */ if (
    ...
    ;
    MELT_LOCATION ("warmelt-modes.melt:4474:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*epilog */
...
#undef MELTFRAM_NBVARNUM
#undef MELTFRAM_NBVARPTR
}				/*end meltrout_78_warmelt_modes_UNREGISTER_ALARM_TIMER */
...
{
  long
    current_blocklevel_signals_meltrout_79_warmelt_modes_CHILD_PROCESS_SIGCHLD_HANDLER_melt
    = melt_blocklevel_signals;
...
#define meltcallcount 0L
  ...
  struct frame_meltrout_79_warmelt_modes_CHILD_PROCESS_SIGCHLD_HANDLER_st
  {
    int mcfr_nbvar;
#if MELT_HAVE_DEBUG
    const char *mcfr_flocs;
...
/*others*/
   ...
   *meltframptr_ = 0, meltfram__;	/*declfrastruct */
#define meltframe meltfram__
  /*meltrout_79_warmelt_modes_CHILD_PROCESS_SIGCHLD_HANDLER is not initial declstructinit */
  if (MELT_UNLIKELY (meltxargdescr_ == MELTPAR_MARKGGC))
    {				/*mark for ggc */
      int ix = 0;
      meltframptr_ =
	(struct
	 frame_meltrout_79_warmelt_modes_CHILD_PROCESS_SIGCHLD_HANDLER_st *)
	meltfirstargp_;
      /* use arguments output_curframe_declstruct_init */
      (void) meltclosp_;
      (void) meltfirstargp_;
  ...
  memset (&meltfram__, 0, sizeof (meltfram__));
/* declstructinit plain routine meltrout_79_warmelt_modes_CHILD_PROCESS_SIGCHLD_HANDLER nbval 63*/
...
lab_endgetargs:;
/*body*/
  MELT_LOCATION ("warmelt-modes.melt:4509:/ block");
/*anyblock*/
  {
 ...
 /*_.LISWSTAT__V7*/ meltfptr[3] =
  ...
  /*_.BUCK__V8*/ meltfptr[7] = NULL;;
    ...
    ;
    MELT_LOCATION ("warmelt-modes.melt:4515:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
 /*_#IS_BUCKETLONG__L3*/ meltfnum[1] =
...
#endif /* meltcallcount the_meltcallcount */
		      ;;
		    MELT_LOCATION ("warmelt-modes.melt:4527:/ checksignal");
		    MELT_CHECK_SIGNAL ();
		    ;
		    /*^apply */
		    /*apply */
  ...
  /*_.CHPH__V19*/ meltfptr[10] = NULL;
	for (meltcit2__EACHBUCKLONG_ix = 0;
	 ...
	 /*_#PIDSTAT__L5*/ meltfnum[4] = 0L;
	   ...
	   /*_#PIDSTAT__L5*/ meltfnum[4] = pstatus;
	    ...
	    ;
	    MELT_LOCATION ("warmelt-modes.melt:4547:/ checksignal");
	    MELT_CHECK_SIGNAL ();
	    ;
	    /*^cond */
	    /*cond */ if ( /*_#WAITFAIL__L4*/ meltfnum[0])	/*then */
    ...
    ;
    MELT_LOCATION ("warmelt-modes.melt:4554:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^apply */
    /*apply */
  ...
  /*_#TERMSIG__L18*/ meltfnum[17] = 0;;
   ...
   /*_.BUCKETLONG_REMOVE__V40*/ meltfptr[36] =
	      meltgc_longsbucket_remove ((melt_ptr_t) /*_.CBUCK__V39*/
					 meltfptr[35],
					 ( /*_#CURPID__L14*/ meltfnum[0]));;
	    MELT_LOCATION ("warmelt-modes.melt:4574:/ compute");
	    /*_.CBUCK__V39*/ meltfptr[35] = /*_.SETQ___V41*/ meltfptr[40] =
	      /*_.BUCKETLONG_REMOVE__V40*/ meltfptr[36];;
	    MELT_LOCATION ("warmelt-modes.melt:4575:/ checksignal");
	    MELT_CHECK_SIGNAL ();
	    ;
	    /*^cond */
	    /*cond */ if (
	  ...
	  ;
	  MELT_LOCATION ("warmelt-modes.melt:4595:/ checksignal");
	  MELT_CHECK_SIGNAL ();
	  ;
	  /*^cond */
	  /*cond */ if ( /*_#EXITED__L15*/ meltfnum[4])	/*then */
		...
		MELT_LOCATION ("warmelt-modes.melt:4597:/ checksignal");
		MELT_CHECK_SIGNAL ();
		;
	...
	/*_#MELT_NEED_DBG__L22*/ meltfnum[18] =
	  ...
	  /*_#THE_MELTCALLCOUNT__L23*/ meltfnum[22] =
				...
				;;
			      MELT_LOCATION
				("warmelt-modes.melt:4599:/ checksignal");
			      MELT_CHECK_SIGNAL ();
			      ;
			      /*^apply */
			      /*apply */
	 ...
	 /*_.IF___V45*/ meltfptr[44] = NULL;;
			...
			;
			MELT_LOCATION
			  ("warmelt-modes.melt:4599:/ quasiblock");
...
#endif /*MELT_HAVE_DEBUG */
		      ;
		      MELT_LOCATION ("warmelt-modes.melt:4601:/ checksignal");
		      MELT_CHECK_SIGNAL ();
		      ;
		      /*^apply */
		      /*apply */
	...
	/*_#MELT_NEED_DBG__L24*/ meltfnum[22] =
	  ...
	  /*_#THE_MELTCALLCOUNT__L25*/ meltfnum[18] =
				...
				;;
			      MELT_LOCATION
				("warmelt-modes.melt:4605:/ checksignal");
			      MELT_CHECK_SIGNAL ();
			      ;
			      /*^apply */
			      /*apply */
	 ...
	 /*_.IF___V51*/ meltfptr[44] = NULL;;
			...
			;
			MELT_LOCATION
			  ("warmelt-modes.melt:4605:/ quasiblock");
      ...
      /*_.MAKE_INTEGERBOX__V54*/ meltfptr[44] =
			(meltgc_new_int
			 ((meltobject_ptr_t)
			  (( /*!DISCR_CONSTANT_INTEGER */ meltfrout->
			    tabval[5])),
			  ( /*_#EXITSTAT__L16*/ meltfnum[15])));;
		      MELT_LOCATION ("warmelt-modes.melt:4607:/ checksignal");
		      MELT_CHECK_SIGNAL ();
		      ;
		      /*^apply */
		      /*apply */
		...
		MELT_LOCATION ("warmelt-modes.melt:4611:/ checksignal");
		MELT_CHECK_SIGNAL ();
		;
		/*^cond */
	...
	/*_#MELT_NEED_DBG__L26*/ meltfnum[18] =
	  ...
	  /*_#THE_MELTCALLCOUNT__L27*/ meltfnum[22] =
				...
				;;
			      MELT_LOCATION
				("warmelt-modes.melt:4612:/ checksignal");
			      MELT_CHECK_SIGNAL ();
			      ;
			      /*^apply */
			      /*apply */
	 ...
	 /*_.IF___V59*/ meltfptr[45] = NULL;;
			...
			;
			MELT_LOCATION
			  ("warmelt-modes.melt:4612:/ quasiblock");
...
#endif /*MELT_HAVE_DEBUG */
		      ;
		      MELT_LOCATION ("warmelt-modes.melt:4614:/ checksignal");
		      MELT_CHECK_SIGNAL ();
		      ;
		      /*^apply */
		      /*apply */
    ...
    MELT_LOCATION ("warmelt-modes.melt:4509:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*epilog */
...
#undef MELTFRAM_NBVARNUM
#undef MELTFRAM_NBVARPTR
}				/*end meltrout_79_warmelt_modes_CHILD_PROCESS_SIGCHLD_HANDLER */
...
{
  long
    current_blocklevel_signals_meltrout_80_warmelt_modes_REGISTER_CHILD_PROCESS_HANDLER_melt
    = melt_blocklevel_signals;
...
#define meltcallcount 0L
  ...
  struct frame_meltrout_80_warmelt_modes_REGISTER_CHILD_PROCESS_HANDLER_st
  {
    int mcfr_nbvar;
#if MELT_HAVE_DEBUG
    const char *mcfr_flocs;
...
/*others*/
   ...
   *meltframptr_ = 0, meltfram__;	/*declfrastruct */
#define meltframe meltfram__
  /*meltrout_80_warmelt_modes_REGISTER_CHILD_PROCESS_HANDLER is not initial declstructinit */
  if (MELT_UNLIKELY (meltxargdescr_ == MELTPAR_MARKGGC))
    {				/*mark for ggc */
      int ix = 0;
      meltframptr_ =
	(struct
	 frame_meltrout_80_warmelt_modes_REGISTER_CHILD_PROCESS_HANDLER_st *)
	meltfirstargp_;
      /* use arguments output_curframe_declstruct_init */
      (void) meltclosp_;
      (void) meltfirstargp_;
  ...
  memset (&meltfram__, 0, sizeof (meltfram__));
/* declstructinit plain routine meltrout_80_warmelt_modes_REGISTER_CHILD_PROCESS_HANDLER nbval 32*/
...
/*anyblock*/
...
#endif /*MELT_HAVE_DEBUG */
	;;
      MELT_LOCATION ("warmelt-modes.melt:4621:/ cond");
...
#endif /* meltcallcount the_meltcallcount */
	      ;;
	    MELT_LOCATION ("warmelt-modes.melt:4621:/ checksignal");
	    MELT_CHECK_SIGNAL ();
	    ;
	    /*^apply */
	    /*apply */
...
#endif /*MELT_HAVE_DEBUG */
    ;
    MELT_LOCATION ("warmelt-modes.melt:4622:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
 /*_#IS_CLOSURE__L4*/ meltfnum[2] =
	...
	/*anyblock */
	{
	  ...
	  MELT_LOCATION ("warmelt-modes.melt:4623:/ checksignal");
	  MELT_CHECK_SIGNAL ();
	  ;
   /*_#I__L5*/ meltfnum[1] =
	 ...
	 /*_#THE_MELTCALLCOUNT__L8*/ meltfnum[7] =
			  ...
			  ;;
			MELT_LOCATION
			  ("warmelt-modes.melt:4632:/ checksignal");
			MELT_CHECK_SIGNAL ();
			;
			/*^apply */
			/*apply */
	...
	/*_.IF___V12*/ meltfptr[11] = NULL;;
...
#endif /*MELT_HAVE_DEBUG */
		;
		MELT_LOCATION ("warmelt-modes.melt:4633:/ checksignal");
		MELT_CHECK_SIGNAL ();
		;
		/*^cond */
	 ...
	 /*_#THE_MELTCALLCOUNT__L10*/ meltfnum[6] =
			  ...
			  ;;
			MELT_LOCATION
			  ("warmelt-modes.melt:4640:/ checksignal");
			MELT_CHECK_SIGNAL ();
			;
			/*^apply */
			/*apply */
	...
	/*_#IS_BUCKETLONG__L11*/ meltfnum[6] =
      ...
      /*_.BUCKETLONG_PUT__V30*/ meltfptr[28] =
		    meltgc_longsbucket_put ((melt_ptr_t) /*_.BUCK__V26*/
					    ...
					    (melt_ptr_t) /*_.CHPH__V19*/
					    meltfptr[18]);;
		  MELT_LOCATION ("warmelt-modes.melt:4647:/ compute");
		  /*_.BUCK__V26*/ meltfptr[22] =
		    /*_.SETQ___V31*/ meltfptr[30] =
		    /*_.BUCKETLONG_PUT__V30*/ meltfptr[28];;
		  MELT_LOCATION ("warmelt-modes.melt:4648:/ checksignal");
		  MELT_CHECK_SIGNAL ();
		  ;
		  /*^cond */
		  /*cond */ if (
		...
		/*clear *//*_.SETQ___V31*/ meltfptr[30] = 0;
		  MELT_LOCATION ("warmelt-modes.melt:4650:/ checksignal");
		  MELT_CHECK_SIGNAL ();
		  ;
		  /*^cond */
		  /*cond */ if (
		...
		;
		MELT_LOCATION ("warmelt-modes.melt:4653:/ checksignal");
		MELT_CHECK_SIGNAL ();
		;
		/*^quasiblock */
  ...
  /*_.IF___V8*/ meltfptr[4] = NULL;;
    ...
    ;
    MELT_LOCATION ("warmelt-modes.melt:4617:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^quasiblock */
...
#undef MELTFRAM_NBVARNUM
#undef MELTFRAM_NBVARPTR
}				/*end meltrout_80_warmelt_modes_REGISTER_CHILD_PROCESS_HANDLER */
...
{
  long
    current_blocklevel_signals_meltrout_81_warmelt_modes_UNREGISTER_CHILD_PROCESS_HANDLER_melt
    = melt_blocklevel_signals;
...
#define meltcallcount 0L
  ...
  struct frame_meltrout_81_warmelt_modes_UNREGISTER_CHILD_PROCESS_HANDLER_st
  {
    int mcfr_nbvar;
#if MELT_HAVE_DEBUG
    const char *mcfr_flocs;
...
/*others*/
   ...
   *meltframptr_ = 0, meltfram__;	/*declfrastruct */
#define meltframe meltfram__
  /*meltrout_81_warmelt_modes_UNREGISTER_CHILD_PROCESS_HANDLER is not initial declstructinit */
  if (MELT_UNLIKELY (meltxargdescr_ == MELTPAR_MARKGGC))
    {				/*mark for ggc */
      int ix = 0;
      meltframptr_ =
	(struct
	 frame_meltrout_81_warmelt_modes_UNREGISTER_CHILD_PROCESS_HANDLER_st
	 *) meltfirstargp_;
      /* use arguments output_curframe_declstruct_init */
      (void) meltclosp_;
      (void) meltfirstargp_;
  ...
  memset (&meltfram__, 0, sizeof (meltfram__));
/* declstructinit plain routine meltrout_81_warmelt_modes_UNREGISTER_CHILD_PROCESS_HANDLER nbval 8*/
   ...
   /*_#MELT_NEED_DBG__L1*/ meltfnum[0] =
...
#endif /* meltcallcount the_meltcallcount */
	      ;;
	    MELT_LOCATION ("warmelt-modes.melt:4663:/ checksignal");
	    MELT_CHECK_SIGNAL ();
	    ;
	    /*^apply */
	    /*apply */
      ...
      else
	{
	  ...
	  /*anyblock */
	  {
	    ...
	    {
	      /*^locexp */
	      melt_assert_failed (("@$@unimplemented unregister_child_process_handler"), ("warmelt-modes.melt") ? ("warmelt-modes.melt") : __FILE__, (4664) ? (4664) : __LINE__, __FUNCTION__);
	      ;
	    }
	    ;
...
#endif /*MELT_HAVE_DEBUG */
    ;
    MELT_LOCATION ("warmelt-modes.melt:4661:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^quasiblock */
...
#undef MELTFRAM_NBVARNUM
#undef MELTFRAM_NBVARPTR
}				/*end meltrout_81_warmelt_modes_UNREGISTER_CHILD_PROCESS_HANDLER */
