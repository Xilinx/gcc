...
/* predefined class CLASS_INFIX_ADDITIVE_SYMBOL index 18 */ enum
{
  MELTLENGTH_CLASS_INFIX_ADDITIVE_SYMBOL = 3
};

/* predefined class CLASS_INFIX_DELIMITER index 19 */ enum
{
  MELTLENGTH_CLASS_INFIX_DELIMITER = 3
};

/* predefined class CLASS_INFIX_INTEGER_LITERAL index 20 */ enum
{
...
/*** End of declaration file meltrunsup.h generated on 2011 Dec 08
 * by GCC MELT 4.7.0 20111207 (experimental) [melt-branch revision 182126] MELT_0.9.2.b . ***/
