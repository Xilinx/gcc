...
/* value descriptor object magic */
  ...
  /*valdesc #16 VALDESC_SPECIAL_DATA */
  MELTOBMAG_SPECIAL_DATA /*valmagic */  = 20015,

  /*valdesc #17 VALDESC_STRBUF */
  MELTOBMAG_STRBUF /*valmagic */  = 20016,

  /*valdesc #18 VALDESC_STRING */
  MELTOBMAG_STRING /*valmagic */  = 20017,

/* ctype gty object magic */
  /*gtyctype #1 CTYPE_BASIC_BLOCK */
  MELTOBMAG_BASICBLOCK /*boxedmagic */  = 20018,
  MELTOBMAG_MAPBASICBLOCKS /*mapmagic */  = 20019,
  /*gtyctype #2 CTYPE_BITMAP */
  MELTOBMAG_BITMAP /*boxedmagic */  = 20020,
  MELTOBMAG_MAPBITMAPS /*mapmagic */  = 20021,
  /*gtyctype #3 CTYPE_EDGE */
  MELTOBMAG_EDGE /*boxedmagic */  = 20022,
  MELTOBMAG_MAPEDGES /*mapmagic */  = 20023,
  /*gtyctype #4 CTYPE_GIMPLE */
  MELTOBMAG_GIMPLE /*boxedmagic */  = 20024,
  MELTOBMAG_MAPGIMPLES /*mapmagic */  = 20025,
  /*gtyctype #5 CTYPE_GIMPLE_SEQ */
  MELTOBMAG_GIMPLESEQ /*boxedmagic */  = 20026,
  MELTOBMAG_MAPGIMPLESEQS /*mapmagic */  = 20027,
  /*gtyctype #6 CTYPE_LOOP */
  MELTOBMAG_LOOP /*boxedmagic */  = 20028,
  MELTOBMAG_MAPLOOPS /*mapmagic */  = 20029,
  /*gtyctype #7 CTYPE_RTVEC */
  MELTOBMAG_RTVEC /*boxedmagic */  = 20030,
  MELTOBMAG_MAPRTVECS /*mapmagic */  = 20031,
  /*gtyctype #8 CTYPE_RTX */
  MELTOBMAG_RTX /*boxedmagic */  = 20032,
  MELTOBMAG_MAPRTXS /*mapmagic */  = 20033,
  /*gtyctype #9 CTYPE_TREE */
  MELTOBMAG_TREE /*boxedmagic */  = 20034,
  MELTOBMAG_MAPTREES /*mapmagic */  = 20035,
  MELTOBMAG__LAST
};				/* end generated enum meltobmag_en */
#define MELT_COUNT_GENERATED_OBJMAGIC 27
...
/* predefined class CLASS_CTYPE_GTY index 7 */ enum
{
  ...
  MELTFIELD_CTYPG_BOXDISCR = 19 /*in CLASS_CTYPE_GTY */ ,
  MELTFIELD_CTYPG_MAPDISCR = 20 /*in CLASS_CTYPE_GTY */ ,
  MELTFIELD_CTYPG_MAPUNIMEMB = 21 /*in CLASS_CTYPE_GTY */ ,
  MELTFIELD_CTYPG_BOXFUN = 22 /*in CLASS_CTYPE_GTY */ ,
  MELTFIELD_CTYPG_UNBOXFUN = 23 /*in CLASS_CTYPE_GTY */ ,
  MELTFIELD_CTYPG_UPDATEBOXFUN = 24 /*in CLASS_CTYPE_GTY */ ,
  MELTFIELD_CTYPG_NEWMAPFUN = 25 /*in CLASS_CTYPE_GTY */ ,
  MELTFIELD_CTYPG_MAPGETFUN = 26 /*in CLASS_CTYPE_GTY */ ,
  MELTFIELD_CTYPG_MAPPUTFUN = 27 /*in CLASS_CTYPE_GTY */ ,
  MELTFIELD_CTYPG_MAPREMOVEFUN = 28 /*in CLASS_CTYPE_GTY */ ,
  MELTFIELD_CTYPG_MAPCOUNTFUN = 29 /*in CLASS_CTYPE_GTY */ ,
  MELTFIELD_CTYPG_MAPSIZEFUN = 30 /*in CLASS_CTYPE_GTY */ ,
  MELTFIELD_CTYPG_MAPNATTFUN = 31 /*in CLASS_CTYPE_GTY */ ,
  MELTFIELD_CTYPG_MAPNVALFUN = 32 /*in CLASS_CTYPE_GTY */ ,
  MELTFIELD_CTYPG_MAPAUXDATAFUN = 33 /*in CLASS_CTYPE_GTY */ ,
  MELTFIELD_CTYPG_MAPAUXPUTFUN = 34 /*in CLASS_CTYPE_GTY */ ,
  MELTLENGTH_CLASS_CTYPE_GTY = 35
};
...
/* predefined class CLASS_INPUT_CHANNEL_HANDLER index 20 */ enum
{
...
/* predefined class CLASS_SYSTEM_DATA index 33 */ enum
{
  ...
  MELTFIELD_SYSDATA_ALARM_HOOK = 37 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_CHILD_HOOK = 38 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_SRC_LOC_FILE_DICT = 39 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA___SPARE1 = 40 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA___SPARE2 = 41 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA___SPARE3 = 42 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA___SPARE4 = 43 /*in CLASS_SYSTEM_DATA */ ,
  MELTLENGTH_CLASS_SYSTEM_DATA = 44
};
/** end of code generated by generate_runtypesupport_predef_fields **/


/*** End of declaration file meltbuild-sources/generated/meltrunsup.h generated on 2012 Nov 30
 * by GCC MELT 4.8.0 20121127 (experimental) [melt-branch revision 193971] MELT_0.9.7-post . ***/
