...
/*anyblock*/
  ...
  /*_.KWDICT__V9*/ meltfptr[8] = slot;
    ...
    MELT_LOCATION ("warmelt-first.melt:2853:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^quasiblock */
...
/*anyblock*/
 ...
 /*_.OLDSY__V11*/ meltfptr[10] =
	...
	/*anyblock */
	{
	  ...
	  {
	    MELT_LOCATION ("warmelt-first.melt:2871:/ locexp");
    ...
    MELT_LOCATION ("warmelt-first.melt:2862:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^quasiblock */
...
/*anyblock*/
  {
   ...
   /*_#IS_A__L1*/ meltfnum[0] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:2878:/ cond.else");
  ...
  /*_.KWNAME__V9*/ meltfptr[8] = slot;
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:2881:/ getslot");
    {
      melt_ptr_t slot = NULL, obj = NULL;
      obj = (melt_ptr_t) ( /*_.INIDAT__V2*/ meltfptr[1]) /*=obj*/ ;
      melt_object_get_field (slot, obj, 7, "SYSDATA_KEYWDICT");
...
/*anyblock*/
 ...
 /*_#IS_STRING__L1*/ meltfnum[0] =
	...
	/*anyblock */
	{
	  ...
	  MELT_LOCATION ("warmelt-first.melt:2900:/ checksignal");
	  MELT_CHECK_SIGNAL ();
	  ;
   /*_#IS_A__L2*/ meltfnum[1] =
	  ...
	  /*cond */ if ( /*_#IS_A__L2*/ meltfnum[1])	/*then */
		...
		MELT_LOCATION ("warmelt-first.melt:2901:/ getslot");
		{
		  melt_ptr_t slot = NULL, obj = NULL;
     ...
     /*_.DISCRIM__V9*/ meltfptr[8] =
      ...
      /*_.DISCRINAM__V10*/ meltfptr[9] = NULL;;
		...
		{
		  MELT_LOCATION ("warmelt-first.melt:2905:/ locexp");
     ...
     /*_?*/ meltfram__.loc_CSTRING__o0 =
		...
		{
		  MELT_LOCATION ("warmelt-first.melt:2911:/ locexp");
 ...
 /*_.MAKE_INTEGERBOX__V20*/ meltfptr[10] =
  ...
  /*_.INST__V22*/ meltfptr[11] =
    ...
    {
      MELT_LOCATION ("warmelt-first.melt:2893:/ locexp");
      /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
      if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
	melt_warn_for_no_expected_secondary_results ();
...
/*anyblock*/
  {
    ...
    MELT_LOCATION ("warmelt-first.melt:2945:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
 /*_#MELT_NEED_DBG__L1*/ meltfnum[0] =
    ...
    MELT_LOCATION ("warmelt-first.melt:2948:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^cond */
  ...
  /*_.DESCR__V4*/ meltfptr[3] = NULL;;
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:2949:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^apply */
    /*apply */
  ...
  /*_.INST__V8*/ meltfptr[7] =
    ...
    MELT_LOCATION ("warmelt-first.melt:2953:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^quasiblock */
    ...
    {
      MELT_LOCATION ("warmelt-first.melt:2953:/ locexp");
      /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
      if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
	melt_warn_for_no_expected_secondary_results ();
...
/*anyblock*/
 ...
 /*_#NULL__L1*/ meltfnum[0] =
	...
	/*anyblock */
	{
	  ...
	  MELT_LOCATION ("warmelt-first.melt:2961:/ checksignal");
	  MELT_CHECK_SIGNAL ();
	  ;
	  /*^cond */
	  /*cond */ if ( /*_.PARENV__V6*/ meltfptr[5])	/*then */
		...
		MELT_LOCATION ("warmelt-first.melt:2962:/ getslot");
		{
		  melt_ptr_t slot = NULL, obj = NULL;
  ...
  /*_.ENV__V16*/ meltfptr[15] = slot;
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:2968:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^checksignal */
    MELT_CHECK_SIGNAL ();
 ...
 /*_#NULL__L4*/ meltfnum[1] =
  ...
  /*_.PREVBIND__V25*/ meltfptr[19] = NULL;;
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:2976:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^quasiblock */
 ...
 /*_#NULL__L6*/ meltfnum[4] =
	...
	/*_.IFELSE___V30*/ meltfptr[29] = ( /*nil */ NULL);;
      ...
      {
	MELT_LOCATION ("warmelt-first.melt:2984:/ cond.else");

	/*^block */
	/*anyblock */
	{

	  MELT_LOCATION ("warmelt-first.melt:2985:/ checksignal");
	  MELT_CHECK_SIGNAL ();
	  ;
	  /*^checksignal */
	  MELT_CHECK_SIGNAL ();
     ...
     /*_#IS_A__L10*/ meltfnum[8] =
      ...
      /*_#IF___L11*/ meltfnum[10] = 0;;
		...
		/*cond */ if ( /*_#IF___L11*/ meltfnum[10])	/*then */
		  {
		    ...
		    /*anyblock */
		    {
		      ...
		      {
			MELT_LOCATION ("warmelt-first.melt:2993:/ locexp");
			warning (0, "MELT WARNING MSG [#%ld]::: %s - %s",
				 melt_dbgcounter,
       ...
       /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
		      ...
		      {
			MELT_LOCATION ("warmelt-first.melt:2994:/ locexp");
			/*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
	...
	/*_#IF___L14*/ meltfnum[13] = 0;;
		      ...
		      /*cond */ if ( /*_#IF___L14*/ meltfnum[13])	/*then */
			{
			  ...
			  /*anyblock */
			  {
			    ...
			    {
			      MELT_LOCATION
				("warmelt-first.melt:2998:/ locexp");
			      warning (0,
			    ...
			    ;
			    MELT_LOCATION
			      ("warmelt-first.melt:2999:/ quasiblock");
	 ...
	 /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
			    ...
			    {
			      MELT_LOCATION
				("warmelt-first.melt:2999:/ locexp");
			      /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
			      if (meltxresdescr_ && meltxresdescr_[0]
				  && meltxrestab_)
			    ...
			    /*finalret */ goto labend_rout;
			    MELT_LOCATION
			      ("warmelt-first.melt:2995:/ quasiblock");
		   ...
		   /*clear *//*_.PROGN___V39*/ meltfptr[38] = 0;
			...
			{	/*^cond.else */
			  ...
			  /*anyblock */
			  {
			    ...
			    MELT_LOCATION
			      ("warmelt-first.melt:3000:/ checksignal");
			    MELT_CHECK_SIGNAL ();
			    ;
			    /*^checksignal */
			    MELT_CHECK_SIGNAL ();
	 ...
	 /*_#IS_A__L16*/ meltfnum[14] =
	  ...
	  /*_#IF___L17*/ meltfnum[16] = 0;;
				...
				/*anyblock */
				{
				  ...
				  {
				    MELT_LOCATION
				      ("warmelt-first.melt:3003:/ locexp");
				    warning (0,
					     "MELT WARNING MSG [#%ld]::: %s - %s",
					     melt_dbgcounter,
				  ...
				  ;
				  MELT_LOCATION
				    ("warmelt-first.melt:3004:/ quasiblock");
	   ...
	   /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
				  ...
				  {
				    MELT_LOCATION
				      ("warmelt-first.melt:3004:/ locexp");
				    /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
				    if (meltxresdescr_ && meltxresdescr_[0]
					&& meltxrestab_)
				  ...
				  /*finalret */ goto labend_rout;
				  MELT_LOCATION
				    ("warmelt-first.melt:3000:/ quasiblock");
		     ...
		     /*clear *//*_.PROGN___V42*/ meltfptr[41] =
				...
				/*anyblock */
				{
				  ...
				  MELT_LOCATION
				    ("warmelt-first.melt:3005:/ checksignal");
				  MELT_CHECK_SIGNAL ();
				  ;
				  /*^checksignal */
				  MELT_CHECK_SIGNAL ();
	   ...
	   /*_#IS_A__L19*/ meltfnum[17] =
	    ...
	    /*_#IF___L20*/ meltfnum[19] = 0;;
				  ...
				  /*cond */ if ( /*_#IF___L20*/ meltfnum[19])	/*then */
					...
					{
					  MELT_LOCATION
					    ("warmelt-first.melt:3008:/ locexp");
					  warning (0,
						   "MELT WARNING MSG [#%ld]::: %s - %s",
						   melt_dbgcounter,
					...
					;
					MELT_LOCATION
					  ("warmelt-first.melt:3009:/ quasiblock");
	     ...
	     /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
					...
					{
					  MELT_LOCATION
					    ("warmelt-first.melt:3009:/ locexp");
					  /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
					  if (meltxresdescr_
					      && meltxresdescr_[0]
					...
					/*finalret */ goto labend_rout;
					MELT_LOCATION
					  ("warmelt-first.melt:3005:/ quasiblock");
		       ...
		       /*clear *//*_.PROGN___V45*/
					...
					MELT_LOCATION
					  ("warmelt-first.melt:3010:/ checksignal");
					MELT_CHECK_SIGNAL ();
					;
					/*^checksignal */
					MELT_CHECK_SIGNAL ();
	      ...
	      /*_#IF___L23*/ meltfnum[22] = 0;;
					...
					/*cond */ if ( /*_#IF___L23*/ meltfnum[22])	/*then */
					  {
					    ...
					    /*anyblock */
					    {
					      ...
					      {
						MELT_LOCATION
						  ("warmelt-first.melt:3013:/ locexp");
						warning (0,
							 "MELT WARNING MSG [#%ld]::: %s - %s",
							 melt_dbgcounter,
					      ...
					      ;
					      MELT_LOCATION
						("warmelt-first.melt:3014:/ quasiblock");
	       ...
	       /*_.RETVAL___V1*/ meltfptr[0] =
						NULL;;
					      ...
					      {
						MELT_LOCATION
						  ("warmelt-first.melt:3014:/ locexp");
						/*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
						if (meltxresdescr_
						    && meltxresdescr_[0]
						...
						;
					      ...
					      /*finalret */ goto labend_rout;
					      MELT_LOCATION
						("warmelt-first.melt:3010:/ quasiblock");
			 ...
			 /*clear *//*_.PROGN___V48*/
					  ...
					  {	/*^cond.else */
					    ...
					    /*anyblock */
					    {
					      ...
					      MELT_LOCATION
						("warmelt-first.melt:3016:/ checksignal");
					      MELT_CHECK_SIGNAL ();
					      ;
					      /*^checksignal */
					      MELT_CHECK_SIGNAL ();
		...
		/*_#IF___L26*/ meltfnum[25]
		 ...
		 /*_.RETVAL___V1*/
						    ...
						    {
						      MELT_LOCATION
							("warmelt-first.melt:3020:/ locexp");
						      /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
						      if (meltxresdescr_
							  && meltxresdescr_[0]
						    ...
						    /*finalret */ goto
						      labend_rout;
						    MELT_LOCATION
						      ("warmelt-first.melt:3016:/ quasiblock");
			   ...
			   /*clear *//*_.PROGN___V51*/
						...
						{	/*^cond.else */
						  ...
						  /*anyblock */
						  {
						    ...
						    MELT_LOCATION
						      ("warmelt-first.melt:3022:/ checksignal");
						    MELT_CHECK_SIGNAL ();
						    ;
		 /*_#IS_A__L28*/
						      meltfnum[26] =
							...
							/*anyblock */
							{
							  ...
							  MELT_LOCATION
							    ("warmelt-first.melt:3023:/ quasiblock");
		   ...
		   /*_.CURDISCR__V56*/
								...
								[2]))));;
							  MELT_LOCATION
							    ("warmelt-first.melt:3027:/ checksignal");
							  MELT_CHECK_SIGNAL
							    ();
							  ;
		   /*_#__L29*/
							  ...
							  /*cond */ if ( /*_#__L29*/ meltfnum[28])	/*then */
								...
								;
								MELT_LOCATION
								  ("warmelt-first.melt:3031:/ getslot");
								{
								  melt_ptr_t
								    slot =
								    NULL,
		      ...
		      /*_.NAMED_NAME__V58*/
								...
								{
								  MELT_LOCATION
								    ("warmelt-first.melt:3030:/ locexp");
								  warning (0,
									   "MELT WARNING MSG [#%ld]::: %s - %s",
									   melt_dbgcounter,
								...
								;
								MELT_LOCATION
								  ("warmelt-first.melt:3032:/ quasiblock");
		     ...
		     /*_.RETVAL___V1*/
								...
								{
								  MELT_LOCATION
								    ("warmelt-first.melt:3032:/ locexp");
								  /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
								  if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
								    melt_warn_for_no_expected_secondary_results
								...
								/*finalret */
								  ...
								  labend_rout;
								MELT_LOCATION
								  ("warmelt-first.melt:3028:/ quasiblock");
   ...
   /*_#IS_A__L30*/ meltfnum[28] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:3035:/ cond.else");
...
#endif /*MELT_HAVE_DEBUG */
    ;
    MELT_LOCATION ("warmelt-first.melt:3036:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^apply */
    /*apply */
 ...
 /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
    ...
    {
      MELT_LOCATION ("warmelt-first.melt:3037:/ locexp");
      /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
      if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
	melt_warn_for_no_expected_secondary_results ();
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-first.melt:3042:/ getarg");
 /*_.SYM__V2*/ meltfptr[1] = (melt_ptr_t) meltfirstargp_;
...
/*anyblock*/
  {
    ...
    {
      MELT_LOCATION ("warmelt-first.melt:3043:/ locexp");
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3045:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
 /*_#IS_NOT_A__L1*/ meltfnum[0] =
	...
	/*anyblock */
	{
	  ...
	  {
	    MELT_LOCATION ("warmelt-first.melt:3048:/ locexp");
	    /* ERRFAILIMPORT__1 */
  ...
  /*_.IF___V4*/ meltfptr[3] = NULL;;
   ...
   /*_#IS_A__L3*/ meltfnum[1] =
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3061:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
 /*_#IS_NOT_A__L4*/ meltfnum[1] =
    ...
    /*_.BINDISCRNAM__V17*/ meltfptr[16] = NULL;;
...
#if MELT_HAVE_DEBUG
	  MELT_LOCATION ("warmelt-first.melt:3066:/ cppif.then");
	  /*^block */
	  /*anyblock */
	  {
     ...
     /*_#IS_STRING__L5*/ meltfnum[4] =
		...
		/*_.IFELSE___V19*/ meltfptr[18] = ( /*nil */ NULL);;
	      ...
	      {
		MELT_LOCATION ("warmelt-first.melt:3066:/ cond.else");
  ...
  /*_.VBIND_VALUE__V23*/ meltfptr[16] = slot;
    ...
    {
      MELT_LOCATION ("warmelt-first.melt:3078:/ locexp");
      /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
      if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
	melt_warn_for_no_expected_secondary_results ();
    ...
    {
      MELT_LOCATION ("warmelt-first.melt:3042:/ locexp");
      /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
      if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
	melt_warn_for_no_expected_secondary_results ();
...
/*anyblock*/
 ...
 /*_#NULL__L2*/ meltfnum[0] =
	...
	/*anyblock */
	{
	  ...
	  MELT_LOCATION ("warmelt-first.melt:3086:/ checksignal");
	  MELT_CHECK_SIGNAL ();
	  ;
	  /*^cond */
	  /*cond */ if (( /*!konst_1 */ meltfrout->tabval[1]))	/*then */
		...
		MELT_LOCATION ("warmelt-first.melt:3088:/ getslot");
		{
		  melt_ptr_t slot = NULL, obj = NULL;
		  obj = (melt_ptr_t) ( /*_.SYM__V2*/ meltfptr[1]) /*=obj*/ ;
		  melt_object_get_field (slot, obj, 1, "NAMED_NAME");
  ...
  /*_.IF___V7*/ meltfptr[5] = NULL;;
   ...
   /*_#IS_A__L3*/ meltfnum[2] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:3091:/ cond.else");
 ...
 /*_#NULL__L4*/ meltfnum[2] =
  ...
  /*_.IF___V15*/ meltfptr[14] = NULL;;
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-first.melt:3099:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#IS_A__L5*/ meltfnum[4] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:3099:/ cond.else");
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-first.melt:3100:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#IS_CLOSURE__L6*/ meltfnum[4] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:3100:/ cond.else");
 ...
 /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
    ...
    MELT_LOCATION ("warmelt-first.melt:3082:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^quasiblock */
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-first.melt:3111:/ getarg");
 /*_.SYM__V2*/ meltfptr[1] = (melt_ptr_t) meltfirstargp_;
...
/*anyblock*/
  {
   ...
   /*_#IS_A__L1*/ meltfnum[0] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:3112:/ cond.else");
...
#endif /*MELT_HAVE_DEBUG */
    ;
    MELT_LOCATION ("warmelt-first.melt:3113:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
 /*_#NULL__L2*/ meltfnum[0] =
 ...
 /*_#NULL__L4*/ meltfnum[2] =
	...
	/*anyblock */
	{
	  ...
	  MELT_LOCATION ("warmelt-first.melt:3125:/ getslot");
	  {
	    melt_ptr_t slot = NULL, obj = NULL;
	    obj = (melt_ptr_t) ( /*_.SYM__V2*/ meltfptr[1]) /*=obj*/ ;
	    melt_object_get_field (slot, obj, 1, "NAMED_NAME");
  ...
  /*_.IF___V15*/ meltfptr[14] = NULL;;
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-first.melt:3128:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#IS_A__L5*/ meltfnum[4] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:3128:/ cond.else");
   ...
   /*_#IS_CLOSURE__L6*/ meltfnum[4] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:3129:/ cond.else");
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-first.melt:3130:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#IS_CLOSURE__L7*/ meltfnum[4] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:3130:/ cond.else");
  ...
  /*_.INST__V27*/ meltfptr[26] =
    ...
    MELT_LOCATION ("warmelt-first.melt:3137:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^apply */
    /*apply */
 ...
 /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
    ...
    MELT_LOCATION ("warmelt-first.melt:3111:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^quasiblock */
 ...
 /*_.REVLASTLIST__V4*/ meltfptr[3] =
  ...
  /*_.INST__V6*/ meltfptr[5] =
	   ...
	   melt_pair_tail ((melt_ptr_t) /*_.CURPAIR__V7*/ meltfptr[6]))
	{
	  ...
	  {
	    MELT_LOCATION ("warmelt-first.melt:3174:/ locexp");
   ...
   /*_.PREVRES__V9*/ meltfptr[8] = slot;
	   ...
	   melt_pair_tail ((melt_ptr_t) /*_.CURPAIR__V11*/ meltfptr[8]))
	{
	  ...
	  {
	    MELT_LOCATION ("warmelt-first.melt:3185:/ locexp");
  ...
  /*_#IS_CLOSURE__L1*/ meltfnum[0] =
	   ...
	   melt_pair_tail ((melt_ptr_t) /*_.CURPAIR__V13*/ meltfptr[12]))
	{
	  ...
	  {
	    MELT_LOCATION ("warmelt-first.melt:3192:/ locexp");
   ...
   /*_.PREVRES__V15*/ meltfptr[14] = slot;
	  ...
	  ;
	  MELT_LOCATION ("warmelt-first.melt:3195:/ checksignal");
	  MELT_CHECK_SIGNAL ();
	  ;
	  /*^apply */
	  /*apply */
	  ...
	  ;
	  MELT_LOCATION ("warmelt-first.melt:3197:/ checksignal");
	  MELT_CHECK_SIGNAL ();
	  ;
	  /*^quasiblock */
    ...
    {
      MELT_LOCATION ("warmelt-first.melt:3200:/ locexp");
...
/*anyblock*/
 ...
 /*_.REVLASTLIST__V6*/ meltfptr[5] =
      (meltgc_new_list
       ((meltobject_ptr_t) (( /*!DISCR_LIST */ meltfrout->tabval[1]))));;
    MELT_LOCATION ("warmelt-first.melt:3234:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^quasiblock */
 ...
 /*_.VALPASSNUMBER__V10*/ meltfptr[9] =
    ...
    {
      MELT_LOCATION ("warmelt-first.melt:3230:/ locexp");
      /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
      if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
	melt_warn_for_no_expected_secondary_results ();
...
/*anyblock*/
  ...
  /*_.PREVRES__V3*/ meltfptr[2] = slot;
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3249:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^apply */
    /*apply */
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-first.melt:3261:/ getarg");
 /*_.LASTPROC__V2*/ meltfptr[1] = (melt_ptr_t) meltfirstargp_;
  ;
  goto lab_endgetargs;
lab_endgetargs:;
...
/*anyblock*/
 ...
 /*_#NULL__L1*/ meltfnum[0] =
   ...
   /*_.MAKE_LIST__V4*/ meltfptr[3] =
	  ...
	  MELT_LOCATION ("warmelt-first.melt:3280:/ compute");
   ...
   /*_.MAKE_LIST__V6*/ meltfptr[5] =
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3288:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-first.melt:3291:/ getarg");
 /*_.FUN__V2*/ meltfptr[1] = (melt_ptr_t) meltfirstargp_;
  ;
  goto lab_endgetargs;
lab_endgetargs:;
...
/*anyblock*/
  ...
  /*_.LASTLIST__V3*/ meltfptr[2] = slot;
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3297:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
 /*_#NULL__L1*/ meltfnum[0] =
   ...
   /*_.MAKE_LIST__V4*/ meltfptr[3] =
	    (meltgc_new_list
	     ((meltobject_ptr_t)
	      (( /*!DISCR_LIST */ meltfrout->tabval[1]))));;
	  MELT_LOCATION ("warmelt-first.melt:3299:/ compute");
	  /*_.LASTLIST__V3*/ meltfptr[2] = /*_.SETQ___V5*/ meltfptr[4] =
	    /*_.MAKE_LIST__V4*/ meltfptr[3];;
	  MELT_LOCATION ("warmelt-first.melt:3300:/ checksignal");
	  MELT_CHECK_SIGNAL ();
	  ;
   /*_.MAKE_LIST__V6*/ meltfptr[5] =
	    (meltgc_new_list
...
lab_endgetargs:;
/*body*/
  MELT_LOCATION ("warmelt-first.melt:3318:/ block");
/*anyblock*/
  {
 ...
 /*_.REVLASTLIST__V5*/ meltfptr[4] =
  ...
  /*_.INST__V7*/ meltfptr[6] =
    ...
    ;
    /*_.LAMBDA___V11*/ meltfptr[10] = /*_.LAMBDA___V12*/ meltfptr[11];;
    MELT_LOCATION ("warmelt-first.melt:3334:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^apply */
    /*apply */
...
/*anyblock*/
  ...
  /*_.PREVRES__V3*/ meltfptr[2] = slot;
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3329:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^apply */
    /*apply */
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3331:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^quasiblock */
...
/*anyblock*/
  ...
  /*_.PREVRES__V3*/ meltfptr[2] = slot;
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3343:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^apply */
    /*apply */
...
/*anyblock*/
  ...
  /*_.FIRSTLIST__V3*/ meltfptr[2] = slot;
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3354:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
 /*_#IS_CLOSURE__L1*/ meltfnum[0] =
      (melt_magic_discr ((melt_ptr_t) ( /*_.FUN__V2*/ meltfptr[1])) ==
...
/*anyblock*/
  ...
  /*_.LASTLIST__V3*/ meltfptr[2] = slot;
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3361:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
 /*_#IS_CLOSURE__L1*/ meltfnum[0] =
      (melt_magic_discr ((melt_ptr_t) ( /*_.FUN__V2*/ meltfptr[1])) ==
...
lab_endgetargs:;
/*body*/
  MELT_LOCATION ("warmelt-first.melt:3372:/ block");
/*anyblock*/
  {
 ...
 /*_.REVLASTLIST__V5*/ meltfptr[4] =
      (meltgc_new_list
       ((meltobject_ptr_t) (( /*!DISCR_LIST */ meltfrout->tabval[1]))));;
    MELT_LOCATION ("warmelt-first.melt:3376:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^quasiblock */
  ...
  /*_.INST__V7*/ meltfptr[6] =
    ...
    ;
    /*_.LAMBDA___V14*/ meltfptr[13] = /*_.LAMBDA___V15*/ meltfptr[14];;
    MELT_LOCATION ("warmelt-first.melt:3393:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^apply */
    /*apply */
    ...
    {
      MELT_LOCATION ("warmelt-first.melt:3372:/ locexp");
      /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
      if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
	melt_warn_for_no_expected_secondary_results ();
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-first.melt:3381:/ getarg");
 /*_.FIRSTPROC__V2*/ meltfptr[1] = (melt_ptr_t) meltfirstargp_;
  ;
  goto lab_endgetargs;
lab_endgetargs:;
...
/*anyblock*/
  ...
  /*_.PREVRES__V3*/ meltfptr[2] = slot;
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3383:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^apply */
    /*apply */
...
/*anyblock*/
  {
    ...
    MELT_LOCATION ("warmelt-first.melt:3391:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
 /*_#IS_CLOSURE__L1*/ meltfnum[0] =
      (melt_magic_discr ((melt_ptr_t) ( /*_.LASTPROC__V2*/ meltfptr[1])) ==
...
/*anyblock*/
  ...
  /*_.PREVRES__V3*/ meltfptr[2] = slot;
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3397:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^apply */
    /*apply */
...
/*anyblock*/
  ...
  /*_.FIRSTLIST__V3*/ meltfptr[2] = slot;
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3409:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
 /*_#IS_CLOSURE__L1*/ meltfnum[0] =
      (melt_magic_discr ((melt_ptr_t) ( /*_.FUN__V2*/ meltfptr[1])) ==
 ...
 /*_.OPTDEC__V5*/ meltfptr[4] =
  ...
  /*_.OPTNAME__V6*/ meltfptr[5] = NULL;;
   ...
   /*_#IS_A__L1*/ meltfnum[0] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:3439:/ cond.else");
...
#endif /*MELT_HAVE_DEBUG */
    ;
    MELT_LOCATION ("warmelt-first.melt:3440:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^cond */
    ...
    /*_.OPTFUN__V11*/ meltfptr[10] = NULL;;
...
#if MELT_HAVE_DEBUG
	  MELT_LOCATION ("warmelt-first.melt:3443:/ cppif.then");
	  /*^block */
	  /*anyblock */
	  {
     ...
     /*_#IS_A__L2*/ meltfnum[0] =
		...
		/*_.IFELSE___V13*/ meltfptr[12] = ( /*nil */ NULL);;
	      ...
	      {
		MELT_LOCATION ("warmelt-first.melt:3443:/ cond.else");
...
/*anyblock*/
  {
    ...
    MELT_LOCATION ("warmelt-first.melt:3457:/ checksignal");
    MELT_CHECK_SIGNAL ();
    ;
    /*^checksignal */
    MELT_CHECK_SIGNAL ();
 ...
 /*_#IS_A__L1*/ meltfnum[0] =
  ...
  /*_#IF___L2*/ meltfnum[1] = 0;;
    ...
    /*_.OPTMAP__V5*/ meltfptr[4] = slot;
	  ...
	  ;
	  MELT_LOCATION ("warmelt-first.melt:3461:/ checksignal");
	  MELT_CHECK_SIGNAL ();
	  ;
	  /*^quasiblock */
   ...
   /*_#IS_CLOSURE__L2*/ meltfnum[1] =
    ...
    /*_.CURVAL__V5*/ meltfptr[4] = NULL;
			...
			continue;
		      ...
		      MELT_LOCATION ("warmelt-first.melt:3578:/ checksignal");
		      MELT_CHECK_SIGNAL ();
		      ;
		      /*^apply */
		      /*apply */
