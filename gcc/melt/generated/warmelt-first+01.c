...
/*anyblock*/
  {
   ...
   /*_#IS_A__L1*/ meltfnum[0] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:2589:/ cond.else");
  ...
  /*_.INST__V8*/ meltfptr[7] =
    ...
    {
      MELT_LOCATION ("warmelt-first.melt:2593:/ locexp");
    ...
    MELT_LOCATION ("warmelt-first.melt:2588:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^quasiblock */
...
/*anyblock*/
  {
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-first.melt:2598:/ cppif.then");
    /*^block */
    /*anyblock */
    {
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-first.melt:2599:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#IS_A__L2*/ meltfnum[0] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:2599:/ cond.else");
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:2601:/ getslot");
    {
      melt_ptr_t slot = 0;
 ...
 /*_.OLDSY__V11*/ meltfptr[10] =
	...
	/*anyblock */
	{
	  ...
	  {
	    MELT_LOCATION ("warmelt-first.melt:2606:/ locexp");
    ...
    MELT_LOCATION ("warmelt-first.melt:2597:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^quasiblock */
...
/*anyblock*/
  {
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-first.melt:2613:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#IS_A__L1*/ meltfnum[0] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:2613:/ cond.else");
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-first.melt:2614:/ cppif.then");
    /*^block */
    /*anyblock */
    {
 ...
 /*_.OLDKW__V11*/ meltfptr[10] =
    ...
    MELT_LOCATION ("warmelt-first.melt:2618:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^cond */
	...
	/*_.IFELSE___V12*/ meltfptr[11] = /*_.OLDKW__V11*/ meltfptr[10];;
      ...
      {
	MELT_LOCATION ("warmelt-first.melt:2618:/ cond.else");
    ...
    /*^clear */
	   /*clear *//*_.IFELSE___V12*/ meltfptr[11] = 0;
    MELT_LOCATION ("warmelt-first.melt:2612:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^quasiblock */
...
/*anyblock*/
  {
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:2633:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
 /*_#IS_STRING__L1*/ meltfnum[0] =
	...
	/*_.SYNAM__V5*/ meltfptr[4] = /*_.SYMB__V2*/ meltfptr[1];;
      ...
      {
	MELT_LOCATION ("warmelt-first.melt:2633:/ cond.else");

	/*^block */
	/*anyblock */
	{

	  MELT_LOCATION ("warmelt-first.melt:2635:/ checkinterrupt");
	  MELT_CHECK_INTERRUPT ();
	  ;
   /*_#IS_A__L2*/ meltfnum[1] =
     ...
     /*_?*/ meltfram__.loc_CSTRING__o0 =
		...
		{
		  MELT_LOCATION ("warmelt-first.melt:2646:/ locexp");
     ...
     /*_.MAKE_STRINGCONST__V12*/ meltfptr[11] =
		...
		MELT_LOCATION ("warmelt-first.melt:2637:/ quasiblock");
...
#endif /*MELT_HAVE_DEBUG */
    ;
    MELT_LOCATION ("warmelt-first.melt:2663:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
 ...
 /*_#NOT__L5*/ meltfnum[4] =
   ...
   /*_.MAKE_INTEGERBOX__V17*/ meltfptr[6] =
	  ...
	  MELT_LOCATION ("warmelt-first.melt:2665:/ compute");
	  /*_.BOXI__V14*/ meltfptr[8] = /*_.SETQ___V18*/ meltfptr[11] =
	    /*_.MAKE_INTEGERBOX__V17*/ meltfptr[6];;

	  {
	    MELT_LOCATION ("warmelt-first.melt:2666:/ locexp");
 ...
 /*_#I__L7*/ meltfnum[6] =
    ...
    MELT_LOCATION ("warmelt-first.melt:2668:/ compute");
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:2670:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
...
/*anyblock*/
 ...
 /*_#MELT_NEED_DBG__L1*/ meltfnum[0] =
  ...
  /*_.DESCR__V4*/ meltfptr[3] = NULL;;
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:2684:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^apply */
    /*apply */
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:2685:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^quasiblock */
  ...
  /*_.INST__V8*/ meltfptr[7] =
    ...
    MELT_LOCATION ("warmelt-first.melt:2688:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^quasiblock */
    ...
    MELT_LOCATION ("warmelt-first.melt:2679:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^quasiblock */
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-first.melt:2692:/ getarg");
...
/*anyblock*/
  {
    ...
    MELT_LOCATION ("warmelt-first.melt:2694:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
 /*_#NULL__L1*/ meltfnum[0] =
	...
	/*anyblock */
	{
	  ...
	  MELT_LOCATION ("warmelt-first.melt:2696:/ checkinterrupt");
	  MELT_CHECK_INTERRUPT ();
	  ;
	  /*^cond */
  ...
  /*_.IF___V7*/ meltfptr[6] = NULL;;
   ...
   /*_#IS_A__L2*/ meltfnum[1] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:2700:/ cond.else");
   ...
   /*_#IS_A__L3*/ meltfnum[1] =
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:2703:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^checkinterrupt */
    MELT_CHECK_INTERRUPT ();
 ...
 /*_#NULL__L6*/ meltfnum[4] =
	...
	/*anyblock */
	{
	  ...
	  MELT_LOCATION ("warmelt-first.melt:2720:/ checkinterrupt");
	  MELT_CHECK_INTERRUPT ();
	  ;
	  /*^checkinterrupt */
	  MELT_CHECK_INTERRUPT ();
		 ...
		 /*clear *//*_.PROGN___V36*/ meltfptr[35] = 0;
		  ...
		  {		/*^cond.else */
		    ...
		    /*anyblock */
		    {
		      ...
		      MELT_LOCATION
			("warmelt-first.melt:2730:/ checkinterrupt");
		      MELT_CHECK_INTERRUPT ();
		      ;
		      /*^checkinterrupt */
		      MELT_CHECK_INTERRUPT ();
	...
	/*_#IF___L14*/ meltfnum[13] = 0;;
		      ...
		      /*cond */ if ( /*_#IF___L14*/ meltfnum[13])	/*then */
			{
			  ...
			  /*anyblock */
			  {
			    ...
			    {
			      MELT_LOCATION
				("warmelt-first.melt:2733:/ locexp");
			      warning (0,
			    ...
			    ;
			    MELT_LOCATION
			      ("warmelt-first.melt:2734:/ quasiblock");


	 /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
			    MELT_LOCATION
			      ("warmelt-first.melt:2734:/ finalreturn");
			    ;
			    /*finalret */ goto labend_rout;
			    MELT_LOCATION
			      ("warmelt-first.melt:2730:/ quasiblock");
		   ...
		   /*clear *//*_.PROGN___V39*/ meltfptr[38] = 0;
			...
			{	/*^cond.else */
			  ...
			  /*anyblock */
			  {
			    ...
			    MELT_LOCATION
			      ("warmelt-first.melt:2735:/ checkinterrupt");
			    MELT_CHECK_INTERRUPT ();
			    ;
			    /*^checkinterrupt */
			    MELT_CHECK_INTERRUPT ();
	 ...
	 /*_#IS_A__L16*/ meltfnum[14] =
	  ...
	  /*_#IF___L17*/ meltfnum[16] = 0;;
				...
				/*anyblock */
				{
				  ...
				  {
				    MELT_LOCATION
				      ("warmelt-first.melt:2738:/ locexp");
				    warning (0,
					     "MELT WARNING MSG [#%ld]::: %s - %s",
					     melt_dbgcounter,
				  ...
				  ;
				  MELT_LOCATION
				    ("warmelt-first.melt:2739:/ quasiblock");


	   /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
				  MELT_LOCATION
				    ("warmelt-first.melt:2739:/ finalreturn");
				  ;
				  /*finalret */ goto labend_rout;
				  MELT_LOCATION
				    ("warmelt-first.melt:2735:/ quasiblock");
		     ...
		     /*clear *//*_.PROGN___V42*/ meltfptr[41] =
				...
				/*anyblock */
				{
				  ...
				  MELT_LOCATION
				    ("warmelt-first.melt:2740:/ checkinterrupt");
				  MELT_CHECK_INTERRUPT ();
				  ;
				  /*^checkinterrupt */
				  MELT_CHECK_INTERRUPT ();
	   ...
	   /*_#IS_A__L19*/ meltfnum[17] =
	    ...
	    /*_#IF___L20*/ meltfnum[19] = 0;;
				  ...
				  /*cond */ if ( /*_#IF___L20*/ meltfnum[19])	/*then */
					...
					{
					  MELT_LOCATION
					    ("warmelt-first.melt:2743:/ locexp");
					  warning (0,
						   "MELT WARNING MSG [#%ld]::: %s - %s",
						   melt_dbgcounter,
					...
					;
					MELT_LOCATION
					  ("warmelt-first.melt:2744:/ quasiblock");


	     /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
					MELT_LOCATION
					  ("warmelt-first.melt:2744:/ finalreturn");
					;
					/*finalret */ goto labend_rout;
					MELT_LOCATION
					  ("warmelt-first.melt:2740:/ quasiblock");
		       ...
		       /*clear *//*_.PROGN___V45*/
					...
					MELT_LOCATION
					  ("warmelt-first.melt:2745:/ checkinterrupt");
					MELT_CHECK_INTERRUPT ();
					;
					/*^checkinterrupt */
					MELT_CHECK_INTERRUPT ();
					...
					/*cond */ if ( /*_#IF___L23*/ meltfnum[22])	/*then */
					  {
					    ...
					    /*anyblock */
					    {
					      ...
					      {
						MELT_LOCATION
						  ("warmelt-first.melt:2748:/ locexp");
						warning (0,
							 "MELT WARNING MSG [#%ld]::: %s - %s",
							 melt_dbgcounter,
					      ...
					      ;
					      MELT_LOCATION
						("warmelt-first.melt:2749:/ quasiblock");


	       /*_.RETVAL___V1*/ meltfptr[0] =
						NULL;;
					      MELT_LOCATION
						("warmelt-first.melt:2749:/ finalreturn");
					      ;
					      /*finalret */ goto labend_rout;
					      MELT_LOCATION
						("warmelt-first.melt:2745:/ quasiblock");
			 ...
			 /*clear *//*_.PROGN___V48*/
					  ...
					  {	/*^cond.else */
					    ...
					    /*anyblock */
					    {
					      ...
					      MELT_LOCATION
						("warmelt-first.melt:2751:/ checkinterrupt");
					      MELT_CHECK_INTERRUPT ();
					      ;
					      /*^checkinterrupt */
					      MELT_CHECK_INTERRUPT ();
		...
		/*_#IF___L26*/ meltfnum[25]
					      ...
					      /*cond */ if ( /*_#IF___L26*/ meltfnum[25])	/*then */
						{
						  ...
						  /*anyblock */
						  {
						    ...
						    {
						      MELT_LOCATION
							("warmelt-first.melt:2754:/ locexp");
						      warning (0,
							       "MELT WARNING MSG [#%ld]::: %s - %s",
							       melt_dbgcounter,
							       ("not exporting previous bound instance"),
						    ...
						    ;
						    MELT_LOCATION
						      ("warmelt-first.melt:2755:/ quasiblock");


		 /*_.RETVAL___V1*/
						      meltfptr[0] = NULL;;
						    MELT_LOCATION
						      ("warmelt-first.melt:2755:/ finalreturn");
						    ;
						    /*finalret */ goto
						      labend_rout;
						    MELT_LOCATION
						      ("warmelt-first.melt:2751:/ quasiblock");
			   ...
			   /*clear *//*_.PROGN___V51*/
						...
						{	/*^cond.else */
						  ...
						  /*anyblock */
						  {
						    ...
						    MELT_LOCATION
						      ("warmelt-first.melt:2757:/ checkinterrupt");
						    MELT_CHECK_INTERRUPT ();
						    ;
		 /*_#IS_A__L28*/
						      meltfnum[26] =
							...
							/*anyblock */
							{
							  ...
							  MELT_LOCATION
							    ("warmelt-first.melt:2758:/ quasiblock");
		   ...
		   /*_.CURDISCR__V56*/
								...
								[2]))));;
							  MELT_LOCATION
							    ("warmelt-first.melt:2762:/ checkinterrupt");
							  MELT_CHECK_INTERRUPT
							    ();
							  ;
		   /*_#__L29*/
							  ...
							  /*cond */ if ( /*_#__L29*/ meltfnum[28])	/*then */
								...
								{
								  MELT_LOCATION
								    ("warmelt-first.melt:2764:/ locexp");
								  warning (0,
									   "MELT WARNING MSG [#%ld]::: %s - %s",
									   melt_dbgcounter,
								...
								;
								MELT_LOCATION
								  ("warmelt-first.melt:2766:/ getslot");
								{
								  melt_ptr_t
								    slot = 0;
								...
								{
								  MELT_LOCATION
								    ("warmelt-first.melt:2765:/ locexp");
								  warning (0,
									   "MELT WARNING MSG [#%ld]::: %s - %s",
									   melt_dbgcounter,
								...
								;
								MELT_LOCATION
								  ("warmelt-first.melt:2767:/ quasiblock");
		     ...
		     /*_.RETVAL___V1*/
								  ...
								  [0] = NULL;;
								MELT_LOCATION
								  ("warmelt-first.melt:2767:/ finalreturn");
								;
								/*finalret */
								  goto
								  labend_rout;
								MELT_LOCATION
								  ("warmelt-first.melt:2763:/ quasiblock");
...
#endif /*MELT_HAVE_DEBUG */
    ;
    MELT_LOCATION ("warmelt-first.melt:2771:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^apply */
    /*apply */
...
/*anyblock*/
  {
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:2780:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
 /*_#IS_NOT_A__L1*/ meltfnum[0] =
   ...
   /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
	  MELT_LOCATION ("warmelt-first.melt:2790:/ finalreturn");
	  ;
	  /*finalret */ goto labend_rout;
  ...
  /*_.IF___V4*/ meltfptr[3] = NULL;;
   ...
   /*_#IS_A__L2*/ meltfnum[1] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:2792:/ cond.else");
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-first.melt:2793:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#IS_A__L3*/ meltfnum[1] =
	melt_is_instance_of ((melt_ptr_t) ( /*_.PARENV__V3*/ meltfptr[2]),
			     (melt_ptr_t) (( /*!CLASS_ENVIRONMENT */
					    meltfrout->tabval[1])));;
      MELT_LOCATION ("warmelt-first.melt:2793:/ cond");
      /*cond */ if ( /*_#IS_A__L3*/ meltfnum[1])	/*then */
	{
	  /*^cond.then */
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:2793:/ cond.else");
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-first.melt:2817:/ getarg");
 /*_.SYM__V2*/ meltfptr[1] = (melt_ptr_t) meltfirstargp_;
...
/*anyblock*/
 ...
 /*_#NULL__L2*/ meltfnum[0] =
	...
	/*anyblock */
	{
	  ...
	  MELT_LOCATION ("warmelt-first.melt:2821:/ checkinterrupt");
	  MELT_CHECK_INTERRUPT ();
	  ;
	  /*^cond */
   ...
   /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
	  MELT_LOCATION ("warmelt-first.melt:2824:/ finalreturn");
	  ;
	  /*finalret */ goto labend_rout;
 ...
 /*_#NULL__L4*/ meltfnum[2] =
	...
	/*anyblock */
	{
	  ...
	  MELT_LOCATION ("warmelt-first.melt:2831:/ getslot");
	  {
	    melt_ptr_t slot = 0;
	    melt_object_get_field (slot, (melt_ptr_t) ( /*_.SYM__V2*/ meltfptr[1]), 1, "NAMED_NAME");
											 /*_.NAMED_NAME__V16*/
   ...
   /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
	  MELT_LOCATION ("warmelt-first.melt:2832:/ finalreturn");
	  ;
	  /*finalret */ goto labend_rout;
  ...
  /*_.IF___V15*/ meltfptr[14] = NULL;;
   ...
   /*_#IS_A__L5*/ meltfnum[4] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:2834:/ cond.else");
   ...
   /*_#IS_CLOSURE__L6*/ meltfnum[4] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:2835:/ cond.else");
 ...
 /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
    MELT_LOCATION ("warmelt-first.melt:2842:/ finalreturn");
    ;
    /*finalret */ goto labend_rout;
...
/*anyblock*/
  {
   ...
   /*_#IS_A__L1*/ meltfnum[0] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:2847:/ cond.else");
 ...
 /*_#NULL__L2*/ meltfnum[0] =
  ...
  /*_.IF___V8*/ meltfptr[6] = NULL;;
   ...
   /*_#IS_A__L3*/ meltfnum[2] =
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:2857:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
 /*_#NULL__L4*/ meltfnum[2] =
      (( /*_.ENV__V14*/ meltfptr[13]) == NULL);;
	...
	/*anyblock */
	{
	  ...
	  MELT_LOCATION ("warmelt-first.melt:2860:/ getslot");
	  {
	    melt_ptr_t slot = 0;
	    melt_object_get_field (slot, (melt_ptr_t) ( /*_.SYM__V2*/ meltfptr[1]), 1, "NAMED_NAME");
											 /*_.NAMED_NAME__V16*/
  ...
  /*_.IF___V15*/ meltfptr[14] = NULL;;
   ...
   /*_#IS_CLOSURE__L6*/ meltfnum[4] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:2864:/ cond.else");
   ...
   /*_#IS_CLOSURE__L7*/ meltfnum[4] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:2865:/ cond.else");
...
lab_endgetargs:;
/*body*/
  MELT_LOCATION ("warmelt-first.melt:2896:/ block");
/*anyblock*/
  {
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:2898:/ getslot");
    {
      melt_ptr_t slot = 0;
 ...
 /*_.REVLASTLIST__V5*/ meltfptr[4] =
  ...
  /*_.INST__V7*/ meltfptr[6] =
    ...
    MELT_LOCATION ("warmelt-first.melt:2912:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^apply */
    /*apply */
    ...
    MELT_LOCATION ("warmelt-first.melt:2917:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^apply */
    /*apply */
...
/*anyblock*/
  {
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:2907:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^apply */
    /*apply */
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:2909:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^quasiblock */
...
/*anyblock*/
  {
    ...
    MELT_LOCATION ("warmelt-first.melt:2915:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
...
/*anyblock*/
  {
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:2941:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
 /*_#IS_CLOSURE__L1*/ meltfnum[0] =
      (melt_magic_discr ((melt_ptr_t) ( /*_.FUN__V2*/ meltfptr[1])) ==
...
/*anyblock*/
  {
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:2955:/ getslot");
    {
      melt_ptr_t slot = 0;
...
/*anyblock*/
  {
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3001:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
 /*_#NULL__L1*/ meltfnum[0] =
   ...
   /*_.MAKE_LIST__V4*/ meltfptr[3] =
	  ...
	  MELT_LOCATION ("warmelt-first.melt:3003:/ compute");
   ...
   /*_.MAKE_LIST__V6*/ meltfptr[5] =
	  ...
	  ;
	  MELT_LOCATION ("warmelt-first.melt:3008:/ checkinterrupt");
	  MELT_CHECK_INTERRUPT ();
	  ;
	  /*^cond */
	  /*cond */ if (
...
/*anyblock*/
 ...
 /*_#NULL__L1*/ meltfnum[0] =
    ...
    MELT_LOCATION ("warmelt-first.melt:3020:/ cond");
    /*cond */ if ( /*_#NULL__L1*/ meltfnum[0])	/*then */
      {
	/*^cond.then */
	/*^block */
   ...
   /*_.MAKE_LIST__V4*/ meltfptr[3] =
	    (meltgc_new_list
	     ((meltobject_ptr_t)
	      (( /*!DISCR_LIST */ meltfrout->tabval[1]))));;
	  MELT_LOCATION ("warmelt-first.melt:3022:/ compute");
	  /*_.LASTLIST__V3*/ meltfptr[2] = /*_.SETQ___V5*/ meltfptr[4] =
	    /*_.MAKE_LIST__V4*/ meltfptr[3];;
	  MELT_LOCATION ("warmelt-first.melt:3023:/ checkinterrupt");
	  MELT_CHECK_INTERRUPT ();
	  ;
   /*_.MAKE_LIST__V6*/ meltfptr[5] =
	    (meltgc_new_list
...
/*anyblock*/
 ...
 /*_.REVLASTLIST__V5*/ meltfptr[4] =
  ...
  /*_.INST__V7*/ meltfptr[6] =
    ...
    ;
    /*_.LAMBDA___V11*/ meltfptr[10] = /*_.LAMBDA___V12*/ meltfptr[11];;
    MELT_LOCATION ("warmelt-first.melt:3057:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^apply */
    /*apply */
    ...
    ;
    /*_.LAMBDA___V14*/ meltfptr[13] = /*_.LAMBDA___V15*/ meltfptr[14];;
    MELT_LOCATION ("warmelt-first.melt:3062:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^apply */
    /*apply */
...
/*anyblock*/
  {
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3054:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^quasiblock */
...
/*anyblock*/
  {
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3077:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
 /*_#IS_CLOSURE__L1*/ meltfnum[0] =
      (melt_magic_discr ((melt_ptr_t) ( /*_.FUN__V2*/ meltfptr[1])) ==
...
lab_endgetargs:;
/*body*/
  MELT_LOCATION ("warmelt-first.melt:3095:/ block");
/*anyblock*/
  {
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3097:/ getslot");
    {
      melt_ptr_t slot = 0;
 ...
 /*_.REVLASTLIST__V5*/ meltfptr[4] =
      (meltgc_new_list
       ((meltobject_ptr_t) (( /*!DISCR_LIST */ meltfrout->tabval[1]))));;
    MELT_LOCATION ("warmelt-first.melt:3099:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^quasiblock */
...
/*anyblock*/
  {
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:3106:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
    /*^apply */
    /*apply */
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-first.melt:3127:/ getarg");
 /*_.FUN__V2*/ meltfptr[1] = (melt_ptr_t) meltfirstargp_;
  ;
  goto lab_endgetargs;
lab_endgetargs:;
...
/*anyblock*/
  {
    ...
    MELT_LOCATION ("warmelt-first.melt:3138:/ quasiblock");
 ...
 /*_.OPTDEC__V5*/ meltfptr[4] =
  ...
  /*_.OPTNAME__V6*/ meltfptr[5] = NULL;;
   ...
   /*_#IS_A__L1*/ meltfnum[0] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:3162:/ cond.else");
    ...
    /*_.OPTFUN__V11*/ meltfptr[10] = NULL;;
...
#if MELT_HAVE_DEBUG
	  MELT_LOCATION ("warmelt-first.melt:3166:/ cppif.then");
	  /*^block */
	  /*anyblock */
	  {
     ...
     /*_#IS_A__L2*/ meltfnum[0] =
		...
		/*_.IFELSE___V13*/ meltfptr[12] = ( /*nil */ NULL);;
	      ...
	      {
		MELT_LOCATION ("warmelt-first.melt:3166:/ cond.else");
   ...
   /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
	  MELT_LOCATION ("warmelt-first.melt:3174:/ finalreturn");
	  ;
	  /*finalret */ goto labend_rout;
 ...
 /*_#IS_A__L1*/ meltfnum[0] =
  ...
  /*_#IF___L2*/ meltfnum[1] = 0;;
    ...
    /*_.INST__V7*/ meltfptr[6] =
	  ...
	  {
	    MELT_LOCATION ("warmelt-first.melt:3189:/ locexp");
...
/*anyblock*/
 ...
 /*_.OPTD__V7*/ meltfptr[5] =
    ...
    MELT_LOCATION ("warmelt-first.melt:3198:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
 /*_#IS_A__L1*/ meltfnum[0] =
	...
	/*anyblock */
	{
	  ...
	  ;
	  MELT_LOCATION ("warmelt-first.melt:3205:/ checkinterrupt");
	  MELT_CHECK_INTERRUPT ();
	  ;
	  /*^quasiblock */
...
/*anyblock*/
  {
    ...
    MELT_LOCATION ("warmelt-first.melt:3294:/ checkinterrupt");
    MELT_CHECK_INTERRUPT ();
    ;
 /*_#IS_MAPOBJECT__L1*/ meltfnum[0] =
	...
	/*anyblock */
	{
	  ...
	  MELT_LOCATION ("warmelt-first.melt:3295:/ checkinterrupt");
	  MELT_CHECK_INTERRUPT ();
	  ;
   /*_#IS_CLOSURE__L2*/ meltfnum[1] =
    ...
    /*_.CURVAL__V5*/ meltfptr[4] = NULL;
			...
			continue;
		      ...
		      MELT_LOCATION
			("warmelt-first.melt:3299:/ checkinterrupt");
		      MELT_CHECK_INTERRUPT ();
		      ;
		      /*^apply */
		      /*apply */
